...
#  libs/phpseclib/vendor/phpseclib/phpseclib/phpseclib/Net SFTP.php

_Pure-PHP implementation of SFTP._

PHP version 5

Supports SFTPv2/3/4/5/6. Defaults to v3.

The API for this library is modeled after the API from PHP's {@link http://php.net/book.ftp}.
