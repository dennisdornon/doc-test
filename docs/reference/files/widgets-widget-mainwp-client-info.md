...
#  widgets widget-mainwp-client-info.php

_MainWP Client Info Widget_

Displays the Client Info.

## Classes

[MainWP_Client_Info](classes/MainWP-Dashboard-MainWP-Client-Info.md) |  _Class MainWP_Client_Info_  
---|---  
  
Package
    

\MainWPMainWP\Client\Info
