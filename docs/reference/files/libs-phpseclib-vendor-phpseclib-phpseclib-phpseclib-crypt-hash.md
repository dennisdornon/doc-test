...
#  libs/phpseclib/vendor/phpseclib/phpseclib/phpseclib/Crypt Hash.php

_Wrapper around hash() and hash_hmac() functions supporting truncated hashes such as sha256-96. Any hash algorithm returned by hash_algos() (and truncated versions thereof) are supported._

If {@link self::setKey()} is called, {@link self::hash()} will return the HMAC as opposed to the hash.
...
---|---  
copyright  |  2015 Jim Wigginton 2015 Andreas Fischer  
