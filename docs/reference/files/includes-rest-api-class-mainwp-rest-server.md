...
#  includes/rest-api class-mainwp-rest-server.php

_Initialize this version of the REST API._

## Classes

[MainWP_Rest_Server](classes/MainWP-Rest-Server.md) |  _Class responsible for loading the REST API and all REST API namespaces._  
---|---  
