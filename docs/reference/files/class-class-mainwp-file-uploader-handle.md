...
#  class class-mainwp-file-uploader-handle.php

_MainWP_File_Uploader_Handle_

Handle file uploads via regular form post (uses the $_FILES array)

## Classes

[MainWP_File_Uploader_Handle](classes/MainWP-Dashboard-MainWP-File-Uploader-Handle.md) |  _Class MainWP_File_Uploader_Handle_  
---|---  
