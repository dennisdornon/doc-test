...
#  libs/phpseclib/vendor/phpseclib/phpseclib/phpseclib/File ANSI.php

_Pure-PHP ANSI Decoder_

PHP version 5

If you call read() in \phpseclib3\Net\SSH2 you may get {@link http://en.wikipedia.org/wiki/ANSI_escape_code} back. They'd look like chr(0x1B) . '[00m' or whatever (0x1B = ESC). They tell a {@link http://en.wikipedia.org/wiki/Terminal_emulator} how to format the characters, what color to display them in, etc. \phpseclib3\File\ANSI is a {@link http://en.wikipedia.org/wiki/VT100} terminal emulator.

## Classes

[ANSI](classes/phpseclib3-File-ANSI.md) |  _Pure-PHP ANSI Decoder_  
---|---  
