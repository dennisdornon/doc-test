...
#  libs/phpseclib/vendor/phpseclib/phpseclib/phpseclib/Crypt/EC/Curves sect283k1.php
...
[sect283k1](classes/phpseclib3-Crypt-EC-Curves-sect283k1.md) |  _Curves over y^2 + x*y = x^3 + a*x^2 + b_  
---|---  
...
author  |  Jim Wiggint on [terrafrost@php.net](mailto:terrafrost@php.net)  
---|---  
