...
#  widgets widget-mainwp-client-overview-info.php

_MainWP Client Overview Info Widget_

Displays the Client Info.

## Classes

[MainWP_Client_Overview_Info](classes/MainWP-Dashboard-MainWP-Client-Overview-Info.md) |  _Class MainWP_Client_Overview_Info_  
---|---  
  
Package
    

\MainWPMainWP\Client\Overview\Info
