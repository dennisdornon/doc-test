...
#  widgets widget-mainwp-widget-plugins.php

_MainWP Plugins Widget_

Grab current Child Site plugin data & build Widget

## Classes

[MainWP_Widget_Plugins](classes/MainWP-Dashboard-MainWP-Widget-Plugins.md) |  _Class MainWP_Widget_Plugins_  
---|---  
