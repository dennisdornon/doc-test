...
_MainWP API Manager Update Handler_

This class handles updates for MainWP Extension.

## Classes

[MainWP_Api_Manager_Plugin_Update](classes/MainWP-Dashboard-MainWP-Api-Manager-Plugin-Update.md) |  _Class MainWP_Api_Manager_Plugin_Update_  
---|---  
  
Package
    

\MainWPAPIManagerUpdateHandler
