...
#  class class-mainwp-wp-cli-command.php

_MainWP-CLI_

This file extends the WP-CLI and provides a set of SubCommands to Control your Child Sites that are added to the MainWP Dashboard.

## Classes

[MainWP_WP_CLI_Command](classes/MainWP-Dashboard-MainWP-WP-CLI-Command.md) |  _Class MainWP_WP_CLI_Command_  
---|---  
...
Documentation is powered by [phpDocumentor ](https://www.phpdoc.org/) and authored on September 14th, 2025 at 00:31. 
  *[Composer]: \Composer
  *[MainWP]: \MainWP
  *[ParagonIE]: \ParagonIE
