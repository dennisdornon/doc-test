...
#  libs/phpseclib/vendor/phpseclib/phpseclib/phpseclib bootstrap.php

_Bootstrapping File for phpseclib_

composer isn't a requirement for phpseclib 2.0 but this file isn't really required either. it's a bonus for those using composer but if you're not phpseclib will still work
