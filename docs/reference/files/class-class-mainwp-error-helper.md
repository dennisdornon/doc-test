...
#  class class-mainwp-error-helper.php

_HTTP Error Handler_

Throw this error when MainWP is not detected due to either an HTTP error or if MainWP Child Plugin is not found.
