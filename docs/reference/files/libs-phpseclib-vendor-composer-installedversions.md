...
#  libs/phpseclib/vendor/composer InstalledVersions.php

__

## Classes

[InstalledVersions](classes/Composer-InstalledVersions.md) |  _This class is copied in every Composer installed project and available to all_  
---|---  
