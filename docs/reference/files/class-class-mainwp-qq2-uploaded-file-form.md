...
#  class class-mainwp-qq2-uploaded-file-form.php

_MainWP_QQ2_Uploaded_File_Form_

DO NOT TOUCH - part of http://github.com/valums/file-uploader ! (@see js/fileuploader.js) Handle file uploads via regular form post (uses the $_FILES array)
