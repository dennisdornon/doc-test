...
#  pages page-mainwp-setup-wizard.php

_MainWP Setup Wizard_

MainWP Quick Setup Wizard enables you to quickly set basic plugin settings

## Classes

[MainWP_Setup_Wizard](classes/MainWP-Dashboard-MainWP-Setup-Wizard.md) |  _Class MainWP_Setup_Wizard_  
---|---  
