...
#  class class-mainwp-common-handler.php

_MainWP Common Handler_

This class handles the common functions.

## Classes

[MainWP_Common_Handler](classes/MainWP-Dashboard-MainWP-Common-Handler.md) |  _Class MainWP_Common_Handler_  
---|---  
