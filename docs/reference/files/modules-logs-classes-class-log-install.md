...
#  modules/logs/classes class-log-install.php

_This file handles all interactions with the Log DB._

## Classes

[Log_Install](classes/MainWP-Dashboard-Module-Log-Log-Install.md) |  _Class Log_Install_  
---|---  
