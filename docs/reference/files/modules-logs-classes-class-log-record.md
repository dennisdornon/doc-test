...
#  modules/logs/classes class-log-record.php

_Manages the state of a single record_

## Classes

[Log_Record](classes/MainWP-Dashboard-Module-Log-Log-Record.md) |  _Class - Log_Record_  
---|---  
