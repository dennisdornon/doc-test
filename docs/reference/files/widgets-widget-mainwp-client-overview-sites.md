...
#  widgets widget-mainwp-client-overview-sites.php

_MainWP Client Overview Sites Widget_

Displays the Client Info.

## Classes

[MainWP_Client_Overview_Sites](classes/MainWP-Dashboard-MainWP-Client-Overview-Sites.md) |  _Class MainWP_Client_Overview_Sites_  
---|---  
  
Package
    

\MainWPMainWP\Client\Overview\Sites
