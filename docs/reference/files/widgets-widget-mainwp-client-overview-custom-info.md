...
#  widgets widget-mainwp-client-overview-custom-info.php

_MainWP Client Overview Custom Info Widget_

Displays the Client Custom Info.

## Classes

[MainWP_Client_Overview_Custom_Info](classes/MainWP-Dashboard-MainWP-Client-Overview-Custom-Info.md) |  _Class MainWP_Client_Overview_Custom_Info_  
---|---  
  
Package
    

\MainWPMainWP\Client\Overview\Custom\Info
