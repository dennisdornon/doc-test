...
#  class class-mainwp-api-handler.php

_Install, activate and deactivate MainWP Extensions._

## Classes

[MainWP_API_Handler](classes/MainWP-Dashboard-MainWP-API-Handler.md) |  _Class MainWP_API_Handler()_  
---|---  
