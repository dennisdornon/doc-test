...
#  modules/logs/classes class-log-db-driver.php

_Interface for a Database Driver._

## Interfaces

[Log_DB_Driver](classes/MainWP-Dashboard-Module-Log-Log-DB-Driver.md) |  _Interface - Log_DB_Driver_  
---|---  
