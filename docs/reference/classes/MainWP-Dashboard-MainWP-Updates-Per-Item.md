...
#  \MainWP\Dashboard MainWP_Updates_Per_Item

_Class MainWP_Updates_Per_Item._

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Updates-Per-Item.html#method_get_class_name)  
[render_plugins_updates](classes/MainWP-Dashboard-MainWP-Updates-Per-Item.html#method_render_plugins_updates)  
[render_themes_updates](classes/MainWP-Dashboard-MainWP-Updates-Per-Item.html#method_render_themes_updates)  
[render_trans_update](classes/MainWP-Dashboard-MainWP-Updates-Per-Item.html#method_render_trans_update)  
[render_abandoned_plugins](classes/MainWP-Dashboard-MainWP-Updates-Per-Item.html#method_render_abandoned_plugins)  
[render_abandoned_themes](classes/MainWP-Dashboard-MainWP-Updates-Per-Item.html#method_render_abandoned_themes)  
...
File
     [ pages/page-mainwp-updates-per-item.php ](files/pages-page-mainwp-updates-per-item.md)
Package
...
__
[code]
    render_plugins_updates(object  $websites, int  $total_plugin_upgrades, mixed  $userExtension, array  $allPlugins, array  $pluginsInfo, array  $trustedPlugins) : mixed
[/code]
...
__
[code]
    render_themes_updates(object  $websites, int  $total_theme_upgrades, mixed  $userExtension, array  $allThemes, array  $themesInfo, array  $trustedThemes) : mixed
[/code]
...
__
[code]
    render_trans_update(object  $websites, int  $total_translation_upgrades, mixed  $userExtension, array  $allTranslations, array  $translationsInfo) : mixed
[/code]
...
### page-mainwp-updates-per-item.php
[/code]
[code] 
#  __
