...
__
[code]
    update_db_legacy_first_enable_monitoring_create_monitors(mixed  $disabled_monitors = null, mixed  $active = null) : void
[/code]
...
__
[code]
    get_monitor_by(int  $site_id, string  $by, mixed  $value, array  $params = array(), string  $obj = object) : object|null
[/code]
...
__
[code]
    get_monitors(array  $params = array(), int  $obj = object) : object|null
[/code]
...
__
[code]
    get_last_site_heartbeat(int  $siteid, bool  $include_suburl = true) : object|null
[/code]
...
__
[code]
    get_uptime_monitor_stat_hourly_by(int  $monitor_id, string  $by, mixed  $value = false, string  $obj = \MainWP\Dashboard\ARRAY_A) : mixed
[/code]
