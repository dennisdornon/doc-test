...
#  \MainWP\Dashboard MainWP_Meta_Boxes

_Class MainWP_Meta_Boxes_

## Summary

Methods Properties Constants [select_sites_handle](classes/MainWP-Dashboard-MainWP-Meta-Boxes.html#method_select_sites_handle)  
[add_categories](classes/MainWP-Dashboard-MainWP-Meta-Boxes.html#method_add_categories)  
[add_categories_handle](classes/MainWP-Dashboard-MainWP-Meta-Boxes.html#method_add_categories_handle)  
[add_tags](classes/MainWP-Dashboard-MainWP-Meta-Boxes.html#method_add_tags)  
[add_tags_handle](classes/MainWP-Dashboard-MainWP-Meta-Boxes.html#method_add_tags_handle)  
[add_slug](classes/MainWP-Dashboard-MainWP-Meta-Boxes.html#method_add_slug)  
[add_slug_handle](classes/MainWP-Dashboard-MainWP-Meta-Boxes.html#method_add_slug_handle)  
_No public properties found_ _No public constants found_ _No protected methods found_ _No protected properties found_ _No protected constants found_ [add_extra](classes/MainWP-Dashboard-MainWP-Meta-Boxes.html#method_add_extra)  
[add_extra_handle](classes/MainWP-Dashboard-MainWP-Meta-Boxes.html#method_add_extra_handle)  
_No private properties found_ _No private constants found_

File
     [ class/class-mainwp-meta-boxes.php ](files/class-class-mainwp-meta-boxes.md)
Package
...
__
[code]
    select_sites_handle(mixed  $post_id, mixed  $post_type) : int
[/code]

_Method select_sites_handle()_
...
__
[code]
    add_categories_handle(int  $post_id, string  $post_type) : mixed
[/code]

_Method add_categories_handle()_
...
__
[code]
    add_tags_handle(int  $post_id, string  $post_type) : mixed
[/code]

_Method add_tags_handle()_
...
__
[code]
    add_slug_handle(int  $post_id, string  $post_type) : mixed
[/code]

_Method add_slug_handle()_
...
__
[code]
    add_extra(string  $title, string  $saveto, string  $prefix, object  $post) : mixed
[/code]
...
__
[code]
    add_extra_handle(string  $title, string  $saveto, string  $prefix, int  $post_id, string  $post_type) : int
[/code]

_Method add_extra_handle()_
