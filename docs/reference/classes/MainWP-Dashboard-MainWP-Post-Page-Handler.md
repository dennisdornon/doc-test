...
_Class MainWP_Post_Page_Handler_

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Post-Page-Handler.html#method_get_class_name)  
[add_meta](classes/MainWP-Dashboard-MainWP-Post-Page-Handler.html#method_add_meta)  
[ajax_add_meta](classes/MainWP-Dashboard-MainWP-Post-Page-Handler.html#method_ajax_add_meta)  
[ajax_handle_get_categories](classes/MainWP-Dashboard-MainWP-Post-Page-Handler.html#method_ajax_handle_get_categories)  
[print_catergories_tree](classes/MainWP-Dashboard-MainWP-Post-Page-Handler.html#method_print_catergories_tree)  
[arrange_categories_list](classes/MainWP-Dashboard-MainWP-Post-Page-Handler.html#method_arrange_categories_list)  
[posting_bulk](classes/MainWP-Dashboard-MainWP-Post-Page-Handler.html#method_posting_bulk)  
[posting](classes/MainWP-Dashboard-MainWP-Post-Page-Handler.html#method_posting)  
[posting_prepare](classes/MainWP-Dashboard-MainWP-Post-Page-Handler.html#method_posting_prepare)  
[ajax_posting_posts](classes/MainWP-Dashboard-MainWP-Post-Page-Handler.html#method_ajax_posting_posts)  
[ajax_get_sites_of_groups](classes/MainWP-Dashboard-MainWP-Post-Page-Handler.html#method_ajax_get_sites_of_groups)  
[posting_posts](classes/MainWP-Dashboard-MainWP-Post-Page-Handler.html#method_posting_posts)  
[get_post](classes/MainWP-Dashboard-MainWP-Post-Page-Handler.html#method_get_post)  
[new_post](classes/MainWP-Dashboard-MainWP-Post-Page-Handler.html#method_new_post)  
[create_post](classes/MainWP-Dashboard-MainWP-Post-Page-Handler.html#method_create_post)  
[replace_advanced_image](classes/MainWP-Dashboard-MainWP-Post-Page-Handler.html#method_replace_advanced_image)  
[upload_image](classes/MainWP-Dashboard-MainWP-Post-Page-Handler.html#method_upload_image)  
[add_sticky_handle](classes/MainWP-Dashboard-MainWP-Post-Page-Handler.html#method_add_sticky_handle)  
[add_status_handle](classes/MainWP-Dashboard-MainWP-Post-Page-Handler.html#method_add_status_handle)  
...
File
     [ pages/page-mainwp-post-page-handler.php ](files/pages-page-mainwp-post-page-handler.md)
Package
...
### ajax_handle_get_categories()

__
[code]
    ajax_handle_get_categories() : mixed
[/code]

_Method ajax_handle_get_categories()_
...
### print_catergories_tree()

__
[code]
    print_catergories_tree(array  $print_cats, array  $check_printed_cats_names = array()) : mixed
[/code]

_Method print_catergories_tree()_

#### Parameters

array | $print_cats  | categories to print.  
---|---|---  
array | $check_printed_cats_names  | check printed cats slugs.  
...
### arrange_categories_list()

__
[code]
    arrange_categories_list(array  $categories, array  $save_all_cats_tree) : mixed
[/code]

_Method arrange_categories_list()_
...
---|---|---  
array | $save_all_cats_tree  | all categories tree.  
...
__
[code]
    posting_prepare(int  $post_id) : mixed
[/code]

_Method posting_prepare()_
...
__
[code]
    ajax_posting_posts() : mixed
[/code]

_Method ajax_posting_posts()_
...
__
[code]
    ajax_get_sites_of_groups() : mixed
[/code]

_Method ajax_get_sites_of_groups()_
...
__
[code]
    posting_posts(int  $post_id, string  $what) : mixed
[/code]

_Method posting_posts()_
...
int | $post_id  | Post or Page ID.  
---|---|---  
string | $what  | What posting process.  
...
---|---|---  
bool | $replaceadvImg  | replace advanced images of post or not.  
...
bool | $withslashes  | to use preg pattern with slashes.  
...
_Method upload_image()_

Handle upload image.

#### Parameters

string | $img_url  | URL for the image.  
---|---|---  
array | $img_data  | Array of image data.  
...
__
[code]
    add_sticky_handle(mixed  $post_id) : int
[/code]

_Method add_sticky_handle()_
...
__
[code]
    add_status_handle(int  $post_id) : int
[/code]

_Method add_status_handle()_
...
### page-mainwp-post-page-handler.php
[/code]
[code] 
#  __
