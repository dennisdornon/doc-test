...
#  \MainWP\Dashboard\Module\Log Connector_Site

_Class Connector_Site_

## Summary

Methods Properties Constants [get_label](classes/MainWP-Dashboard-Module-Log-Connector-Site.html#method_get_label)  
[get_action_labels](classes/MainWP-Dashboard-Module-Log-Connector-Site.html#method_get_action_labels)  
[get_context_labels](classes/MainWP-Dashboard-Module-Log-Connector-Site.html#method_get_context_labels)  
[callback_mainwp_site_added](classes/MainWP-Dashboard-Module-Log-Connector-Site.html#method_callback_mainwp_site_added)  
[callback_mainwp_site_sync](classes/MainWP-Dashboard-Module-Log-Connector-Site.html#method_callback_mainwp_site_sync)  
[callback_mainwp_site_deleted](classes/MainWP-Dashboard-Module-Log-Connector-Site.html#method_callback_mainwp_site_deleted)  
[callback_mainwp_site_reconnected](classes/MainWP-Dashboard-Module-Log-Connector-Site.html#method_callback_mainwp_site_reconnected)  
[callback_mainwp_site_updated](classes/MainWP-Dashboard-Module-Log-Connector-Site.html#method_callback_mainwp_site_updated)  
[callback_mainwp_site_suspended](classes/MainWP-Dashboard-Module-Log-Connector-Site.html#method_callback_mainwp_site_suspended)  
[callback_mainwp_site_tag_action](classes/MainWP-Dashboard-Module-Log-Connector-Site.html#method_callback_mainwp_site_tag_action)  
...
File
     [ modules/logs/connectors/class-connector-site.php ](files/modules-logs-connectors-class-connector-site.md)
Package
...
Inherited from
    [\MainWP\Dashboard\Module\Log\Connector_Site](classes/MainWP-Dashboard-Module-Log-Connector-Site.md)
...
__
[code]
    callback_mainwp_site_added(object  $website) : bool
[/code]

_Log site added process._

#### Parameters

object | $website  | Website object data.  
---|---|---  
...
__
[code]
    callback_mainwp_site_sync(object  $website, array  $information, bool  $success, string  $sync_error = '') : bool
[/code]
...
object | $website  | Website object data.  
---|---|---  
array | $information  | Sync array data.  
bool | $success  | Sync success or failed.  
string | $sync_error  | Sync error data (options).  
...
__
[code]
    callback_mainwp_site_deleted(object  $website) : bool
[/code]
...
__
[code]
    callback_mainwp_site_updated(object  $website) : bool
[/code]

_Log site updated process._
...
__
[code]
    callback_mainwp_site_suspended(object  $website, int  $suspended) : bool
[/code]

_Log site updated suspended process._

#### Parameters

object | $website  | Website object data.  
---|---|---  
int | $suspended  | suspended value.  
...
__
[code]
    callback_mainwp_site_tag_action(object  $tag, string  $action, array  $data = array()) : bool
[/code]
...
object | $tag  | tag object data.  
---|---|---  
string | $action  | tag action.  
array | $data  | other data array (option).  
