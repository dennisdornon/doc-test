...
#  \MainWP\Dashboard MainWP_Cron_Jobs_Auto_Updates

_Class MainWP_Cron_Jobs_Auto_Updates_

## Summary

Methods Properties Constants [instance](classes/MainWP-Dashboard-MainWP-Cron-Jobs-Auto-Updates.html#method_instance)  
[__construct](classes/MainWP-Dashboard-MainWP-Cron-Jobs-Auto-Updates.html#method___construct)  
[check_to_run_auto_updates](classes/MainWP-Dashboard-MainWP-Cron-Jobs-Auto-Updates.html#method_check_to_run_auto_updates)  
[handle_cron_auto_updates](classes/MainWP-Dashboard-MainWP-Cron-Jobs-Auto-Updates.html#method_handle_cron_auto_updates)  
[get_next_auto_updates_timestamp](classes/MainWP-Dashboard-MainWP-Cron-Jobs-Auto-Updates.html#method_get_next_auto_updates_timestamp)  
[calculate_days_in_month](classes/MainWP-Dashboard-MainWP-Cron-Jobs-Auto-Updates.html#method_calculate_days_in_month)  
[set_next_auto_updates_time](classes/MainWP-Dashboard-MainWP-Cron-Jobs-Auto-Updates.html#method_set_next_auto_updates_time)  
[finished_auto_updates](classes/MainWP-Dashboard-MainWP-Cron-Jobs-Auto-Updates.html#method_finished_auto_updates)  
[finished_site_auto_updates](classes/MainWP-Dashboard-MainWP-Cron-Jobs-Auto-Updates.html#method_finished_site_auto_updates)  
[log_start_auto_updates](classes/MainWP-Dashboard-MainWP-Cron-Jobs-Auto-Updates.html#method_log_start_auto_updates)  
_No public properties found_ _No public constants found_ _No protected methods found_ _No protected properties found_ _No protected constants found_ _No private methods found_ [instance](classes/MainWP-Dashboard-MainWP-Cron-Jobs-Auto-Updates.html#property_instance)  
_No private constants found_

File
     [ class/class-mainwp-cron-jobs-auto-updates.php ](files/class-class-mainwp-cron-jobs-auto-updates.md)
Package
...
Inherited from
    [\MainWP\Dashboard\MainWP_Cron_Jobs_Auto_Updates](classes/MainWP-Dashboard-MainWP-Cron-Jobs-Auto-Updates.md)
...
### check_to_run_auto_updates()

__
[code]
    check_to_run_auto_updates() : mixed
[/code]

_Method check_to_run_auto_updates()_
...
### handle_cron_auto_updates()

__
[code]
    handle_cron_auto_updates() : mixed
[/code]

_Method handle_cron_auto_updates()_
...
### get_next_auto_updates_timestamp()

__
[code]
    get_next_auto_updates_timestamp() : mixed
[/code]

_Method get_next_auto_updates_timestamp()_
...
__
[code]
    calculate_days_in_month(int  $month, int  $year) : mixed
[/code]

_Method calculate_days_in_month()._
...
### set_next_auto_updates_time()

__
[code]
    set_next_auto_updates_time() : mixed
[/code]

_Method set_next_auto_updates_time()_
...
### finished_auto_updates()

__
[code]
    finished_auto_updates() : mixed
[/code]

_Method finished_auto_updates()_
...
### finished_site_auto_updates()

__
[code]
    finished_site_auto_updates(object  $website) : mixed
[/code]

_Method finished_site_auto_updates()_
...
### log_start_auto_updates()

__
[code]
    log_start_auto_updates() : mixed
[/code]

_Method log_start_auto_updates()_
...
### class-mainwp-cron-jobs-auto-updates.php
[/code]
[code] 
#  __
