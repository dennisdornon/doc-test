...
#  \MainWP\Dashboard\Module\Log Connector_User

_Class Connector_User_

## Summary

Methods Properties Constants [get_label](classes/MainWP-Dashboard-Module-Log-Connector-User.html#method_get_label)  
[get_action_labels](classes/MainWP-Dashboard-Module-Log-Connector-User.html#method_get_action_labels)  
[get_context_labels](classes/MainWP-Dashboard-Module-Log-Connector-User.html#method_get_context_labels)  
[callback_mainwp_user_action](classes/MainWP-Dashboard-Module-Log-Connector-User.html#method_callback_mainwp_user_action)  
...
File
     [ modules/logs/connectors/class-connector-user.php ](files/modules-logs-connectors-class-connector-user.md)
Package
...
Inherited from
    [\MainWP\Dashboard\Module\Log\Connector_User](classes/MainWP-Dashboard-Module-Log-Connector-User.md)
...
### callback_mainwp_user_action()

__
[code]
    callback_mainwp_user_action(object  $website, string  $pAction, array  $data) : mixed
[/code]
