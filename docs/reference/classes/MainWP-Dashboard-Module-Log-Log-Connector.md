...
#  \MainWP\Dashboard\Module\Log Log_Connector

_Class Log_Connector_

## Summary

Methods Properties Constants [is_registered](classes/MainWP-Dashboard-Module-Log-Log-Connector.html#method_is_registered)  
[register](classes/MainWP-Dashboard-Module-Log-Log-Connector.html#method_register)  
[callback](classes/MainWP-Dashboard-Module-Log-Log-Connector.html#method_callback)  
[log](classes/MainWP-Dashboard-Module-Log-Log-Connector.html#method_log)  
[log_record](classes/MainWP-Dashboard-Module-Log-Log-Connector.html#method_log_record)  
[get_changed_keys](classes/MainWP-Dashboard-Module-Log-Log-Connector.html#method_get_changed_keys)  
...
File
     [ modules/logs/classes/class-log-connector.php ](files/modules-logs-classes-class-log-connector.md)
Package
...
_Actions registered for this connector_
...
_Is the connector currently registered?_
...
_Callback for all registered hooks throughout Log Looks for a class method with the convention: "callback_{action name}"_
...
int | $site_id  | Target site id.  
string | $context  | Context of the event.  
string | $action  | Action of the event.  
int|null | $state  | action status: null - N/A, 0 - failed, 1 - success.  
int | $user_id  | User responsible for the event.  
...
__
[code]
    log_record(array  $recordarr) : bool|\MainWP\Dashboard\Module\Log\WP_Error
[/code]
...
array | $recordarr  | sprintf (and extra) arguments to use.  
---|---|---  
  
#### Returns

bool|\MainWP\Dashboard\Module\Log\WP_Error —
...
bool|int | $deep  | Get array children changes keys as well, not just parents.  
