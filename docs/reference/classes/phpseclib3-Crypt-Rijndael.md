...
_Pure-PHP implementation of Rijndael._
...
[setBlockLength](classes/phpseclib3-Crypt-Rijndael.html#method_setBlockLength)  
...
[getTables](classes/phpseclib3-Crypt-Rijndael.html#method_getTables)  
[getInvTables](classes/phpseclib3-Crypt-Rijndael.html#method_getInvTables)  
[setupInlineCrypt](classes/phpseclib3-Crypt-Rijndael.html#method_setupInlineCrypt)  
...
[key_length](classes/phpseclib3-Crypt-Rijndael.html#property_key_length)  
...
File
     [ libs/phpseclib/vendor/phpseclib/phpseclib/phpseclib/Crypt/Rijndael.php ](files/libs-phpseclib-vendor-phpseclib-phpseclib-phpseclib-crypt-rijndael.md)
Package
...
See also
    [](\\phpseclib3\\Crypt\\self::setKeyLength\(\))
...
_The Block Length divided by 32_
...
See also
    [](\\phpseclib3\\Crypt\\self::setBlockLength\(\))
...
_Holds the last used key- and block_size information_
...
__
[code]
    setBlockLength(int  $length) : mixed
[/code]

_Sets the block length_
...
Inherited from
    [\phpseclib3\Crypt\Rijndael](classes/phpseclib3-Crypt-Rijndael.md)
...
_Sets additional authenticated data_
...
_Returns whether or not the algorithm uses an IV_
...
_Returns whether or not the algorithm uses a nonce_
...
_Returns the current key length in bits_
...
_Returns the current block length in bits_
...
_Returns the current block length in bytes_
...
__
[code]
    setPassword(string  $password, string  $method = 'pbkdf2', int|string  ...$func_args) : bool
[/code]

_Sets the password._

Depending on what $method is set to, setPassword()'s (optional) parameters are as follows: {@link http://en.wikipedia.org/wiki/PBKDF2} or pbkdf1: $hash, $salt, $count, $dkLen
[code] 
...
Inherited from
    [\phpseclib3\Crypt\Common\SymmetricKey](classes/phpseclib3-Crypt-Common-SymmetricKey.md)
See also
    [](\\phpseclib3\\Crypt\\Common\\self::disablePadding\(\))
...
_Treat consecutive "packets" as if they are a continuous buffer._
...
_Treat consecutive packets as if they are a discontinuous buffer._
...
_Sets the preferred crypt engine_
...
_Returns the engine currently being utilized_
...
__
[code]
    continuousBufferEnabled() : bool
[/code]

_Is the continuous buffer enabled?_
...
_Setup the self::ENGINE_INTERNAL $engine_
...
_Provides the mixColumns and sboxes tables_
...
Inherited from
    [\phpseclib3\Crypt\Rijndael](classes/phpseclib3-Crypt-Rijndael.md)
See also
    [](\\phpseclib3\\Crypt\\self::encryptBlock\(\))
    [](\\phpseclib3\\Crypt\\self::setupInlineCrypt\(\))
    [](\\phpseclib3\\Crypt\\self::subWord\(\))
...
_Provides the inverse mixColumns and inverse sboxes tables_
...
Inherited from
    [\phpseclib3\Crypt\Rijndael](classes/phpseclib3-Crypt-Rijndael.md)
See also
    [](\\phpseclib3\\Crypt\\self::decryptBlock\(\))
    [](\\phpseclib3\\Crypt\\self::setupInlineCrypt\(\))
...
_Setup the performance-optimized function for de/encrypt()_
...
Inherited from
    [\phpseclib3\Crypt\Rijndael](classes/phpseclib3-Crypt-Rijndael.md)
See also
    [](\\phpseclib3\\Crypt\\Common\\SymmetricKey::setupInlineCrypt\(\))
...
_phpseclib <-> OpenSSL Mode Mapper_
...
_Sets the engine as appropriate_
...
Inherited from
    [\phpseclib3\Crypt\Common\SymmetricKey](classes/phpseclib3-Crypt-Common-SymmetricKey.md)
See also
    [](\\phpseclib3\\Crypt\\Common\\self::unpad\(\))
...
Inherited from
    [\phpseclib3\Crypt\Common\SymmetricKey](classes/phpseclib3-Crypt-Common-SymmetricKey.md)
See also
    [](\\phpseclib3\\Crypt\\Common\\self::pad\(\))
...
_Creates the performance-optimized function for en/decrypt()_
...
__
[code]
    safe_intval(string  $x) : int
[/code]

_Convert float to int_
...
_eval() 'able string for in-line float to int_
...
_NULL pads a string to be a multiple of 128_
...
__
[code]
    subWord(int  $word) : array
[/code]

_Performs S-Box substitutions_
