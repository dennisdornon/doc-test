...
#  \MainWP\Dashboard\Module\Log Log_Filter_Input

_Class - Log_Filter_Input_

## Summary

Methods Properties Constants [super](classes/MainWP-Dashboard-Module-Log-Log-Filter-Input.html#method_super)  
[filter](classes/MainWP-Dashboard-Module-Log-Log-Filter-Input.html#method_filter)  
[is_regex](classes/MainWP-Dashboard-Module-Log-Log-Filter-Input.html#method_is_regex)  
[is_ip_address](classes/MainWP-Dashboard-Module-Log-Log-Filter-Input.html#method_is_ip_address)  
[filter_callbacks](classes/MainWP-Dashboard-Module-Log-Log-Filter-Input.html#property_filter_callbacks)  
...
File
     [ modules/logs/classes/class-log-filter-input.php ](files/modules-logs-classes-class-log-filter-input.md)
Package
...
_Callbacks to be used for input validation/sanitation._
...
int | $type  | Input type.  
---|---|---  
string | $variable_name  | Variable key.  
int | $filter  | Filter callback.  
array | $options  | Filter callback parameters.  
...
Inherited from
    [\MainWP\Dashboard\Module\Log\Log_Filter_Input](classes/MainWP-Dashboard-Module-Log-Log-Filter-Input.md)
...
__
[code]
    is_regex(string  $var_value) : bool
[/code]

_Returns whether the variable is a Regular Expression or not?_

#### Parameters

string | $var_value  | Raw input.  
---|---|---  
...
__
[code]
    is_ip_address(string  $var_value) : bool
[/code]

_Returns whether the variable is an IP address or not?_
