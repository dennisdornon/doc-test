...
#  \MainWP\Dashboard MainWP_Extensions_Handler

_Class MainWP_Extensions_Handler_

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_get_class_name)  
[get_extension_slug](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_get_extension_slug)  
[get_slugs](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_get_slugs)  
[polish_ext_name](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_polish_ext_name)  
[polish_string_name](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_polish_string_name)  
[get_extensions](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_get_extensions)  
[get_extensions_disabled](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_get_extensions_disabled)  
[get_extensions_not_installed](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_get_extensions_not_installed)  
[get_indexed_extensions_infor](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_get_indexed_extensions_infor)  
[gen_api_password](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_gen_api_password)  
[add_extension_menu](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_add_extension_menu)  
[http_request_reject_unsafe_urls](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_http_request_reject_unsafe_urls)  
[no_ssl_filter_function](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_no_ssl_filter_function)  
[no_ssl_filter_extension_upgrade](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_no_ssl_filter_extension_upgrade)  
[install_plugin](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_install_plugin)  
[is_extension_available](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_is_extension_available)  
[is_extension_enabled](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_is_extension_enabled)  
[added_on_menu](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_added_on_menu)  
[is_extension_activated](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_is_extension_activated)  
[hook_verify](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_hook_verify)  
[hook_get_dashboard_sites](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_hook_get_dashboard_sites)  
[hook_fetch_urls_authed](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_hook_fetch_urls_authed)  
[hook_fetch_url_authed](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_hook_fetch_url_authed)  
[fetch_url_authed](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_fetch_url_authed)  
[hook_get_db_sites](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_hook_get_db_sites)  
[hook_get_db_websites](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_hook_get_db_websites)  
[hook_get_sites](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_hook_get_sites)  
[hook_get_groups](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_hook_get_groups)  
[hook_get_all_extensions](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_hook_get_all_extensions)  
[hook_clone_site](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_hook_clone_site)  
[hook_delete_clone_site](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_hook_delete_clone_site)  
[hook_add_group](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#method_hook_add_group)  
[extensions](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#property_extensions)  
[extensions_disabled](classes/MainWP-Dashboard-MainWP-Extensions-Handler.html#property_extensions_disabled)  
...
File
     [ pages/page-mainwp-extensions-handler.php ](files/pages-page-mainwp-extensions-handler.md)
Package
...
__
[code]
    get_extension_slug(mixed  $slug) : string
[/code]

_Get Extension Slug._

#### Parameters

mixed | $slug  | Extension Slug.  
---|---|---  
...
string | $extension  | Array of MainWP Extentsions.  
---|---|---  
bool | $forced  | forced polish.  
...
__
[code]
    polish_string_name(string  $name) : string
[/code]
...
string | $name  | Extention name string.  
---|---|---  
...
bool | $forced  | Forced reload value.  
---|---|---  
...
bool | $compatible_api_response  | To get compatible api response values.  
---|---|---  
...
### get_extensions_not_installed()

__
[code]
    get_extensions_not_installed() : array
[/code]

_Get not installed MainWP Extensions._

#### Returns

array —

Array of not installed Extensions.
...
---|---|---  
bool | $deactivated_license  | Get extensions that deactivated license or not.  
...
int | $length  | Lenght of password.  
---|---|---  
bool | $special_chars  | true|false, allow special characters.  
bool | $extra_special_chars  | true|false, allow extra special characters.  
...
__
[code]
    add_extension_menu(mixed  $slug) : bool
[/code]

_Add Extension Menu._
...
__
[code]
    http_request_reject_unsafe_urls(bool  $args) : mixed
[/code]

_HTTP Request Reject Unsafe Urls._
...
__
[code]
    no_ssl_filter_function(bool  $args) : mixed
[/code]

_No SSL Filter Function._
...
__
[code]
    no_ssl_filter_extension_upgrade(bool  $r, mixed  $url) : mixed
[/code]

_No SSL Filter Extention Upgrade._

#### Parameters

bool | $r  | Results.  
---|---|---  
mixed | $url  | Upgrade Extension URL.  
...
mixed | $url  | MainWP Extension update URL.  
---|---|---  
bool | $activatePlugin  | true|false Whether or not to activate extension.  
...
__
[code]
    is_extension_available(mixed  $pAPI) : bool
[/code]

_Check if MainWP Extension is available._

#### Parameters

mixed | $pAPI  | MainWP Extension API Key.  
---|---|---  
...
_Check if MainWP Extension is enabled._

#### Parameters

mixed | $pluginFile  | MainWP Extension to bo verified.  
---|---|---  
...
_Create Menu Extension Array._

#### Parameters

mixed | $slug  | menu slug.  
---|---|---  
...
__
[code]
    is_extension_activated(mixed  $plugin_slug) : bool
[/code]

_Check if MainWP Extension is activated or not._

#### Parameters

mixed | $plugin_slug  | MainWP Extension slug.  
---|---|---  
...
_Verify MainWP Extension._

#### Parameters

mixed | $pluginFile  | MainWP Extensoin to verify.  
---|---|---  
mixed | $key  | Child Site Key.  
...
_Get sql websites for current user._

#### Parameters

mixed | $pluginFile  | Extension plugin file to verify.  
---|---|---  
mixed | $key  | PThe child-key.  
...
### hook_get_db_websites()

__
[code]
    hook_get_db_websites(mixed  $pluginFile, mixed  $key, mixed  $params = array()) : array
[/code]
...
---|---|---  
string | $key  | The child-key.  
int | $groupid  | The id of the group you wish to retrieve.  
bool | $for_manager  | Check Team Control.  
...
bool | $force_update  | true|false, force an update.  
...
mixed | $key  | The child-key.  
mixed | $clone_url  | URL to Clone to.  
bool | $clone_site_id  | Cloned Site ID.  
...
---|---|---  
mixed | $key  | The child-key.  
mixed | $newName  | Name that you want to give the group.  
...
### page-mainwp-extensions-handler.php
[/code]
[code] 
#  __
