...
#  \MainWP\Dashboard MainWP_Monitoring_Handler

_Class MainWP_Monitoring_Handler_

## Summary

Methods Properties Constants [handle_settings_post](classes/MainWP-Dashboard-MainWP-Monitoring-Handler.html#method_handle_settings_post)  
[handle_check_website](classes/MainWP-Dashboard-MainWP-Monitoring-Handler.html#method_handle_check_website)  
[get_http_noticed_status_value](classes/MainWP-Dashboard-MainWP-Monitoring-Handler.html#method_get_http_noticed_status_value)  
[get_health_noticed_status_value](classes/MainWP-Dashboard-MainWP-Monitoring-Handler.html#method_get_health_noticed_status_value)  
[get_site_checking_status](classes/MainWP-Dashboard-MainWP-Monitoring-Handler.html#method_get_site_checking_status)  
[notice_sites_uptime_monitoring](classes/MainWP-Dashboard-MainWP-Monitoring-Handler.html#method_notice_sites_uptime_monitoring)  
[notice_site_health_threshold](classes/MainWP-Dashboard-MainWP-Monitoring-Handler.html#method_notice_site_health_threshold)  
...
File
     [ class/class-mainwp-monitoring-handler.php ](files/class-class-mainwp-monitoring-handler.md)
Package
    

DashboardThisclasshandlesthe\POSTofSettingsOptions
...
package  |  MainWP\Dashboard This class handles the $_POST of Settings Options.  
---|---  
uses  |   
method  |   
property  |   
...
__
[code]
    handle_check_website(object  $website) : mixed
[/code]

_Check a website HTTP header status._
...
__
[code]
    get_http_noticed_status_value(object  $website, int  $new_code) : int
[/code]

_Get a new HTTP status notice._

#### Parameters

object | $website  | Object containing the website info.  
---|---|---  
int | $new_code  | The new HTTP code value.  
...
__
[code]
    get_health_noticed_status_value(object  $website, object  $new_health) : int
[/code]

_Get new site health value._
...
__
[code]
    get_site_checking_status(int  $http_code) : mixed
[/code]

_Determin if site is up or down based on HTTP code._

#### Parameters

int | $http_code  | HTTP code.  
---|---|---  
...
bool | $plain_text  | Determines if the plain text format should be used.  
bool | $general  | Determines if it's a general notification.  
bool | $to_admin  | Send to admin or not.  
...
### class-mainwp-monitoring-handler.php
[/code]
[code] 
#  __
