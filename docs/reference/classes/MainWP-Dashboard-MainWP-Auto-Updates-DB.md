...
[get_websites_check_updates](classes/MainWP-Dashboard-MainWP-Auto-Updates-DB.html#method_get_websites_check_updates)  
[get_websites_to_start_updates](classes/MainWP-Dashboard-MainWP-Auto-Updates-DB.html#method_get_websites_to_start_updates)  
[get_websites_to_continue_updates](classes/MainWP-Dashboard-MainWP-Auto-Updates-DB.html#method_get_websites_to_continue_updates)  
[get_websites_to_continue_individual_updates](classes/MainWP-Dashboard-MainWP-Auto-Updates-DB.html#method_get_websites_to_continue_individual_updates)  
[get_websites_check_updates_count](classes/MainWP-Dashboard-MainWP-Auto-Updates-DB.html#method_get_websites_check_updates_count)  
[get_websites_count_where_dts_automatic_sync_smaller_then_start](classes/MainWP-Dashboard-MainWP-Auto-Updates-DB.html#method_get_websites_count_where_dts_automatic_sync_smaller_then_start)  
[get_websites_last_automatic_sync](classes/MainWP-Dashboard-MainWP-Auto-Updates-DB.html#method_get_websites_last_automatic_sync)  
...
_No protected constants found_ _No private methods found_ [instance](classes/MainWP-Dashboard-MainWP-Auto-Updates-DB.html#property_instance)  
_No private constants found_

File
     [ class/class-mainwp-auto-updates-db.php ](files/class-class-mainwp-auto-updates-db.md)
Package
...
__
[code]
    get_websites_check_updates(int  $limit, int  $lasttime_start, bool  $connected = false, bool  $not_suspended = false) : object|null
[/code]

_Get child sites check updates._

#### Parameters

int | $limit  | Query limit.  
---|---|---  
int | $lasttime_start  | Lasttime start automatic update.  
bool | $connected  | Requires sites connected.  
bool | $not_suspended  | Requires sites unsuspended.  
...
Inherited from
    [\MainWP\Dashboard\MainWP_Auto_Updates_DB](classes/MainWP-Dashboard-MainWP-Auto-Updates-DB.md)
...
### get_websites_to_start_updates()

__
[code]
    get_websites_to_start_updates(bool  $connected = false, bool  $not_suspended = false) : object|null
[/code]

_Get child sites to start updates._
...
### get_websites_to_continue_updates()

__
[code]
    get_websites_to_continue_updates(int  $limit, int  $lasttime_start, bool  $connected = false, bool  $not_suspended = false) : object|null
[/code]

_Get child sites to continue updates._

#### Parameters

int | $limit  | limit sites to continue updates.  
---|---|---  
int | $lasttime_start  | Lasttime start automatic update.  
bool | $connected  | Requires sites connected.  
bool | $not_suspended  | Requires sites unsuspended.  
...
### get_websites_to_continue_individual_updates()

__
[code]
    get_websites_to_continue_individual_updates(int  $limit = 4, int  $lasttime_start = false) : object|null
[/code]
...
__
[code]
    get_websites_check_updates_count(int  $lasttime_start) : int
[/code]

_Get websites check updates count._
...
__
[code]
    get_websites_count_where_dts_automatic_sync_smaller_then_start(int  $lasttime_start) : int
[/code]

_Get child site count where date & time Session sync is smaller then start._

#### Parameters

int | $lasttime_start  | Last time start automatic.  
---|---|---  
...
_Get child site last automatic sync date & time._
...
__
[code]
    get_option_view_by(array  $view = '', array  $other_fields = array()) : array
[/code]
...
array | $view  | Option view.  
---|---|---  
array | $other_fields  | Extra option fields.  
...
### get_select_groups_belong()

__
[code]
    get_select_groups_belong() : string
[/code]

_Method get_select_groups_belong()._
...
array | $sites_ids  | Websites ids - option field.  
---|---|---  
...
---|---|---  
bool | $all_access  | Check if user has access to all sites.  
...
__
[code]
    get_websites_stats_count(array  $params = array()) : mixed
[/code]

_Get child sites stats count._
...
mixed | $json_format  | Is json format value.  
...
_Get child site options._

#### Parameters

array | $website  | Child site.  
---|---|---  
mixed | $options  | Child site options name.  
...
__
[code]
    update_website_option(object  $website, mixed  $option, mixed  $value) : mixed
[/code]

_Update child site options._

#### Parameters

object | $website  | Child site object.  
---|---|---  
mixed | $option  | Option to update.  
mixed | $value  | Value to update with.  
...
### remove_website_option()

__
[code]
    remove_website_option(object  $website, mixed  $options) : mixed
[/code]

_Remove child site options._

#### Parameters

object | $website  | Child site object.  
---|---|---  
mixed | $options  | Option to update.  
...
__
[code]
    update_general_option(mixed  $option, mixed  $value, string  $type_value = 'single') : mixed
[/code]

_Update general site options._
...
---|---|---  
mixed | $value  | Value to update with.  
string | $type_value  | Type values: single|array.  
...
mixed | $opt  | Child Site option name.  
---|---|---  
string | $type_value  | Type values: single|array.  
...
int | $userid  | Given user ID.  
---|---|---  
bool | $selectgroups  | Selected groups. Default: false.  
null | $search_site  | Site search field value. Default: null.  
string | $orderBy  | Order list by. Default: URL.  
bool | $offset  | Query offset. Default: false.  
bool | $rowcount  | Row count. Default: falese.  
...
string | $orderBy  | Order list by. Default: URL.  
bool | $offset  | Query offset. Default: false.  
bool | $rowcount  | Row count. Default: false.  
null | $extraWhere  | Extra WHERE. Default: null.  
bool | $for_manager  | For role manager. Default: false.  
...
_Get SQL to get wp child sites for current user._
...
_Get SQL select websites fields._

#### Parameters

array | $other_fields  | extra select wp fields .  
---|---|---  
...
_Get child sites for current user._

#### Parameters

array | $params  | to get sites. Default: array().  
---|---|---  
...
__
[code]
    get_sql_search_websites_for_current_user(array  $params) : bool|null
[/code]

_Get the child sites the current user has searched for._
...
__
[code]
    get_sql_where_allow_access_sites(string  $site_table_alias = '', string  $is_staging = 'no') : bool|null
[/code]

_Get child sites where allowed access via SQL._
...
__
[code]
    get_sql_where_allow_groups(string  $group_table_alias = '', string  $with_staging = 'no') : bool|null
[/code]

_Get groupd where allowed access via SQL._
...
int | $id  | Child site ID.  
---|---|---  
array | $params  | params.  
string | $obj  | OBJECT|ARRAY_A.  
...
### get_sql_website_by_params()

__
[code]
    get_sql_website_by_params(int  $id, array  $params = array()) : object|null
[/code]

_Get sql child site by id and params._
...
__
[code]
    get_websites_by_group_id(int  $id) : object|null
[/code]

_Get child sites by group ID._
...
__
[code]
    get_websites_by_group_name(int  $userid, string  $groupname) : object|null
[/code]
...
__
[code]
    get_wp_ip(int  $wpid) : string|null
[/code]

_Get child site IP address._

#### Parameters

int | $wpid  | Child site ID.  
---|---|---  
...
__
[code]
    add_website(int  $userid, string  $name, string  $url, string  $admin, string  $pubkey, string  $privkey, array  $params = array()) : int|false
[/code]

_Add website to the MainWP Dashboard._
...
__
[code]
    remove_website(int  $websiteid) : int|bool
[/code]

_Remove child site from the MainWP Dashboard._

#### Parameters

int | $websiteid  | Child site ID.  
---|---|---  
...
__
[code]
    update_website_values(int  $websiteid, array  $fields) : int|bool
[/code]

_Update child site db values._

#### Parameters

int | $websiteid  | Child site ID.  
---|---|---  
array | $fields  | Database fields to update.  
...
__
[code]
    update_website_sync_values(int  $websiteid, array  $fields) : int|bool
[/code]

_Update child site sync values._
...
__
[code]
    update_website(int  $websiteid, string  $url, int  $userid, string  $name, string  $siteadmin, array  $groupids, array  $groupnames, string  $pluginDir, mixed  $maximumFileDescriptorsOverride, mixed  $maximumFileDescriptorsAuto, mixed  $maximumFileDescriptors, int  $verifyCertificate = 1, mixed  $archiveFormat = 'global', string  $uniqueId = '', string  $http_user = null, string  $http_pass = null, int  $sslVersion = 0, bool  $disableHealthChecking = 1, int  $healthThreshold = 80, string  $backup_method = 'global') : bool
[/code]
...
int | $verifyCertificate  | Whether or not to verify SSL Certificate.  
...
bool | $disableHealthChecking  | Disable Site health threshold.  
int | $healthThreshold  | Site health threshold.  
string | $backup_method  | Primary backup method.  
...
_Get website update stats via SQL._
...
__
[code]
    update_website_stats(mixed  $websiteid, mixed  $statsUpdated) : int|bool
[/code]

_Update child site statistics._
...
__
[code]
    get_websites_to_notice_health_threshold(int  $globalThreshold) : mixed
[/code]

_Method get_websites_to_notice_health_threshold()_

Get websites to notice site health.

#### Parameters

int | $globalThreshold  | Global site health threshold.  
---|---|---  
...
### get_websites_http_check_status()

__
[code]
    get_websites_http_check_status() : array
[/code]

_Get websites offline status._
...
int | $websiteid  | The id of the child site you wish to retrieve.  
---|---|---  
bool | $for_manager  | Check Team Control.  
...
__
[code]
    get_lookup_items(string  $item_name, int  $item_id, string  $obj_name) : mixed
[/code]

_Method get_lookup_items()._

Get bulk lookup items to reduce number of db queries.

#### Parameters

string | $item_name  | lookup item name.  
---|---|---  
int | $item_id  | lookup item id.  
string | $obj_name  | loockup object name.  
...
__
[code]
    insert_lookup_item(string  $item_name, int  $item_id, string  $obj_name, int  $obj_id) : mixed
[/code]

_Method insert_lookup_item()._
...
__
[code]
    delete_lookup_items(string  $by = 'lookup_id', array  $params = array()) : mixed
[/code]

_Method delete_lookup_items()._
...
__
[code]
    insert_rest_api_key(string  $consumer_key, string  $consumer_secret, string  $scope, string  $description, int  $enabled, array  $others = array()) : array
[/code]

_Return the user data for the given consumer_key._

#### Parameters

string | $consumer_key  | Consumer key.  
---|---|---  
string | $consumer_secret  | Secret key.  
string | $scope  | scope.  
...
__
[code]
    update_rest_api_key(int  $key_id, string  $scope, string  $description, int  $enabled = 1) : array
[/code]

_Update rest api key._

#### Parameters

int | $key_id  | Consumer key.  
---|---|---  
string | $scope  | scope.  
string | $description  | description.  
int | $enabled  | Enabled.  
...
### is_existed_enabled_rest_key()

__
[code]
    is_existed_enabled_rest_key() : bool
[/code]

_Method is_existed_enabled_rest_key()._
...
__
[code]
    get_rest_api_key_by(int  $id) : array
[/code]

_Method get_rest_api_key_by()._
...
__
[code]
    remove_rest_api_key(string  $id) : array
[/code]

_Method remove_rest_api_key()._
...
__
[code]
    get_rest_api_keys() : array
[/code]

_Method get_rest_api_keys()._
...
### update_regular_process()

__
[code]
    update_regular_process(array  $data) : mixed
[/code]

_Update regular process._

#### Parameters

array | $data  | process data.  
---|---|---  
...
__
[code]
    get_regular_process_by_item_id_type_slug(int  $item_id, string  $type, string  $process_slug) : mixed
[/code]

_Method get_regular_process_by_item_id_type_slug_
...
---|---|---  
string | $type  | type.  
string | $process_slug  | process slug.  
...
__
[code]
    log_system_query(array  $params, string  $sql) : void
[/code]

_Method log_system_query_
...
### class-mainwp-auto-updates-db.php
[/code]
[code] 
#  __
...
Documentation is powered by [phpDocumentor ](https://www.phpdoc.org/) and authored on September 13th, 2026 at 00:44. 
  ...
  *[MainWP_DB]: \MainWP\Dashboard\MainWP_DB
