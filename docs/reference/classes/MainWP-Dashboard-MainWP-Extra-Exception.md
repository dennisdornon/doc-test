...
_Extra exception class._

## Summary

Methods Properties Constants [__construct](classes/MainWP-Dashboard-MainWP-Extra-Exception.html#method___construct)  
[getErrorCode](classes/MainWP-Dashboard-MainWP-Extra-Exception.html#method_getErrorCode)  
[getErrorData](classes/MainWP-Dashboard-MainWP-Extra-Exception.html#method_getErrorData)  
_No public properties found_ _No public constants found_ _No protected methods found_ [error_code](classes/MainWP-Dashboard-MainWP-Extra-Exception.html#property_error_code)  
[error_data](classes/MainWP-Dashboard-MainWP-Extra-Exception.html#property_error_data)  
_No protected constants found_ _No private methods found_ _No private properties found_ _No private constants found_

File
     [ class/class-mainwp-extra-exception.php ](files/class-class-mainwp-extra-exception.md)
Package
...
__
[code]
    __construct(string  $code, string  $message, string  $http_status_code = 400, array  $data = array()) : mixed
[/code]
...
string | $code  | Machine-readable error code, e.g `mainwp_invalid_site_id`.  
---|---|---  
string | $message  | User-friendly translated error message, e.g. 'Site ID is invalid'.  
string | $http_status_code  | HTTP status code.  
array | $data  | Extra error data.  
...
Inherited from
    [\MainWP\Dashboard\MainWP_Extra_Exception](classes/MainWP-Dashboard-MainWP-Extra-Exception.md)
...
### class-mainwp-extra-exception.php
[/code]
[code] 
#  __
