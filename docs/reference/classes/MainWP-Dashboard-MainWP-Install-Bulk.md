...
_Class MainWP_Install_Bulk_

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Install-Bulk.html#method_get_class_name)  
[init](classes/MainWP-Dashboard-MainWP-Install-Bulk.html#method_init)  
[admin_init](classes/MainWP-Dashboard-MainWP-Install-Bulk.html#method_admin_init)  
[render_upload](classes/MainWP-Dashboard-MainWP-Install-Bulk.html#method_render_upload)  
[prepare_install](classes/MainWP-Dashboard-MainWP-Install-Bulk.html#method_prepare_install)  
[addition_post_data](classes/MainWP-Dashboard-MainWP-Install-Bulk.html#method_addition_post_data)  
[perform_install](classes/MainWP-Dashboard-MainWP-Install-Bulk.html#method_perform_install)  
[prepare_upload](classes/MainWP-Dashboard-MainWP-Install-Bulk.html#method_prepare_upload)  
[get_selected_sites](classes/MainWP-Dashboard-MainWP-Install-Bulk.html#method_get_selected_sites)  
[perform_upload](classes/MainWP-Dashboard-MainWP-Install-Bulk.html#method_perform_upload)  
[clean_upload](classes/MainWP-Dashboard-MainWP-Install-Bulk.html#method_clean_upload)  
[install_plugin_theme_handler](classes/MainWP-Dashboard-MainWP-Install-Bulk.html#method_install_plugin_theme_handler)  
...
File
     [ pages/page-mainwp-install-bulk.php ](files/pages-page-mainwp-install-bulk.md)
Package
...
used-by  |  MainWP_Plugins::InstallPlugins MainWP_Themes::InstallThemes  
---|---  
...
Uses
     [\MainWP\Dashboard\static::init()](\\MainWP\\Dashboard\\static::init\(\))
...
__
[code]
    render_upload(string  $type) : mixed
[/code]

_Method render_upload()_

Renders the upload sub part.

#### Parameters

string | $type  | Plugin|Theme Type of upload.  
---|---|---  
...
__
[code]
    prepare_install() : mixed
[/code]

_Method prepare_install()_
...
_Method addition_post_data()_

Grab Post addition data.

#### Parameters

array | $post_data  | Data for post.  
---|---|---  
...
__
[code]
    prepare_upload() : mixed
[/code]

_Method prepare_upload()_
...
Uses
     ...
     [\MainWP\Dashboard\MainWP_DB::fetch_object()](\\MainWP\\Dashboard\\MainWP_DB::fetch_object\(\))
     [\MainWP\Dashboard\MainWP_DB::free_result()](\\MainWP\\Dashboard\\MainWP_DB::free_result\(\))
     [\MainWP\Dashboard\MainWP_System_Utility::get_download_url()](classes/MainWP-Dashboard-MainWP-System-Utility.html#method_get_download_url)
     [\MainWP\Dashboard\MainWP_Utility::ctype_digit()](classes/MainWP-Dashboard-MainWP-Utility.html#method_ctype_digit)
     [\MainWP\Dashboard\MainWP_Utility::map_site()](classes/MainWP-Dashboard-MainWP-Utility.html#method_map_site)
...
__
[code]
    get_selected_sites(array  $output) : mixed
[/code]
...
array | $output  | selected sites output.  
---|---|---  
...
__
[code]
    perform_upload() : mixed
[/code]

_Method perform_upload()_
...
_Plugin & Theme upload handler._

#### Parameters

mixed | $data  | Processing data.  
---|---|---  
object | $website  | The website object.  
mixed | $output  | Function output.  
mixed | $post_data  | Post data.  
