...
#  \MainWP\Dashboard MainWP_Manage_Sites_View

_Class MainWP_Manage_Sites_View_

## Summary

Methods Properties Constants [init_menu](classes/MainWP-Dashboard-MainWP-Manage-Sites-View.html#method_init_menu)  
[init_subpages_menu](classes/MainWP-Dashboard-MainWP-Manage-Sites-View.html#method_init_subpages_menu)  
[init_left_menu](classes/MainWP-Dashboard-MainWP-Manage-Sites-View.html#method_init_left_menu)  
[render_header](classes/MainWP-Dashboard-MainWP-Manage-Sites-View.html#method_render_header)  
[render_footer](classes/MainWP-Dashboard-MainWP-Manage-Sites-View.html#method_render_footer)  
[render_import_sites](classes/MainWP-Dashboard-MainWP-Manage-Sites-View.html#method_render_import_sites)  
[render_sync_exts_settings](classes/MainWP-Dashboard-MainWP-Manage-Sites-View.html#method_render_sync_exts_settings)  
[render_dashboard](classes/MainWP-Dashboard-MainWP-Manage-Sites-View.html#method_render_dashboard)  
[render_header_tabs](classes/MainWP-Dashboard-MainWP-Manage-Sites-View.html#method_render_header_tabs)  
[render_scan_site](classes/MainWP-Dashboard-MainWP-Manage-Sites-View.html#method_render_scan_site)  
[render_edit_site](classes/MainWP-Dashboard-MainWP-Manage-Sites-View.html#method_render_edit_site)  
[render_site_edit_email_settings](classes/MainWP-Dashboard-MainWP-Manage-Sites-View.html#method_render_site_edit_email_settings)  
[render_edit_template](classes/MainWP-Dashboard-MainWP-Manage-Sites-View.html#method_render_edit_template)  
[render_edit_site_email_settings](classes/MainWP-Dashboard-MainWP-Manage-Sites-View.html#method_render_edit_site_email_settings)  
[m_reconnect_site](classes/MainWP-Dashboard-MainWP-Manage-Sites-View.html#method_m_reconnect_site)  
[add_site](classes/MainWP-Dashboard-MainWP-Manage-Sites-View.html#method_add_site)  
[add_wp_site](classes/MainWP-Dashboard-MainWP-Manage-Sites-View.html#method_add_wp_site)  
[update_wp_site](classes/MainWP-Dashboard-MainWP-Manage-Sites-View.html#method_update_wp_site)  
_No public properties found_ _No public constants found_ _No protected methods found_ _No protected properties found_ _No protected constants found_ [render_managesites_header](classes/MainWP-Dashboard-MainWP-Manage-Sites-View.html#method_render_managesites_header)  
_No private properties found_ _No private constants found_

File
     [ class/class-mainwp-manage-sites-view.php ](files/class-class-mainwp-manage-sites-view.md)
Package
...
Inherited from
    [\MainWP\Dashboard\MainWP_Manage_Sites_View](classes/MainWP-Dashboard-MainWP-Manage-Sites-View.md)
Uses
     [\MainWP\Dashboard\MainWP_Manage_Sites::get_class_name()](classes/MainWP-Dashboard-MainWP-Manage-Sites.html#method_get_class_name)
...
__
[code]
    init_subpages_menu(array  $subPages) : mixed
[/code]
...
array | $subPages  | Sub pages array.  
---|---|---  
...
__
[code]
    render_header(string  $shownPage = '', array  $subPages = array()) : mixed
[/code]
...
string | $shownPage  | Current Page.  
---|---|---  
array | $subPages  | Sites subpages.  
...
__
[code]
    render_import_sites() : mixed
[/code]

_Method render_import_sites()_
...
__
[code]
    render_sync_exts_settings() : mixed
[/code]

_Method render_sync_exts_settings()_
...
Inherited from
    [\MainWP\Dashboard\MainWP_Manage_Sites_View](classes/MainWP-Dashboard-MainWP-Manage-Sites-View.md)
Uses
     [\MainWP\Dashboard\MainWP_Overview::render_dashboard_body()](classes/MainWP-Dashboard-MainWP-Overview.html#method_render_dashboard_body)
...
__
[code]
    render_header_tabs(mixed  $active_tab, mixed  $active_text, mixed  $show_language_updates) : mixed
[/code]

_Method render_header_tabs()_

Render Sites sub page header tabs.

#### Parameters

mixed | $active_tab  | Currently active tab.  
---|---|---  
mixed | $active_text  | Currently active drop down text.  
mixed | $show_language_updates  | Whether or not to show translations.  
...
__
[code]
    render_scan_site(mixed  $website) : mixed
[/code]

_Method render_scan_site()_
...
---|---|---  
mixed | $updated  | Site settings updated check.  
...
Uses
     ...
     [\MainWP\Dashboard\MainWP_DB_Common::get_groups_by_website_id()](classes/MainWP-Dashboard-MainWP-DB-Common.html#method_get_groups_by_website_id)
     [\MainWP\Dashboard\MainWP_DB::get_website_by_id()](classes/MainWP-Dashboard-MainWP-DB.html#method_get_website_by_id)
...
__
[code]
    render_site_edit_email_settings(object  $website, string  $type, bool  $updated_templ) : mixed
[/code]

_Render single site Email notification settings._
...
object | $website  | Object containng the website info.  
---|---|---  
string | $type  | Email type.  
bool | $updated_templ  | True if page loaded after update, false if not.  
...
Uses
     ...
     [\MainWP\Dashboard\MainWP_Notification_Settings::get_settings_desc()](classes/MainWP-Dashboard-MainWP-Notification-Settings.html#method_get_settings_desc)
     [\MainWP\Dashboard\MainWP_Notification_Settings::render_update_template_message()](classes/MainWP-Dashboard-MainWP-Notification-Settings.html#method_render_update_template_message)
...
Uses
     [\MainWP\Dashboard\MainWP_Notification_Template::get_template_name_by_notification_type()](classes/MainWP-Dashboard-MainWP-Notification-Template.html#method_get_template_name_by_notification_type)
     [\MainWP\Dashboard\MainWP_Notification_Template::get_default_templates_dir()](classes/MainWP-Dashboard-MainWP-Notification-Template.html#method_get_default_templates_dir)
     [\MainWP\Dashboard\MainWP_Notification_Template::get_custom_templates_dir()](classes/MainWP-Dashboard-MainWP-Notification-Template.html#method_get_custom_templates_dir)
...
__
[code]
    render_edit_site_email_settings(object  $website, bool  $updated) : mixed
[/code]

_Render all email settings options._

#### Parameters

object | $website  | Object containing the website info.  
---|---|---  
bool | $updated  | True if page loaded after update, false if not.  
...
object | $website  | The website object.  
---|---|---  
bool | $sync_first  | True try to sync before reconnect.  
array | $params  | others params.  
...
mixed | $website  | Child Site.  
---|---|---  
array | $params  | Array of new Child Site to add.  
array | $output  | Output values.  
...
Uses
     ...
     [\MainWP\Dashboard\MainWP_DB::add_website()](classes/MainWP-Dashboard-MainWP-DB.html#method_add_website)
     [\MainWP\Dashboard\MainWP_DB::get_website_by_id()](classes/MainWP-Dashboard-MainWP-DB.html#method_get_website_by_id)
     [\MainWP\Dashboard\MainWP_Exception](classes/MainWP-Dashboard-MainWP-Exception.md)
     [\MainWP\Dashboard\MainWP_Sync::sync_information_array()](classes/MainWP-Dashboard-MainWP-Sync.html#method_sync_information_array)
     [\MainWP\Dashboard\MainWP_System_Utility::get_openssl_conf()](classes/MainWP-Dashboard-MainWP-System-Utility.html#method_get_openssl_conf)
...
__
[code]
    update_wp_site(mixed  $params) : int
[/code]

_Method update_wp_site()_

Update Child Site.

#### Parameters

mixed | $params  | Udate parameters.  
---|---|---  
...
__
[code]
    render_managesites_header(array  $site_pages, array  $managesites_pages, array  $subPages, int  $site_id, string  $shownPage) : mixed
[/code]

_Method render_managesites_header()_

Render manage sites header.

#### Parameters

array | $site_pages  | site pages.  
---|---|---  
array | $managesites_pages  | manage site pages.  
array | $subPages  | sub pages.  
int | $site_id  | Site id.  
string | $shownPage  | Current Page.  
...
### class-mainwp-manage-sites-view.php
[/code]
[code] 
#  __
