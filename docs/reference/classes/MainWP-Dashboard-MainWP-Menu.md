...
#  \MainWP\Dashboard MainWP_Menu

_Class MainWP_Menu_

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Menu.html#method_get_class_name)  
[get_instance](classes/MainWP-Dashboard-MainWP-Menu.html#method_get_instance)  
[__construct](classes/MainWP-Dashboard-MainWP-Menu.html#method___construct)  
[init_mainwp_menus](classes/MainWP-Dashboard-MainWP-Menu.html#method_init_mainwp_menus)  
[init_mainwp_menu_items](classes/MainWP-Dashboard-MainWP-Menu.html#method_init_mainwp_menu_items)  
[init_sub_pages](classes/MainWP-Dashboard-MainWP-Menu.html#method_init_sub_pages)  
[set_menu_active_slugs](classes/MainWP-Dashboard-MainWP-Menu.html#method_set_menu_active_slugs)  
[init_subpages_left_menu](classes/MainWP-Dashboard-MainWP-Menu.html#method_init_subpages_left_menu)  
[is_disable_menu_item](classes/MainWP-Dashboard-MainWP-Menu.html#method_is_disable_menu_item)  
[add_left_menu](classes/MainWP-Dashboard-MainWP-Menu.html#method_add_left_menu)  
[render_left_menu](classes/MainWP-Dashboard-MainWP-Menu.html#method_render_left_menu)  
[render_mobile_menu](classes/MainWP-Dashboard-MainWP-Menu.html#method_render_mobile_menu)  
[render_sub_item](classes/MainWP-Dashboard-MainWP-Menu.html#method_render_sub_item)  
[is_level2_menu_item_active](classes/MainWP-Dashboard-MainWP-Menu.html#method_is_level2_menu_item_active)  
...
File
     [ class/class-mainwp-menu.php ](files/class-class-mainwp-menu.md)
Package
...
__
[code]
    init_mainwp_menus() : mixed
[/code]

_Method init_mainwp_menus()_
...
__
[code]
    init_mainwp_menu_items(array  $menus_items, string  $part) : mixed
[/code]

_Method init_mainwp_menu_items()_

Init MainWP menus.

#### Parameters

array | $menus_items  | menus items.  
---|---|---  
string | $part  | menus part.  
...
__
[code]
    init_sub_pages() : mixed
[/code]

_Method init_sub_pages()_
...
__
[code]
    set_menu_active_slugs(string  $item, string  $active) : mixed
[/code]

_Method set_menu_active_slugs_

#### Parameters

string | $item  | Menu item.  
---|---|---  
string | $active  | Menu active slug.  
...
__
[code]
    init_subpages_left_menu(array  $subPages, array  $initSubpage, string  $parentKey, mixed  $slug) : mixed
[/code]

_Method init_subpages_left_menu_
...
__
[code]
    is_disable_menu_item(string  $level, array|string  $item) : bool
[/code]

_Method is_disable_menu_item_
...
---|---|---  
array|string | $item  | The menu items meta data.  
...
__
[code]
    add_left_menu(array  $params = array(), int  $level = 1) : array
[/code]

_Method add_left_menu_

Build Top Level Menu

#### Parameters

array | $params  | Menu Item parameters.  
---|---|---  
int | $level  | Menu Item Level 1 or 2.  
...
__
[code]
    render_left_menu() : mixed
[/code]

_Method render_left_menu_
...
__
[code]
    render_mobile_menu() : mixed
[/code]

_Method render_mobile_menu_
...
__
[code]
    render_sub_item(mixed  $parent_key) : mixed
[/code]

_Method render_sub_item_

Grabs all submenu items and attatches to Main Menu.

#### Parameters

mixed | $parent_key  | The parent key.  
---|---|---  
...
__
[code]
    is_level2_menu_item_active(mixed  $href) : mixed
[/code]

_Method is_level2_menu_item_active()._

Check if menu item level 2 is active.

#### Parameters

mixed | $href  | The href value.  
---|---|---  
