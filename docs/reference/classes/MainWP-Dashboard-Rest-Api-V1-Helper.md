...
#  \MainWP\Dashboard Rest_Api_V1_Helper

_Class Rest_Api_

## Summary

Methods Properties Constants [instance](classes/MainWP-Dashboard-Rest-Api-V1-Helper.html#method_instance)  
[handle_site_update_item](classes/MainWP-Dashboard-Rest-Api-V1-Helper.html#method_handle_site_update_item)  
_No public properties found_ _No public constants found_ _No protected methods found_ _No protected properties found_ _No protected constants found_ _No private methods found_ [instance](classes/MainWP-Dashboard-Rest-Api-V1-Helper.html#property_instance)  
_No private constants found_

File
     [ includes/rest-api/controller/version1/class-mainwp-rest-api-v1-helper.php ](files/includes-rest-api-controller-version1-class-mainwp-rest-api-v1-helper.md)
Package
...
Inherited from
    [\MainWP\Dashboard\Rest_Api_V1_Helper](classes/MainWP-Dashboard-Rest-Api-V1-Helper.md)
...
### handle_site_update_item()

__
[code]
    handle_site_update_item(int  $website_id, string  $update_type, array  $result) : array
[/code]

_Method handle_site_update_item()_

#### Parameters

int | $website_id  | website id.  
---|---|---  
string | $update_type  | result update.  
array | $result  | result update.  
...
### class-mainwp-rest-api-v1-helper.php
[/code]
[code] 
#  __
