...
#  \MainWP\Dashboard MainWP_Uptime_Monitoring_Site_Widget

_Class MainWP_Uptime_Monitoring_Site_Widget_

Displays the Logs info.

## Summary

Methods Properties Constants [instance](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Site-Widget.html#method_instance)  
[ajax_get_response_times](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Site-Widget.html#method_ajax_get_response_times)  
[get_valid_days_periods](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Site-Widget.html#method_get_valid_days_periods)  
[get_days_number_by_period](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Site-Widget.html#method_get_days_number_by_period)  
[render_top_widget](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Site-Widget.html#method_render_top_widget)  
[render_response_times_widget](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Site-Widget.html#method_render_response_times_widget)  
[render_content_response_time_widget](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Site-Widget.html#method_render_content_response_time_widget)  
[prepare_response_time_ui_chart_data](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Site-Widget.html#method_prepare_response_time_ui_chart_data)  
_No public properties found_ _No public constants found_ _No protected methods found_ [instance](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Site-Widget.html#property_instance)  
_No protected constants found_ [prepare_group_time_option_for_ui_chart_data_only](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Site-Widget.html#method_prepare_group_time_option_for_ui_chart_data_only)  
_No private properties found_ _No private constants found_

File
     [ widgets/widget-mainwp-uptime-monitoring-site-widget.php ](files/widgets-widget-mainwp-uptime-monitoring-site-widget.md)
Package
...
Inherited from
    [\MainWP\Dashboard\MainWP_Uptime_Monitoring_Site_Widget](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Site-Widget.md)
...
__
[code]
    ajax_get_response_times() : void
[/code]

_Method ajax_get_response_times_
...
__
[code]
    get_days_number_by_period(string|false  $period) : mixed
[/code]

_Method get_days_number_by_period_

#### Parameters

string|false | $period  | period.  
---|---|---  
...
__
[code]
    render_top_widget() : mixed
[/code]

_Renders the top widget._
...
### render_response_times_widget()

__
[code]
    render_response_times_widget() : mixed
[/code]
...
__
[code]
    render_content_response_time_widget(mixed  $site_id) : void
[/code]

_Method render_content_response_time_widget_

#### Parameters

mixed | $site_id  | site id.  
---|---|---  
...
### prepare_response_time_ui_chart_data()

__
[code]
    prepare_response_time_ui_chart_data(array  $chart_data, array  $params = array(), string  $slug = 'uptime') : array
[/code]

_Prepare response time for ui chart data._

#### Parameters

array | $chart_data  | array: date and value.  
---|---|---  
array | $params  | params.  
string | $slug  | for date format hook.  
...
### prepare_group_time_option_for_ui_chart_data_only()
...
int | $site_id  | site id.  
---|---|---  
array | $params  | params, 'start' and 'end' date must in format: Y-m-d H:i:s.  
bool | $ajax_working  | ajax working.  
...
### widget-mainwp-uptime-monitoring-site-widget.php
[/code]
[code] 
#  __
