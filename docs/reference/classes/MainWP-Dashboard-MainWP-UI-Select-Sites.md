...
#  \MainWP\Dashboard MainWP_UI_Select_Sites

_Class MainWP_UI_Select_Sites_

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-UI-Select-Sites.html#method_get_class_name)  
[select_sites_box](classes/MainWP-Dashboard-MainWP-UI-Select-Sites.html#method_select_sites_box)  
[select_sites_box_body](classes/MainWP-Dashboard-MainWP-UI-Select-Sites.html#method_select_sites_box_body)  
[render_select_clients](classes/MainWP-Dashboard-MainWP-UI-Select-Sites.html#method_render_select_clients)  
[render_create_tag_modal](classes/MainWP-Dashboard-MainWP-UI-Select-Sites.html#method_render_create_tag_modal)  
...
File
     [ class/class-mainwp-ui-select-sites.php ](files/class-class-mainwp-ui-select-sites.md)
Package
...
Inherited from
    [\MainWP\Dashboard\MainWP_UI_Select_Sites](classes/MainWP-Dashboard-MainWP-UI-Select-Sites.md)
...
__
[code]
    select_sites_box(array  $params = array()) : mixed
[/code]
...
__
[code]
    select_sites_box_body(array  $params = array()) : mixed
[/code]
...
__
[code]
    render_select_clients(mixed  $params = array()) : void
[/code]

_Method render_select_clients()_
...
type  |  object $clients Object containing Clients info. string $type Selector type. array $selected_clients Selected clients. bool $enable_suspended_clients (bool) True, if suspended clients is enabled. False if not. mixed $tab_id Datatab ID. }  
---|---  
...
__
[code]
    render_create_tag_modal() : mixed
[/code]

_Method render_create_tag_modal()_
...
### class-mainwp-ui-select-sites.php
[/code]
[code] 
#  __
