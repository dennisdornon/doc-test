...
#  \MainWP\Dashboard\Module\Log Connector_Posts

_Class Connector_Posts_

## Summary

Methods Properties Constants [get_label](classes/MainWP-Dashboard-Module-Log-Connector-Posts.html#method_get_label)  
[get_action_labels](classes/MainWP-Dashboard-Module-Log-Connector-Posts.html#method_get_action_labels)  
[get_context_labels](classes/MainWP-Dashboard-Module-Log-Connector-Posts.html#method_get_context_labels)  
[registered_post_type](classes/MainWP-Dashboard-Module-Log-Connector-Posts.html#method_registered_post_type)  
[callback_mainwp_post_created](classes/MainWP-Dashboard-Module-Log-Connector-Posts.html#method_callback_mainwp_post_created)  
[callback_mainwp_post_action](classes/MainWP-Dashboard-Module-Log-Connector-Posts.html#method_callback_mainwp_post_action)  
...
_Return translated connector label_
...
Inherited from
    [\MainWP\Dashboard\Module\Log\Connector_Posts](classes/MainWP-Dashboard-Module-Log-Connector-Posts.md)
...
_Return translated action labels_
...
_Return translated context labels_
...
__
[code]
    registered_post_type(string  $post_type, array  $args) : mixed
[/code]

_Catch registration of post_types after initial loading, to cache its labels_

#### Parameters

string | $post_type  | Post type slug.  
---|---|---  
array | $args  | Arguments used to register the post type.  
...
__
[code]
    callback_mainwp_post_created(mixed  $website, string  $post_action, array  $data) : mixed
[/code]
...
mixed | $website  | website.  
---|---|---  
string | $post_action  | post action.  
array | $data  | post data array.  
...
__
[code]
    callback_mainwp_post_action(object  $website, string  $post_action, array  $data) : mixed
[/code]

_Log all post status changes ( creating / updating / trashing )_
