...
[Log](namespaces/mainwp-dashboard-module-log.md) __

#  \MainWP\Dashboard\Module\Log Log_DB

_Class Log_DB_

## Summary

Methods Properties Constants [__construct](classes/MainWP-Dashboard-MainWP-DB-Base.html#method___construct)  
[insert](classes/MainWP-Dashboard-Module-Log-Log-DB.html#method_insert)  
[get_records](classes/MainWP-Dashboard-Module-Log-Log-DB.html#method_get_records)  
[query](classes/MainWP-Dashboard-MainWP-DB-Base.html#method_query)  
[get_found_records_count](classes/MainWP-Dashboard-Module-Log-Log-DB.html#method_get_found_records_count)  
[get_table_names](classes/MainWP-Dashboard-Module-Log-Log-DB.html#method_get_table_names)  
[create_compact_and_erase_records](classes/MainWP-Dashboard-Module-Log-Log-DB.html#method_create_compact_and_erase_records)  
[is_site_action_log_existed](classes/MainWP-Dashboard-Module-Log-Log-DB.html#method_is_site_action_log_existed)  
...
[instance](classes/MainWP-Dashboard-MainWP-DB.html#method_instance)  
...
[driver](classes/MainWP-Dashboard-Module-Log-Log-DB.html#property_driver)  
_No public constants found_ [sanitize_record](classes/MainWP-Dashboard-Module-Log-Log-DB.html#method_sanitize_record)  
...
[found_records_count](classes/MainWP-Dashboard-Module-Log-Log-DB.html#property_found_records_count)  
...
_No protected constants found_ [erase_log_records](classes/MainWP-Dashboard-Module-Log-Log-DB.html#method_erase_log_records)  
_No private properties found_ _No private constants found_

File
     [ modules/logs/classes/class-log-db.php ](files/modules-logs-classes-class-log-db.md)
Package
...
### $driver
[code] 
    $driver : \MainWP\Dashboard\Module\Log\Log_DB_Driver
[/code]

_Holds the driver instance_
...
### $found_records_count
[code] 
    $found_records_count : int
[/code]

_Number of records in last request_
...
array | $args  | Arguments to filter result by.  
---|---|---  
...
__
[code]
    get_found_records_count() : int
[/code]

_Return the number of records found in last request_
...
_Public getter to return table names_
...
__
[code]
    create_compact_and_erase_records(int  $start_time, int  $end_time) : mixed
[/code]

_Create compact logs and erase records from the database._

#### Parameters

int | $start_time  | start time to compact.  
---|---|---  
int | $end_time  | end time to compact.  
...
### is_site_action_log_existed()

__
[code]
    is_site_action_log_existed(int  $site_id, string  $object_id) : mixed
[/code]

_Metho check if site action log existed._
...
_Ensure the record matches our schema._
...
__
[code]
    erase_log_records(int  $start_time, int  $end_time) : int
[/code]

_Clears logs records from the database._

#### Parameters

int | $start_time  | start time.  
---|---|---  
int | $end_time  | start end.  
...
Documentation is powered by [phpDocumentor ](https://www.phpdoc.org/) and authored on September 13th, 2026 at 00:45. 
  *[Composer]: \Composer
  *[MainWP]: \MainWP
  *[ParagonIE]: \ParagonIE
  ...
  *[Log]: \MainWP\Dashboard\Module\Log
