...
#  \MainWP\Dashboard MainWP_Updates_Per_Group

_Class MainWP_Updates_Per_Group_

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Updates-Per-Group.html#method_get_class_name)  
[render_wpcore_updates](classes/MainWP-Dashboard-MainWP-Updates-Per-Group.html#method_render_wpcore_updates)  
[render_plugins_updates](classes/MainWP-Dashboard-MainWP-Updates-Per-Group.html#method_render_plugins_updates)  
[render_themes_updates](classes/MainWP-Dashboard-MainWP-Updates-Per-Group.html#method_render_themes_updates)  
[render_trans_update](classes/MainWP-Dashboard-MainWP-Updates-Per-Group.html#method_render_trans_update)  
[render_abandoned_plugins](classes/MainWP-Dashboard-MainWP-Updates-Per-Group.html#method_render_abandoned_plugins)  
[render_abandoned_themes](classes/MainWP-Dashboard-MainWP-Updates-Per-Group.html#method_render_abandoned_themes)  
...
File
     [ pages/page-mainwp-updates-per-group.php ](files/pages-page-mainwp-updates-per-group.md)
Package
...
Inherited from
    [\MainWP\Dashboard\MainWP_Updates_Per_Group](classes/MainWP-Dashboard-MainWP-Updates-Per-Group.md)
...
__
[code]
    render_wpcore_updates(object  $websites, object  $userExtension, int  $total_wp_upgrades, array  $all_groups_sites, array  $all_groups, int  $site_offset_for_groups) : mixed
[/code]
...
int | $total_wp_upgrades  | total update.  
array | $all_groups_sites  | all groups of sites.  
array | $all_groups  | all groups.  
int | $site_offset_for_groups  | offset value.  
...
Uses
     ...
     [\MainWP\Dashboard\MainWP_Updates::user_can_update_wp()](\\MainWP\\Dashboard\\MainWP_Updates::user_can_update_wp\(\))
...
__
[code]
    render_plugins_updates(object  $websites, int  $total_plugin_upgrades, mixed  $userExtension, array  $all_groups_sites, array  $all_groups, int  $site_offset_for_groups, array  $trustedPlugins) : mixed
[/code]
...
object | $websites  | the websites.  
---|---|---  
int | $total_plugin_upgrades  | total plugin updates.  
...
__
[code]
    render_themes_updates(object  $websites, int  $total_theme_upgrades, mixed  $userExtension, array  $all_groups_sites, array  $all_groups, int  $site_offset_for_groups, array  $trustedThemes) : mixed
[/code]
...
object | $websites  | the websites.  
---|---|---  
int | $total_theme_upgrades  | total theme updates.  
mixed | $userExtension  | The user extension.  
array | $all_groups_sites  | all groups of sites.  
array | $all_groups  | all groups.  
int | $site_offset_for_groups  | offset value.  
...
__
[code]
    render_trans_update(object  $websites, int  $total_translation_upgrades, array  $all_groups_sites, array  $all_groups, int  $site_offset_for_groups, object  $userExtension) : mixed
[/code]

_Method render_trans_update()_
...
object | $websites  | the websites.  
---|---|---  
int | $total_translation_upgrades  | total translation updates.  
array | $all_groups_sites  | all groups of sites.  
array | $all_groups  | all groups.  
int | $site_offset_for_groups  | offset value.  
...
__
[code]
    render_abandoned_plugins(object  $websites, array  $allPluginsOutdate, array  $all_groups_sites, array  $all_groups, int  $site_offset_for_groups, array  $decodedDismissedPlugins) : mixed
[/code]
...
object | $websites  | the websites.  
---|---|---  
array | $allPluginsOutdate  | All Plugins Outdate.  
array | $all_groups_sites  | all groups of sites.  
array | $all_groups  | all groups.  
int | $site_offset_for_groups  | offset value.  
...
__
[code]
    render_abandoned_themes(object  $websites, array  $allThemesOutdate, array  $all_groups_sites, array  $all_groups, int  $site_offset_for_groups, array  $decodedDismissedThemes) : mixed
[/code]
...
object | $websites  | the websites.  
---|---|---  
array | $allThemesOutdate  | All Themes Outdate.  
array | $all_groups_sites  | all groups of sites.  
array | $all_groups  | all groups.  
int | $site_offset_for_groups  | offset value.  
...
### page-mainwp-updates-per-group.php
[/code]
[code] 
#  __
