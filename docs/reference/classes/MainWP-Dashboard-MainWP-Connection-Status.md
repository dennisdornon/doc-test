...
#  \MainWP\Dashboard MainWP_Connection_Status

_Class MainWP_Connection_Status_

Build the Connection Status Widget.

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Connection-Status.html#method_get_class_name)  
[render](classes/MainWP-Dashboard-MainWP-Connection-Status.html#method_render)  
[render_sites](classes/MainWP-Dashboard-MainWP-Connection-Status.html#method_render_sites)  
[render_status](classes/MainWP-Dashboard-MainWP-Connection-Status.html#method_render_status)  
[render_multi_status](classes/MainWP-Dashboard-MainWP-Connection-Status.html#method_render_multi_status)  
[render_details](classes/MainWP-Dashboard-MainWP-Connection-Status.html#method_render_details)  
[render_all_item](classes/MainWP-Dashboard-MainWP-Connection-Status.html#method_render_all_item)  
[render_up_item](classes/MainWP-Dashboard-MainWP-Connection-Status.html#method_render_up_item)  
[render_down_item](classes/MainWP-Dashboard-MainWP-Connection-Status.html#method_render_down_item)  
...
File
     [ widgets/widget-mainwp-connection-status.php ](files/widgets-widget-mainwp-connection-status.md)
Package
...
Build the Connection Status Widget Displays $SYNCERRORS|$UP|$ALL.
...
__
[code]
    render_status(int  $count_connected, int  $count_disconnected) : mixed
[/code]

_The renders the MainWP Overview page Connection Status Widget Header and Drop down Box._

#### Parameters

int | $count_connected  | Number of connected sites.  
---|---|---  
int | $count_disconnected  | Number of disconnected sites.  
...
__
[code]
    render_multi_status(int  $count_connected, int  $count_disconnected) : mixed
[/code]

_Render connection status summary section._

#### Parameters

int | $count_connected  | Connected Count.  
---|---|---  
int | $count_disconnected  | Disconnected Count.  
...
__
[code]
    render_details(mixed  $html_all_sites, mixed  $html_online_sites, mixed  $html_other_sites) : mixed
[/code]

_Render See All Sites List._

#### Parameters

mixed | $html_all_sites  | All sites html.  
---|---|---  
mixed | $html_online_sites  | Online sites html.  
mixed | $html_other_sites  | Other sites html.  
...
__
[code]
    render_all_item(mixed  $website, mixed  $lastSyncTime, mixed  $hasSyncErrors) : mixed
[/code]

_Render all items list._
...
__
[code]
    render_up_item(object  $website, string  $lastSyncTime) : mixed
[/code]

_Render Connected Sites List._
...
__
[code]
    render_down_item(object  $website, string  $lastSyncTime) : mixed
[/code]

_Render Disconected Sites List._
...
### widget-mainwp-connection-status.php
[/code]
[code] 
#  __
