...
_" PKCS1" Formatted DH Key Handler_

## Summary

Methods Properties Constants [saveParameters](classes/phpseclib3-Crypt-DH-Formats-Keys-PKCS1.html#method_saveParameters)  
...
File
     [ libs/phpseclib/vendor/phpseclib/phpseclib/phpseclib/Crypt/DH/Formats/Keys/PKCS1.php ](files/libs-phpseclib-vendor-phpseclib-phpseclib-phpseclib-crypt-dh-formats-keys-pkcs1.md)
Package
...
__
[code]
    saveParameters(\phpseclib3\Math\BigInteger  $prime, \phpseclib3\Math\BigInteger  $base, array  $options = []) : string
[/code]

_Convert EC parameters to the appropriate format_
...
Inherited from
    [\phpseclib3\Crypt\DH\Formats\Keys\PKCS1](classes/phpseclib3-Crypt-DH-Formats-Keys-PKCS1.md)
