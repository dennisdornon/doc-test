...
_Class MainWP_Monitoring_Sites_List_Table_

## Summary

Methods Properties Constants [instance](classes/MainWP-Dashboard-MainWP-Monitoring-Sites-List-Table.html#method_instance)  
[__construct](classes/MainWP-Dashboard-MainWP-Manage-Sites-List-Table.html#method___construct)  
...
[column_site](classes/MainWP-Dashboard-MainWP-Monitoring-Sites-List-Table.html#method_column_site)  
[column_type](classes/MainWP-Dashboard-MainWP-Monitoring-Sites-List-Table.html#method_column_type)  
[column_last_check](classes/MainWP-Dashboard-MainWP-Monitoring-Sites-List-Table.html#method_column_last_check)  
[render_uptime_status](classes/MainWP-Dashboard-MainWP-Monitoring-Sites-List-Table.html#method_render_uptime_status)  
[render_last24_uptime_status](classes/MainWP-Dashboard-MainWP-Monitoring-Sites-List-Table.html#method_render_last24_uptime_status)  
[get_monitors_table_child_rows](classes/MainWP-Dashboard-MainWP-Monitoring-Sites-List-Table.html#method_get_monitors_table_child_rows)  
...
_No protected constants found_ _No private methods found_ [instance](classes/MainWP-Dashboard-MainWP-Monitoring-Sites-List-Table.html#property_instance)  
[global_settings](classes/MainWP-Dashboard-MainWP-Monitoring-Sites-List-Table.html#property_global_settings)  
_No private constants found_

File
     [ class/class-mainwp-monitoring-sites-list-table.php ](files/class-class-mainwp-monitoring-sites-list-table.md)
Package
    

MainWP\DashboardMainWPsitesmonitoringlist
...
package  |  MainWP\Dashboard MainWP sites monitoring list.  
---|---  
...
__
[code]
    column_site(mixed  $website) : void
[/code]

_Method column_site._
...
__
[code]
    column_type(string  $mo_type) : void
[/code]

_Method column_type_

#### Parameters

string | $mo_type  | mointor type.  
---|---|---  
...
int | $uptime_status  | uptime status.  
---|---|---  
int | $compatible_offline  | uptime status.  
bool | $mo_disabled  | Disabled monitor or not.  
...
### render_last24_uptime_status()

__
[code]
    render_last24_uptime_status(array  $data, int  $last24_starttime) : void
[/code]

_Render last24 uptime status._

#### Parameters

array | $data  | data.  
---|---|---  
int | $last24_starttime  | last24 start time.  
...
### get_monitors_table_child_rows()

__
[code]
    get_monitors_table_child_rows(int  $site_id, array  $sub_pages) : string
[/code]

_Get monitors table child rows._

#### Parameters

int | $site_id  | the site id.  
---|---|---  
array | $sub_pages  | sub page.  
...
### class-mainwp-monitoring-sites-list-table.php
[/code]
[code] 
#  __
