...
#  \MainWP\Dashboard\Module\Log Log

_Class Logs_

## Summary

Methods Properties Constants [__construct](classes/MainWP-Dashboard-Module-Log-Log.html#method___construct)  
[log](classes/MainWP-Dashboard-Module-Log-Log.html#method_log)  
[log_record](classes/MainWP-Dashboard-Module-Log-Log.html#method_log_record)  
[debug_backtrace](classes/MainWP-Dashboard-Module-Log-Log.html#method_debug_backtrace)  
[manager](classes/MainWP-Dashboard-Module-Log-Log.html#property_manager)  
...
File
     [ modules/logs/classes/class-log.php ](files/modules-logs-classes-class-log.md)
Package
...
manager — Hold Log_Manager class 
...
__
[code]
    __construct(\MainWP\Dashboard\Module\Log\Log_Manager  $manager) : mixed
[/code]
...
Inherited from
    [\MainWP\Dashboard\Module\Log\Log](classes/MainWP-Dashboard-Module-Log-Log.md)
...
_Helper function to send a full backtrace of calls to the PHP error log for debugging._

#### Parameters

array | $recordarr  | Record argument array.  
---|---|---  
