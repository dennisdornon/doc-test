...
#  \MainWP\Dashboard\Module\CostTracker Cost_Tracker_Settings

_Class Cost_Tracker_Settings_

## Summary

Methods Properties Constants [get_instance](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Settings.html#method_get_instance)  
[__construct](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Settings.html#method___construct)  
[render_settings_page](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Settings.html#method_render_settings_page)  
[render_settings_content](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Settings.html#method_render_settings_content)  
[render_icons_select](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Settings.html#method_render_icons_select)  
[add_custom_product_types_tmpl](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Settings.html#method_add_custom_product_types_tmpl)  
[add_custom_payment_methods_tmpl](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Settings.html#method_add_custom_payment_methods_tmpl)  
[icon_sub_dir](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Settings.html#property_icon_sub_dir)  
_No public constants found_ _No protected methods found_ _No protected properties found_ _No protected constants found_ _No private methods found_ [instance](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Settings.html#property_instance)  
_No private constants found_

File
     [ modules/cost-tracker/pages/page-cost-tracker-settings.php ](files/modules-cost-tracker-pages-page-cost-tracker-settings.md)
Package
...
_Static variable to hold the single instance variable._
...
__
[code]
    get_instance() : \MainWP\Dashboard\Module\CostTracker\Cost_Tracker_Settings
[/code]
...
Inherited from
    [\MainWP\Dashboard\Module\CostTracker\Cost_Tracker_Settings](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Settings.md)
...
__
[code]
    render_settings_content() : mixed
[/code]

_Render settings content._
...
__
[code]
    render_icons_select(array  $default_icons, string  $selected_def_icon = '', string  $icon_color = '', string  $select_img_cls = 'mainwp-module-cost-tracker-select-default-icons') : mixed
[/code]

_Method render_icons_select()._

#### Parameters

array | $default_icons  | default icons.  
---|---|---  
string | $selected_def_icon  | selected default icon.  
string | $icon_color  | icon color.  
string | $select_img_cls  | icon class.  
...
__
[code]
    add_custom_product_types_tmpl(array  $product_default_icons) : mixed
[/code]

_Method add_custom_product_types_tmpl()._

#### Parameters

array | $product_default_icons  | default icons.  
---|---|---  
...
__
[code]
    add_custom_payment_methods_tmpl() : mixed
[/code]

_Method add_custom_payment_methods_tmpl()._
...
### page-cost-tracker-settings.php
[/code]
[code] 
#  __
