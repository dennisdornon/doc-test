...
[emsa_pss_encode](classes/phpseclib3-Crypt-RSA-PrivateKey.html#method_emsa_pss_encode)  
...
_Coefficients for Chinese Remainder Theorem (ie. qInv)_
...
__
[code]
    rsadp(\phpseclib3\Math\BigInteger  $c) : bool|\phpseclib3\Math\BigInteger
[/code]
...
__
[code]
    rsasp1(\phpseclib3\Math\BigInteger  $m) : bool|\phpseclib3\Math\BigInteger
[/code]
...
__
[code]
    blind(\phpseclib3\Math\BigInteger  $x, \phpseclib3\Math\BigInteger  $r, int  $i) : \phpseclib3\Math\BigInteger
[/code]

_Performs RSA Blinding_
