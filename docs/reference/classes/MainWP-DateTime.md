...
Methods Properties Constants [__toString](classes/MainWP-DateTime.html#method___toString)  
[set_utc_offset](classes/MainWP-DateTime.html#method_set_utc_offset)  
[getOffset](classes/MainWP-DateTime.html#method_getOffset)  
[setTimezone](classes/MainWP-DateTime.html#method_setTimezone)  
[getTimestamp](classes/MainWP-DateTime.html#method_getTimestamp)  
[getOffsetTimestamp](classes/MainWP-DateTime.html#method_getOffsetTimestamp)  
[date](classes/MainWP-DateTime.html#method_date)  
[date_i18n](classes/MainWP-DateTime.html#method_date_i18n)  
_No public properties found_ _No public constants found_ _No protected methods found_ [utc_offset](classes/MainWP-DateTime.html#property_utc_offset)  
_No protected constants found_ _No private methods found_ _No private properties found_ _No private constants found_

File
     [ includes/class-mainwp-datetime.php ](files/includes-class-mainwp-datetime.md)
Package
...
_UTC Offset, if needed. Only used when a timezone is not set. When timezones are used this will equal 0._
...
_Output an ISO 8601 date string in local (WordPress) timezone._
...
_Set UTC offset - this is a fixed offset instead of a timezone._
...
_Get UTC offset if set, or default to the DateTime object 's offset._
...
\DateTimeZone | $timezone  | DateTimeZone instance.  
---|---|---  
...
_Missing in PHP 5.2 so just here so it can be supported consistently._
...
_Get the timestamp with the WordPress timezone offset added or subtracted._
...
_Format a date based on the offset timestamp._
...
_Return a localised date based on offset timestamp. Wrapper for date_i18n function._
