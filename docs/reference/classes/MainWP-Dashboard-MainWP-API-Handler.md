...
#  \MainWP\Dashboard MainWP_API_Handler

_Class MainWP_API_Handler()_

MainWP API settings page

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-API-Handler.html#method_get_class_name)  
[check_exts_upgrade](classes/MainWP-Dashboard-MainWP-API-Handler.html#method_check_exts_upgrade)  
[get_upgrade_information](classes/MainWP-Dashboard-MainWP-API-Handler.html#method_get_upgrade_information)  
[get_update_information](classes/MainWP-Dashboard-MainWP-API-Handler.html#method_get_update_information)  
...
File
     [ class/class-mainwp-api-handler.php ](files/class-class-mainwp-api-handler.md)
Package
...
__
[code]
    check_exts_upgrade() : mixed
[/code]

_Check if extension has an update._
...
### get_upgrade_information()

__
[code]
    get_upgrade_information(string  $pSlug) : array
[/code]

_Check extension information for an update._

#### Parameters

string | $pSlug  | Extension slug.  
---|---|---  
...
$rslt An array containing update information.
...
__
[code]
    get_update_information(string  $pSlug) : array
[/code]

_Get extension information._
...
$rslt An array containing extension information.
