...
_Class MainWP_Client_Handler_

## Summary

Methods Properties Constants [instance](classes/MainWP-Dashboard-MainWP-Client-Handler.html#method_instance)  
[get_default_client_fields](classes/MainWP-Dashboard-MainWP-Client-Handler.html#method_get_default_client_fields)  
[get_mini_default_client_fields](classes/MainWP-Dashboard-MainWP-Client-Handler.html#method_get_mini_default_client_fields)  
[get_default_contact_fields](classes/MainWP-Dashboard-MainWP-Client-Handler.html#method_get_default_contact_fields)  
[get_mini_default_contact_fields](classes/MainWP-Dashboard-MainWP-Client-Handler.html#method_get_mini_default_contact_fields)  
[get_compatible_tokens](classes/MainWP-Dashboard-MainWP-Client-Handler.html#method_get_compatible_tokens)  
[rest_api_add_client](classes/MainWP-Dashboard-MainWP-Client-Handler.html#method_rest_api_add_client)  
[get_website_client_tokens_data](classes/MainWP-Dashboard-MainWP-Client-Handler.html#method_get_website_client_tokens_data)  
[get_client_contact_image](classes/MainWP-Dashboard-MainWP-Client-Handler.html#method_get_client_contact_image)  
[get_client_avatar](classes/MainWP-Dashboard-MainWP-Client-Handler.html#method_get_client_avatar)  
[get_client_image_url](classes/MainWP-Dashboard-MainWP-Client-Handler.html#method_get_client_image_url)  
[show_notice_existed_contact_emails](classes/MainWP-Dashboard-MainWP-Client-Handler.html#method_show_notice_existed_contact_emails)  
_No public properties found_ _No public constants found_ _No protected methods found_ _No protected properties found_ _No protected constants found_ _No private methods found_ [instance](classes/MainWP-Dashboard-MainWP-Client-Handler.html#property_instance)  
_No private constants found_

File
     [ class/class-mainwp-client-handler.php ](files/class-class-mainwp-client-handler.md)
Package
...
__
[code]
    instance() : \MainWP\Dashboard\MainWP_Client_Handler
[/code]
...
__
[code]
    get_default_client_fields() : mixed
[/code]

_Get default client fields._
...
__
[code]
    get_mini_default_client_fields() : mixed
[/code]
...
__
[code]
    get_default_contact_fields() : mixed
[/code]

_Get default contact fields._
...
__
[code]
    get_mini_default_contact_fields() : mixed
[/code]
...
__
[code]
    get_compatible_tokens() : mixed
[/code]

_Method get_compatible_tokens()._
...
---|---|---  
bool | $edit  | Is edit. $data fields. 'client_email'. 'name'. 'client_facebook'. 'client_twitter'. 'client_instagram'. 'client_linkedin'. 'address_1'. 'address_2'. 'city'. 'zip'. 'state'. 'note'. 'selected_sites'. 'client_id'. - to edit client.  
...
### get_client_contact_image()

__
[code]
    get_client_contact_image(array  $item, string  $type = 'client', string  $what = 'default') : mixed
[/code]

_Method get_client_contact_image()_

Get client contact image.

#### Parameters

array | $item  | client|contact array data.  
---|---|---  
string | $type  | type of image.  
string | $what  | image for what.  
...
__
[code]
    get_client_avatar(array  $item, string  $type = 'client') : mixed
[/code]

_Method get_client_avatar()_
...
_Method get_client_image_url()_

Get client icon URL.

#### Parameters

string | $image_path  | Client image url path.  
---|---|---  
...
__
[code]
    show_notice_existed_contact_emails() : mixed
[/code]

_Method show_notice_existed_contact_emails()_
...
### class-mainwp-client-handler.php
[/code]
[code] 
#  __
