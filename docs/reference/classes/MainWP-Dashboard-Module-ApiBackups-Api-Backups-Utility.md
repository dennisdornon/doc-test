...
#  \MainWP\Dashboard\Module\ApiBackups Api_Backups_Utility

_Class Api_Backups_Utility_

## Summary

Methods Properties Constants [get_instance](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#method_get_instance)  
[__construct](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#method___construct)  
[count_child_sites](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#method_count_child_sites)  
[get_timestamp](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#method_get_timestamp)  
[format_timestamp](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#method_format_timestamp)  
[format_datestamp](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#method_format_datestamp)  
[map_fields](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#method_map_fields)  
[array_sort](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#method_array_sort)  
[log_info](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#method_log_info)  
[log_debug](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#method_log_debug)  
[save_lasttime_backup](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#method_save_lasttime_backup)  
[show_mainwp_message](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#method_show_mainwp_message)  
[human_filesize](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#method_human_filesize)  
[color_code](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#method_color_code)  
[update_option](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#method_update_option)  
[encrypt_api_keys](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#method_encrypt_api_keys)  
[decrypt_api_keys](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#method_decrypt_api_keys)  
[get_api_key](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#method_get_api_key)  
[update_api_key](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#method_update_api_key)  
[get_child_api_key](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#method_get_child_api_key)  
[update_child_api_key](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#method_update_child_api_key)  
[instance](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.html#property_instance)  
...
File
     [ modules/api-backups/classes/class-api-backups-utility.php ](files/modules-api-backups-classes-class-api-backups-utility.md)
Package
...
__
[code]
    get_instance() : \MainWP\Dashboard\Module\ApiBackups\Api_Backups_Utility
[/code]
...
Inherited from
    [\MainWP\Dashboard\Module\ApiBackups\Api_Backups_Utility](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Utility.md)
...
__
[code]
    count_child_sites() : mixed
[/code]

_Method count_child_sites()._
...
int | $timestamp  | Holds Timestamp.  
---|---|---  
bool | $gmt  | Whether to set as General mountain time. Default: FALSE.  
...
mixed | $website  | Website to map.  
---|---|---  
mixed | $keys  | Keys to map.  
bool | $object_output  | Output format array|object.  
...
mixed | $arr  | Array to sort.  
---|---|---  
mixed | $key  | Array key.  
string | $sort_flag  | Flags to sort by. Default = SORT_STRING.  
...
__
[code]
    log_info(string  $message) : mixed
[/code]

_Debugging log info._
...
__
[code]
    log_debug(string  $message, int  $log_color = 3) : mixed
[/code]
...
string | $message  | Log debug message.  
---|---|---  
int | $log_color  | Log color.  
...
__
[code]
    save_lasttime_backup(int  $site_id, int  $available_backups, string  $backup_api) : mixed
[/code]

_Method save_lasttime_backup()._

#### Parameters

int | $site_id  | site id.  
---|---|---  
int | $available_backups  | Available backups.  
string | $backup_api  | API backups provider.  
...
__
[code]
    show_mainwp_message(string  $notice_id) : bool
[/code]

_Show Info Messages_
...
__
[code]
    human_filesize(mixed  $bytes, int  $decimals = 2) : string
[/code]

_Method human_filesize()_
...
---|---|---  
int | $decimals  | Number of decimals to output.  
...
__
[code]
    update_option(mixed  $option_name, mixed  $option_value) : bool
[/code]

_Method update_option()_
...
---|---|---  
int | $siteid  | site id.  
string | $file_key  | file key.  
string | $service_name  | service name. Encrypt data.  
...
__
[code]
    decrypt_api_keys(mixed  $encrypted_data, string  $def_val = '') : mixed
[/code]

_Method decrypt_api_keys_

#### Parameters

mixed | $encrypted_data  | encrypted data.  
---|---|---  
string | $def_val  | default data.  
...
__
[code]
    get_api_key(string  $name, string  $def_val = '') : mixed
[/code]

_Method get_compatible_site_api_key_
...
__
[code]
    update_api_key(string  $name, string  $value) : mixed
[/code]

_Method update_compatible_site_api_key_
...
__
[code]
    get_child_api_key(int  $website_id, string  $name, string  $def_val = '') : mixed
[/code]

_Method get child site key._

Encrypt data.

#### Parameters

int | $website_id  | name data.  
---|---|---  
string | $name  | name data.  
string | $def_val  | default data.  
...
__
[code]
    update_child_api_key(int  $website_id, string  $name, string  $value) : mixed
[/code]

_Method update child api key._
