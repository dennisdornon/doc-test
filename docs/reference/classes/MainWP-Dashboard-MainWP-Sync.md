...
#  \MainWP\Dashboard MainWP_Sync

_Class MainWP_Sync_

## Summary

Methods Properties Constants [sync_website](classes/MainWP-Dashboard-MainWP-Sync.html#method_sync_website)  
[sync_site](classes/MainWP-Dashboard-MainWP-Sync.html#method_sync_site)  
[sync_information_array](classes/MainWP-Dashboard-MainWP-Sync.html#method_sync_information_array)  
[sync_init_empty_values](classes/MainWP-Dashboard-MainWP-Sync.html#method_sync_init_empty_values)  
[get_wp_icon](classes/MainWP-Dashboard-MainWP-Sync.html#method_get_wp_icon)  
[clone_websites](classes/MainWP-Dashboard-MainWP-Sync.html#property_clone_websites)  
[clone_enabled](classes/MainWP-Dashboard-MainWP-Sync.html#property_clone_enabled)  
[disallowed_clone_sites](classes/MainWP-Dashboard-MainWP-Sync.html#property_disallowed_clone_sites)  
...
File
     [ class/class-mainwp-sync.php ](files/class-class-mainwp-sync.md)
Package
...
### $clone_websites
[code] 
    $clone_websites : mixed
[/code]

_Clone websites setting._

#### Type

mixed — Clone websites. 
...
### $disallowed_clone_sites
[code] 
    $disallowed_clone_sites : mixed
[/code]

_Disallowed Clone sites setting._

#### Type

mixed — Disallowed clone. 
...
---|---|---  
bool | $clear_session  | to run the ending session or not.  
...
---|---|---  
bool | $pForceFetch  | Check if a fourced Sync.  
bool | $pAllowDisconnect  | Check if allowed to disconect.  
bool | $clear_session  | to run the ending session or not.  
...
int | $check_result  | Check if offline.  
bool | $error  | True|False.  
bool | $pAllowDisconnect  | True|False.  
...
### sync_init_empty_values()

__
[code]
    sync_init_empty_values(object  $pWebsite) : void
[/code]

_Method init empty sync values._

#### Parameters

object | $pWebsite  | Object containing child site info.  
---|---|---  
