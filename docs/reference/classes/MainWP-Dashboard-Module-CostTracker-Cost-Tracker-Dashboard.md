...
[CostTracker](namespaces/mainwp-dashboard-module-costtracker.md) __

#  \MainWP\Dashboard\Module\CostTracker Cost_Tracker_Dashboard

_Class Cost_Tracker_Dashboard_

## Summary

Methods Properties Constants [get_instance](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method_get_instance)  
[__construct](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method___construct)  
[admin_init](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method_admin_init)  
[get_columns](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method_get_columns)  
[get_columns_defines](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method_get_columns_defines)  
[get_columns_init](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method_get_columns_init)  
[render_overview_page](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method_render_overview_page)  
[ajax_display_rows](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method_ajax_display_rows)  
[render_dashboard_body](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method_render_dashboard_body)  
[ajax_get_datatable_rows](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method_ajax_get_datatable_rows)  
[ajax_notes_save](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method_ajax_notes_save)  
[ajax_costs_filter_save_segment](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method_ajax_costs_filter_save_segment)  
[set_get_cost_filter_segments](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method_set_get_cost_filter_segments)  
[ajax_costs_filter_load_segments](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method_ajax_costs_filter_load_segments)  
[ajax_costs_filter_delete_segment](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method_ajax_costs_filter_delete_segment)  
[ajax_cost_tracker_delete](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method_ajax_cost_tracker_delete)  
[render_actions_bar](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method_render_actions_bar)  
[get_cost_filter_params](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method_get_cost_filter_params)  
[render_manage_tasks_table_top](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method_render_manage_tasks_table_top)  
[render_modal_save_segment](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method_render_modal_save_segment)  
[render_modal_edit_notes](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method_render_modal_edit_notes)  
[render_screen_options](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#method_render_screen_options)  
_No public properties found_ _No public constants found_ _No protected methods found_ _No protected properties found_ _No protected constants found_ _No private methods found_ [items](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#property_items)  
[total_items](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#property_total_items)  
[order](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#property_order)  
[orderby](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#property_orderby)  
[instance](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.html#property_instance)  
_No private constants found_

File
     [ modules/cost-tracker/pages/page-cost-tracker-dashboard.php ](files/modules-cost-tracker-pages-page-cost-tracker-dashboard.md)
Package
...
_Variable to hold the total items._
...
_Variable to hold the order by._
...
__
[code]
    get_instance() : \MainWP\Dashboard\Module\CostTracker\Cost_Tracker_Dashboard
[/code]
...
Inherited from
    [\MainWP\Dashboard\Module\CostTracker\Cost_Tracker_Dashboard](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Dashboard.md)
...
bool | $filtered  | With per site price column.  
---|---|---  
...
__
[code]
    get_columns_init(bool  $filtered) : array
[/code]

_Instantiate Columns._
...
__
[code]
    ajax_display_rows() : mixed
[/code]

_Method ajax_display_rows()_
...
__
[code]
    render_dashboard_body() : mixed
[/code]

_Render the Dashboard tab_
...
__
[code]
    ajax_notes_save() : mixed
[/code]

_Method ajax_notes_save()_
...
### ajax_costs_filter_save_segment()

__
[code]
    ajax_costs_filter_save_segment() : mixed
[/code]

_Method ajax_costs_filter_save_segment()_
...
bool | $set_val  | Get or set value.  
---|---|---  
array | $saved_segments  | segments value.  
...
### ajax_costs_filter_load_segments()

__
[code]
    ajax_costs_filter_load_segments() : mixed
[/code]

_Method ajax_costs_filter_load_segments()_
...
### ajax_costs_filter_delete_segment()

__
[code]
    ajax_costs_filter_delete_segment() : mixed
[/code]

_Method ajax_costs_filter_delete_segment()_
...
__
[code]
    ajax_cost_tracker_delete() : mixed
[/code]

_Method ajax_cost_tracker_delete()_
...
__
[code]
    render_actions_bar() : mixed
[/code]

_Render Actions Bar_
...
### get_cost_filter_params()

__
[code]
    get_cost_filter_params() : array
[/code]

_Method get_cost_filter_params()._
...
bool | $sel_one_time_ids  | selected one time ids.  
---|---|---  
...
### render_modal_save_segment()

__
[code]
    render_modal_save_segment() : void
[/code]

_Method render_modal_save_segment()_
...
_Method render_modal_edit_notes()_

Render modal window for edit notes.

#### Parameters

string | $what  | What modal window to render. Default = site.  
---|---|---  
...
__
[code]
    render_screen_options() : mixed
[/code]

_Render Page Settings._
...
### page-cost-tracker-dashboard.php
[/code]
[code] 
#  __
...
Documentation is powered by [phpDocumentor ](https://www.phpdoc.org/) and authored on September 13th, 2026 at 00:45. 
  ...
  *[TestClass]: \TestClass
  *[CostTracker]: \MainWP\Dashboard\Module\CostTracker
