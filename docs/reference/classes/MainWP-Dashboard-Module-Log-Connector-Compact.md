...
#  \MainWP\Dashboard\Module\Log Connector_Compact

_Class Connector_User_

## Summary

Methods Properties Constants [get_label](classes/MainWP-Dashboard-Module-Log-Connector-Compact.html#method_get_label)  
[get_action_labels](classes/MainWP-Dashboard-Module-Log-Connector-Compact.html#method_get_action_labels)  
[get_context_labels](classes/MainWP-Dashboard-Module-Log-Connector-Compact.html#method_get_context_labels)  
[callback_mainwp_compact_action](classes/MainWP-Dashboard-Module-Log-Connector-Compact.html#method_callback_mainwp_compact_action)  
...
File
     [ modules/logs/connectors/class-connector-compact.php ](files/modules-logs-connectors-class-connector-compact.md)
Package
...
Inherited from
    [\MainWP\Dashboard\Module\Log\Connector_Compact](classes/MainWP-Dashboard-Module-Log-Connector-Compact.md)
...
_Return translated action term labels_

#### Returns

array —

Action terms label translation
...
### callback_mainwp_compact_action()

__
[code]
    callback_mainwp_compact_action(string  $action, int  $year, array  $data, array  $start_time, array  $end_time) : mixed
[/code]

_Log compact actions._

#### Parameters

string | $action  | post action.  
---|---|---  
int | $year  | compact year.  
array | $data  | data array.  
array | $start_time  | data array.  
array | $end_time  | data array.  
