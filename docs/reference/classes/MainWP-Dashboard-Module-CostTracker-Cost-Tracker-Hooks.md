...
#  \MainWP\Dashboard\Module\CostTracker Cost_Tracker_Hooks

_Class Cost_Tracker_Hooks_

## Summary

Methods Properties Constants [get_instance](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Hooks.html#method_get_instance)  
[__construct](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Hooks.html#method___construct)  
[init](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Hooks.html#method_init)  
[hook_widgets_screen_options](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Hooks.html#method_hook_widgets_screen_options)  
[hook_screen_options](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Hooks.html#method_hook_screen_options)  
[hook_manage_clients_column](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Hooks.html#method_hook_manage_clients_column)  
[hook_clientstable_prepared_items](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Hooks.html#method_hook_clientstable_prepared_items)  
[hook_manage_clients_display_item](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Hooks.html#method_hook_manage_clients_display_item)  
[hook_manage_sites_column](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Hooks.html#method_hook_manage_sites_column)  
[hook_sitestable_prepared_items](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Hooks.html#method_hook_sitestable_prepared_items)  
[hook_manage_sites_display_item](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Hooks.html#method_hook_manage_sites_display_item)  
[hook_get_widgets_screen_options](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Hooks.html#method_hook_get_widgets_screen_options)  
[hook_get_client_page_metaboxes](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Hooks.html#method_hook_get_client_page_metaboxes)  
[hook_get_site_overview_page_metaboxes](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Hooks.html#method_hook_get_site_overview_page_metaboxes)  
[instance](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Hooks.html#property_instance)  
[clients_costs](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Hooks.html#property_clients_costs)  
[clients_sites](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Hooks.html#property_clients_sites)  
[sites_costs](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Hooks.html#property_sites_costs)  
...
File
     [ modules/cost-tracker/classes/class-cost-tracker-hooks.php ](files/modules-cost-tracker-classes-class-cost-tracker-hooks.md)
Package
...
_Public static variable to hold the clients costs._
...
__
[code]
    get_instance() : \MainWP\Dashboard\Module\CostTracker\Cost_Tracker_Hooks
[/code]
...
Inherited from
    [\MainWP\Dashboard\Module\CostTracker\Cost_Tracker_Hooks](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Hooks.md)
...
_Method hook_screen_options()_

Create Screen Options button.

#### Parameters

mixed | $input  | Screen options button HTML.  
---|---|---  
...
_Method hook_manage_clients_column()._

Handle hook to manage sites columns.

#### Parameters

array | $columns  | sites table columns.  
---|---|---  
...
__
[code]
    hook_clientstable_prepared_items(array  $clients, array  $clients_ids) : mixed
[/code]

_Method hook_clientstable_prepared_items()._

Handle hook to prepared manage sites items.

#### Parameters

array | $clients  | sites prepared.  
---|---|---  
array | $clients_ids  | sites ids prepared.  
...
_Method hook_manage_sites_column()._
...
__
[code]
    hook_sitestable_prepared_items(array  $websites, mixed  $site_ids) : mixed
[/code]

_Method hook_sitestable_prepared_items()._

Handle hook to prepared manage sites items.

#### Parameters

array | $websites  | sites prepared. @param array $site_ids sites ids prepared.  
---|---|---  
mixed | $site_ids  |   
...
__
[code]
    hook_get_client_page_metaboxes(array  $widgets) : mixed
[/code]
