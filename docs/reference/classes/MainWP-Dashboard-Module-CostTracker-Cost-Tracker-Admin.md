...
#  \MainWP\Dashboard\Module\CostTracker Cost_Tracker_Admin

_Class Cost_Tracker_Admin_

## Summary

Methods Properties Constants [get_instance](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_get_instance)  
[__construct](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method___construct)  
[init](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_init)  
[hook_delete_site](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_hook_delete_site)  
[admin_init](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_admin_init)  
[hook_log_specific_actions](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_hook_log_specific_actions)  
[hook_init_primary_menu_items](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_hook_init_primary_menu_items)  
[hook_get_default_cost_fields](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_hook_get_default_cost_fields)  
[get_default_fields_values](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_get_default_fields_values)  
[init_menu](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_init_menu)  
[on_load_summary_page](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_on_load_summary_page)  
[init_left_menu](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_init_left_menu)  
[render_header](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_render_header)  
[handle_edit_cost_tracker_post](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_handle_edit_cost_tracker_post)  
[handle_settings_post](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_handle_settings_post)  
[validate_custom_settings_text_fields](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_validate_custom_settings_text_fields)  
[hook_get_next_renewal](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_hook_get_next_renewal)  
[hook_get_total_cost](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_hook_get_total_cost)  
[get_next_renewal](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_get_next_renewal)  
[get_default_product_types](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_get_default_product_types)  
[get_default_product_type_colors](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_get_default_product_type_colors)  
[get_product_colors](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_get_product_colors)  
[get_default_product_types_icons](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_get_default_product_types_icons)  
[get_product_type_icons](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_get_product_type_icons)  
[get_product_types](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_get_product_types)  
[get_payment_methods](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_get_payment_methods)  
[get_renewal_frequency](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_get_renewal_frequency)  
[get_cost_status](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_get_cost_status)  
[handle_sites_screen_settings](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_handle_sites_screen_settings)  
[mainwp_help_content](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_mainwp_help_content)  
[calc_next_renewal_today](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_calc_next_renewal_today)  
[generate_next_renewal](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_generate_next_renewal)  
[get_cost_status_label](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_get_cost_status_label)  
[get_product_icon_display](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#method_get_product_icon_display)  
[version](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#property_version)  
[page](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#property_page)  
[subPages](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#property_subPages)  
[instance](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.html#property_instance)  
...
File
     [ modules/cost-tracker/classes/class-cost-tracker-admin.php ](files/modules-cost-tracker-classes-class-cost-tracker-admin.md)
Package
...
_Variable to hold the version number._
...
_Variable to hold the Page value._
...
_Variable to hold the Sub Pages._
...
__
[code]
    get_instance() : \MainWP\Dashboard\Module\CostTracker\Cost_Tracker_Admin
[/code]
...
Inherited from
    [\MainWP\Dashboard\Module\CostTracker\Cost_Tracker_Admin](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Admin.md)
...
__
[code]
    hook_delete_site(mixed  $site) : bool
[/code]
...
_Hook hook_log_specific_actions._

#### Parameters

array | $logs_spec  | Log actions.  
---|---|---  
...
_Method get_default_fields_values()._
...
### on_load_summary_page()

__
[code]
    on_load_summary_page() : mixed
[/code]

_Method on_load_summary_page()_
...
__
[code]
    init_left_menu(array  $subPages) : mixed
[/code]

_Initiates Cost Tracker menu._

#### Parameters

array | $subPages  | Cost Tracker sub pages.  
---|---|---  
...
array | $arr  | Data to valid.  
---|---|---  
mixed | $product_types_colors  | Product types colors.  
mixed | $product_types_icons  | Product types icons.  
...
__
[code]
    hook_get_next_renewal(mixed  $filter_input, int  $previous_renewal, string  $renewal_type) : mixed
[/code]

_Method hook_get_next_renewal()._

Get the next renewal.

#### Parameters

mixed | $filter_input  | filter input value.  
---|---|---  
int | $previous_renewal  | last renewal.  
string | $renewal_type  | renewal time.  
...
__
[code]
    hook_get_total_cost() : mixed
[/code]

_Method hook_get_total_cost()._
...
---|---|---  
string | $renewal_type  | renewal time.  
bool | $get_real_renewal  | To get future renewal, true|false.  
...
### get_default_product_types()

__
[code]
    get_default_product_types() : mixed
[/code]

_Method get_default_product_types()._
...
### get_default_product_type_colors()

__
[code]
    get_default_product_type_colors() : mixed
[/code]

_Method get_default_product_type_colors()._
...
### get_default_product_types_icons()

__
[code]
    get_default_product_types_icons() : mixed
[/code]

_Method get_default_product_types_icons()._
...
__
[code]
    get_product_types() : mixed
[/code]

_Method get_product_types()._
...
__
[code]
    get_payment_methods() : mixed
[/code]

_Method get_payment_methods()._
...
__
[code]
    get_renewal_frequency() : mixed
[/code]

_Method get_renewal_frequency()._
...
__
[code]
    get_cost_status() : mixed
[/code]

_Method get_cost_status()._
...
__
[code]
    handle_sites_screen_settings() : mixed
[/code]

_Method handle_sites_screen_settings()_
...
mixed | $key  | false|string to get status of key.  
---|---|---  
...
string | $product  | Product object.  
---|---|---  
string | $img_id_attr  | img id attr.  
bool | $with_color  | with color.  
