...
#  \MainWP\Dashboard MainWP_Demo_Handle

_Class MainWP_Settings_

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_get_class_name)  
[get_instance](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_get_instance)  
[init_data_demo](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_init_data_demo)  
[is_instawp_site](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_is_instawp_site)  
[import_data_demo](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_import_data_demo)  
[delete_data_demo](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_delete_data_demo)  
[is_new_instance](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_is_new_instance)  
[is_demo_website](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_is_demo_website)  
[get_open_site_demo_url](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_get_open_site_demo_url)  
[is_demo_mode](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_is_demo_mode)  
[render_demo_disable_button](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_render_demo_disable_button)  
[get_markup_str](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_get_markup_str)  
[get_demo_tooltip](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_get_demo_tooltip)  
[get_demo_notice](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_get_demo_notice)  
[handle_action_demo](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_handle_action_demo)  
[handle_fetch_urls_demo](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_handle_fetch_urls_demo)  
[clear_session_cached_demo_data](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_clear_session_cached_demo_data)  
_No public properties found_ _No public constants found_ _No protected methods found_ [instance](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#property_instance)  
[demo_website_ids](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#property_demo_website_ids)  
_No protected constants found_ [add_demo_client](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_add_demo_client)  
[add_demo_contact](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_add_demo_contact)  
[add_demo_website](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_add_demo_website)  
[add_demo_wp_option](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_add_demo_wp_option)  
[add_demo_none_mainwp_action](classes/MainWP-Dashboard-MainWP-Demo-Handle.html#method_add_demo_none_mainwp_action)  
_No private properties found_ _No private constants found_

File
     [ class/class-mainwp-demo-handle.php ](files/class-class-mainwp-demo-handle.md)
Package
...
_Protected static variable to hold the single instance of the demo website ids._
...
__
[code]
    init_data_demo() : mixed
[/code]

_Method init_data_demo()_
...
__
[code]
    is_instawp_site() : mixed
[/code]

_Handle detect if it 's instawp site._
...
__
[code]
    import_data_demo() : mixed
[/code]

_Method import_data_demo()_
...
__
[code]
    delete_data_demo() : mixed
[/code]

_Method delete_data_demo()_
...
__
[code]
    is_demo_website(array  $website) : mixed
[/code]

_Method is_demo_website()_

Check if website is demo data.

#### Parameters

array | $website  | Site to check.  
---|---|---  
...
__
[code]
    get_open_site_demo_url(mixed  $website) : mixed
[/code]

_Method get_open_site_demo_url()_
...
---|---|---  
bool | $echo_out  | to echo or return.  
...
__
[code]
    get_demo_tooltip() : mixed
[/code]

_Method get_demo_notice()_
...
__
[code]
    handle_action_demo(object  $pWebsite, string  $what) : mixed
[/code]

_Method handle_action_demo()_

Handle action for demo website.

#### Parameters

object | $pWebsite  | The demo site.  
---|---|---  
string | $what  | action.  
...
__
[code]
    handle_fetch_urls_demo(mixed  $data, object  $website, mixed  $output) : mixed
[/code]

_Method handle_fetch_urls_demo()_
...
__
[code]
    clear_session_cached_demo_data() : mixed
[/code]

_Method clear_session_cached_demo_data()_
...
__
[code]
    add_demo_client(array  $params, array  $selected_sites) : mixed
[/code]

_Method add_demo_client()_

Handle to add demo Client.

#### Parameters

array | $params  | Array of data.  
---|---|---  
array | $selected_sites  | client sites ids.  
...
__
[code]
    add_demo_contact(array  $params, int  $client_id) : mixed
[/code]

_Method add_demo_contact()_
...
__
[code]
    add_demo_website(array  $params) : mixed
[/code]

_Method add_demo_website()_

Handle add demo website data.

#### Parameters

array | $params  | Array of demo Site to add.  
---|---|---  
...
__
[code]
    add_demo_wp_option(array  $data_rows, \MainWP\Dashboard\index  $index, \MainWP\Dashboard\index  $websiteid) : mixed
[/code]

_Method add_demo_wp_option()_

Handle add demo website options data.

#### Parameters

array | $data_rows  | Array of Site options.  
---|---|---  
\MainWP\Dashboard\index | $index  | index of data.  
\MainWP\Dashboard\index | $websiteid  | website id.  
...
__
[code]
    add_demo_none_mainwp_action(array  $data_rows, \MainWP\Dashboard\index  $index, \MainWP\Dashboard\index  $websiteid) : mixed
[/code]

_Method add_demo_none_mainwp_action()_

Handle add demo none mainwp actions.

#### Parameters

array | $data_rows  | Array of actions.  
---|---|---  
\MainWP\Dashboard\index | $index  | index of data.  
\MainWP\Dashboard\index | $websiteid  | website id.  
