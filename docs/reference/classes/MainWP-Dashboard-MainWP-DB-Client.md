...
__
[code]
    get_client_fields_by(string  $by = 'field_id', mixed  $value = null, int  $client_id = 0) : mixed|null
[/code]
...
__
[code]
    get_client_fields(bool  $general = true, int  $client_id = 0, bool  $field_name_index = false) : mixed
[/code]
