...
#  \MainWP\Dashboard MainWP_System_Handler

_Class MainWP_System_Handler_

## Summary

Methods Properties Constants [instance](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_instance)  
[__construct](classes/MainWP-Dashboard-MainWP-System-Handler.html#method___construct)  
[filter_fetch_urls_authed](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_filter_fetch_urls_authed)  
[filter_fetch_url_authed](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_filter_fetch_url_authed)  
[hook_fetch_url_verify_action](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_hook_fetch_url_verify_action)  
[apply_filters](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_apply_filters)  
[admin_init](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_admin_init)  
[hook_get_sql_websites_for_current_user](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_hook_get_sql_websites_for_current_user)  
[handle_manage_sites_screen_settings](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_handle_manage_sites_screen_settings)  
[handle_monitoring_sites_screen_settings](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_handle_monitoring_sites_screen_settings)  
[handle_clients_screen_settings](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_handle_clients_screen_settings)  
[handle_insights_events_screen_settings](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_handle_insights_events_screen_settings)  
[handle_updates_screen_settings](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_handle_updates_screen_settings)  
[handle_mainwp_tools_settings](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_handle_mainwp_tools_settings)  
[handle_settings_post](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_handle_settings_post)  
[include_pluggable](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_include_pluggable)  
[plugins_api_extension_info](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_plugins_api_extension_info)  
[plugins_api_wp_plugins_api_result](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_plugins_api_wp_plugins_api_result)  
[check_update_custom](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_check_update_custom)  
[map_rslt_obj](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_map_rslt_obj)  
[pre_check_update_custom](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_pre_check_update_custom)  
[upload_file](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_upload_file)  
[readfile_chunked](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_readfile_chunked)  
[activate_redirect](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_activate_redirect)  
[activate_extension](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_activate_extension)  
[deactivate_extension](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_deactivate_extension)  
_No public properties found_ _No public constants found_ _No protected methods found_ _No protected properties found_ _No protected constants found_ [check_upgrade](classes/MainWP-Dashboard-MainWP-System-Handler.html#method_check_upgrade)  
[instance](classes/MainWP-Dashboard-MainWP-System-Handler.html#property_instance)  
[upgradeVersionInfo](classes/MainWP-Dashboard-MainWP-System-Handler.html#property_upgradeVersionInfo)  
_No private constants found_

File
     [ class/class-mainwp-system-handler.php ](files/class-class-mainwp-system-handler.md)
Package
...
_Private variable to hold the upgrade version info._
...
_MainWP_System_Handler constructor._
...
_Method filter_fetch_urls_authed()_
...
__
[code]
    hook_fetch_url_verify_action(mixed  $pluginFile, string  $childKey, int  $websiteId, array  $params) : mixed
[/code]

_Method hook_fetch_url_verify_action()_
...
_Method hook_get_sql_websites_for_current_user()_
...
__
[code]
    handle_manage_sites_screen_settings() : mixed
[/code]

_Method handle_manage_sites_screen_settings()_
...
__
[code]
    handle_monitoring_sites_screen_settings() : mixed
[/code]

_Method handle_monitoring_sites_screen_settings()_
...
__
[code]
    handle_clients_screen_settings() : mixed
[/code]

_Method handle_clients_screen_settings()_
...
### handle_insights_events_screen_settings()

__
[code]
    handle_insights_events_screen_settings() : mixed
[/code]

_Method handle_insights_events_screen_settings()_
...
__
[code]
    handle_updates_screen_settings() : mixed
[/code]
...
__
[code]
    handle_mainwp_tools_settings() : mixed
[/code]

_Method handle_mainwp_tools_settings()_
...
__
[code]
    include_pluggable() : mixed
[/code]

_Method include_pluggable()_
...
_Method plugins_api_extension_info()_
...
_Method plugins_api_wp_plugins_api_result()_
...
_Method map_rslt_obj()_

Map resulting object.

#### Parameters

object | $result  | Resulting information.  
---|---|---  
...
_Method pre_check_update_custom()_
...
_Method upload_file()_

Upload a file.

#### Parameters

mixed | $file  | File to upload.  
---|---|---  
...
_Method readfile_chunked()_

Read Chunked File.

#### Parameters

mixed | $filename  | Name of file.  
---|---|---  
...
__
[code]
    activate_redirect(mixed  $location) : mixed
[/code]

_Method activate_redirection()_

Redirect after activating MainWP Extension.

#### Parameters

mixed | $location  | Location to redirect to.  
---|---|---  
...
__
[code]
    activate_extension(mixed  $ext_key, array  $info = array()) : mixed
[/code]

_Method activate_extension()_

Activate MainWP Extension.

#### Parameters

mixed | $ext_key  | Extension API Key.  
---|---|---  
array | $info  | Extension Info.  
...
mixed | $ext_key  | Exnension API Key.  
---|---|---  
bool | $dashboard_only  | Deactive API Key on dashboard only.  
...
### class-mainwp-system-handler.php
[/code]
[code] 
#  __
