...
#  \MainWP\Dashboard MainWP_Manage_Backups_Handler

_Class MainWP_Manage_Backups_Handler_

## Summary

Methods Properties Constants [instance](classes/MainWP-Dashboard-MainWP-Manage-Backups-Handler.html#method_instance)  
[get_class_name](classes/MainWP-Dashboard-MainWP-Manage-Backups-Handler.html#method_get_class_name)  
[validate_backup_tasks](classes/MainWP-Dashboard-MainWP-Manage-Backups-Handler.html#method_validate_backup_tasks)  
[can_edit_backuptask](classes/MainWP-Dashboard-MainWP-Manage-Backups-Handler.html#method_can_edit_backuptask)  
[update_backup](classes/MainWP-Dashboard-MainWP-Manage-Backups-Handler.html#method_update_backup)  
[add_backup](classes/MainWP-Dashboard-MainWP-Manage-Backups-Handler.html#method_add_backup)  
[execute_backup_task](classes/MainWP-Dashboard-MainWP-Manage-Backups-Handler.html#method_execute_backup_task)  
[backup](classes/MainWP-Dashboard-MainWP-Manage-Backups-Handler.html#method_backup)  
[get_backup_task_sites](classes/MainWP-Dashboard-MainWP-Manage-Backups-Handler.html#method_get_backup_task_sites)  
[remove_backup](classes/MainWP-Dashboard-MainWP-Manage-Backups-Handler.html#method_remove_backup)  
[resume_backup](classes/MainWP-Dashboard-MainWP-Manage-Backups-Handler.html#method_resume_backup)  
[pause_backup](classes/MainWP-Dashboard-MainWP-Manage-Backups-Handler.html#method_pause_backup)  
_No public properties found_ _No public constants found_ _No protected methods found_ _No protected properties found_ _No protected constants found_ _No private methods found_ [instance](classes/MainWP-Dashboard-MainWP-Manage-Backups-Handler.html#property_instance)  
_No private constants found_

File
     [ pages/page-mainwp-manage-backups-handler.php ](files/pages-page-mainwp-manage-backups-handler.md)
Package
...
__
[code]
    validate_backup_tasks(array  $pBackupTasks) : bool
[/code]

_Validate Backup Tasks._

#### Parameters

array | $pBackupTasks  | Backup tasks.  
---|---|---  
...
__
[code]
    can_edit_backuptask(object  $task) : bool
[/code]

_Can Edit Backup Task._

#### Parameters

object | $task  | Backup task.  
---|---|---  
...
__
[code]
    execute_backup_task(mixed  $task, int  $nrOfSites, bool  $updateRun = true) : mixed
[/code]
...
---|---|---  
int | $nrOfSites  | Number of Child Sites to perform the task on.  
bool | $updateRun  | ture|false.  
...
_Prepare Child Site to be backed up._
...
_Get backup tasks and site ID._
...
### page-mainwp-manage-backups-handler.php
[/code]
[code] 
#  __
