...
#  \MainWP\Dashboard\Module\Log Log_Query

_Class - Log_Query_

## Summary

Methods Properties Constants [query](classes/MainWP-Dashboard-Module-Log-Log-Query.html#method_query)  
[get_log_meta_view](classes/MainWP-Dashboard-Module-Log-Log-Query.html#method_get_log_meta_view)  
[get_sub_query_view](classes/MainWP-Dashboard-Module-Log-Log-Query.html#method_get_sub_query_view)  
[found_records](classes/MainWP-Dashboard-Module-Log-Log-Query.html#property_found_records)  
...
File
     [ modules/logs/classes/class-log-query.php ](files/modules-logs-classes-class-log-query.md)
Package
...
_Hold the number of records found_
...
array | $args  | Arguments to filter the records by.  
---|---|---  
...
Inherited from
    [\MainWP\Dashboard\Module\Log\Log_Query](classes/MainWP-Dashboard-Module-Log-Log-Query.md)
...
_Get logs meta database table view._
...
__
[code]
    get_sub_query_view() : string
[/code]

_Method get_sub_query to support seaching in events table._
