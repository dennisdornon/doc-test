...
Methods Properties Constants _No public methods found_ _No public properties found_ [MAP](classes/phpseclib3-File-ASN1-Maps-CRLDistributionPoints.html#constant_MAP)  
...
File
     [ libs/phpseclib/vendor/phpseclib/phpseclib/phpseclib/File/ASN1/Maps/CRLDistributionPoints.php ](files/libs-phpseclib-vendor-phpseclib-phpseclib-phpseclib-file-asn1-maps-crldistributionpoints.md)
Package
...
### MAP
[code] 
    MAP = ['type' => \phpseclib3\File\ASN1::TYPE_SEQUENCE, 'min' => 1, 'max' => -1, 'children' => \phpseclib3\File\ASN1\Maps\DistributionPoint::MAP]
[/code]
