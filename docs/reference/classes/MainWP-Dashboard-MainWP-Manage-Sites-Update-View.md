...
#  \MainWP\Dashboard MainWP_Manage_Sites_Update_View

_Class MainWP_Manage_Sites_Update_View_

## Summary

Methods Properties Constants [render_updates](classes/MainWP-Dashboard-MainWP-Manage-Sites-Update-View.html#method_render_updates)  
[render_individual_updates](classes/MainWP-Dashboard-MainWP-Manage-Sites-Update-View.html#method_render_individual_updates)  
[get_total_info](classes/MainWP-Dashboard-MainWP-Manage-Sites-Update-View.html#method_get_total_info)  
[render_wpcore_updates](classes/MainWP-Dashboard-MainWP-Manage-Sites-Update-View.html#method_render_wpcore_updates)  
[render_plugins_updates](classes/MainWP-Dashboard-MainWP-Manage-Sites-Update-View.html#method_render_plugins_updates)  
[hook_table_update_plugins_header_content](classes/MainWP-Dashboard-MainWP-Manage-Sites-Update-View.html#method_hook_table_update_plugins_header_content)  
[hook_table_update_themes_header_content](classes/MainWP-Dashboard-MainWP-Manage-Sites-Update-View.html#method_hook_table_update_themes_header_content)  
[render_themes_updates](classes/MainWP-Dashboard-MainWP-Manage-Sites-Update-View.html#method_render_themes_updates)  
[render_language_updates](classes/MainWP-Dashboard-MainWP-Manage-Sites-Update-View.html#method_render_language_updates)  
[get_column_trusted](classes/MainWP-Dashboard-MainWP-Manage-Sites-Update-View.html#method_get_column_trusted)  
[is_trans_trusted_update](classes/MainWP-Dashboard-MainWP-Manage-Sites-Update-View.html#method_is_trans_trusted_update)  
[render_abandoned_plugins](classes/MainWP-Dashboard-MainWP-Manage-Sites-Update-View.html#method_render_abandoned_plugins)  
[render_abandoned_themes](classes/MainWP-Dashboard-MainWP-Manage-Sites-Update-View.html#method_render_abandoned_themes)  
...
File
     [ class/class-mainwp-manage-sites-update-view.php ](files/class-class-mainwp-manage-sites-update-view.md)
Package
...
__
[code]
    render_individual_updates(mixed  $id) : mixed
[/code]

_Method render_individual_updates()_

Render Plugin updates Tab.

#### Parameters

mixed | $id  | Child Site ID.  
---|---|---  
...
__
[code]
    get_total_info(mixed  $site_id) : mixed
[/code]

_Method get_total_info()_

Get total Updates information.

#### Parameters

mixed | $site_id  | Child Site id.  
---|---|---  
...
__
[code]
    render_wpcore_updates(mixed  $website, mixed  $active_tab, object  $userExtension) : mixed
[/code]

_Method render_wpcore_updates()_
...
mixed | $website  | Child Site info.  
---|---|---  
mixed | $active_tab  | Current active tab.  
...
__
[code]
    render_plugins_updates(mixed  $website, mixed  $active_tab, mixed  $userExtension) : mixed
[/code]

_Method render_plugins_updates()_
...
---|---|---  
mixed | $active_tab  | Current active tab.  
mixed | $userExtension  | MainWP trusted plugin data.  
...
__
[code]
    hook_table_update_plugins_header_content(string  $column_display_name, mixed  $column_key, bool  $top) : mixed
[/code]

_Method hook_table_update_plugins_header_content()_

Hook render the column header updates table.

#### Parameters

string | $column_display_name  | column display name.  
---|---|---  
mixed | $column_key  | column key.  
bool | $top  | Top or bottom header.  
...
__
[code]
    hook_table_update_themes_header_content(string  $column_display_name, mixed  $column_key, bool  $top) : mixed
[/code]

_Method hook_table_update_themes_header_content()_
...
__
[code]
    render_themes_updates(mixed  $website, mixed  $active_tab, mixed  $userExtension) : mixed
[/code]

_Method render_themes_updates()_
...
---|---|---  
mixed | $active_tab  | Current active tab.  
mixed | $userExtension  | MainWP trusted themes data.  
...
__
[code]
    render_language_updates(mixed  $website, mixed  $active_tab, object  $userExtension) : mixed
[/code]

_Method render_language_updates()_
...
---|---|---  
mixed | $active_tab  | Current active tab.  
object | $userExtension  | User extension data.  
...
__
[code]
    get_column_trusted(mixed  $value) : mixed
[/code]

_Get trusted column._
...
### is_trans_trusted_update()

__
[code]
    is_trans_trusted_update(string  $tran_info, array  $trusted_plugins, array  $trusted_themes) : mixed
[/code]

_Check if trans is trusted update._

#### Parameters

string | $tran_info  | Translation slug.  
---|---|---  
array | $trusted_plugins  | Trusted update plugins.  
array | $trusted_themes  | Trusted update themes.  
...
__
[code]
    render_abandoned_plugins(mixed  $website, mixed  $active_tab, mixed  $userExtension) : mixed
[/code]

_Method render_abandoned_plugins()_
...
__
[code]
    render_abandoned_themes(mixed  $website, mixed  $active_tab, mixed  $userExtension) : mixed
[/code]
...
### class-mainwp-manage-sites-update-view.php
[/code]
[code] 
#  __
