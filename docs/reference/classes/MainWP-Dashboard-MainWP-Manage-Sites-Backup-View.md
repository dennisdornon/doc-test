...
#  \MainWP\Dashboard MainWP_Manage_Sites_Backup_View

_Class MainWP_Manage_Sites_Backup_View_

## Summary

Methods Properties Constants [show_backups](classes/MainWP-Dashboard-MainWP-Manage-Sites-Backup-View.html#method_show_backups)  
[render_backup_site](classes/MainWP-Dashboard-MainWP-Manage-Sites-Backup-View.html#method_render_backup_site)  
[render_backup_details](classes/MainWP-Dashboard-MainWP-Manage-Sites-Backup-View.html#method_render_backup_details)  
[render_backup_options](classes/MainWP-Dashboard-MainWP-Manage-Sites-Backup-View.html#method_render_backup_options)  
...
File
     [ class/class-mainwp-manage-sites-backup-view.php ](files/class-class-mainwp-manage-sites-backup-view.md)
Package
...
__
[code]
    show_backups(object  $website, array  $fullBackups, array  $dbBackups) : mixed
[/code]

_Shows the available backups taken._

#### Parameters

object | $website  | Child Site info.  
---|---|---  
array | $fullBackups  | Full Backups Array.  
array | $dbBackups  | DB Backups Array.  
...
__
[code]
    render_backup_site(mixed  $website) : string
[/code]

_Renders the Backup Site Dialog._
...
### render_backup_details()

__
[code]
    render_backup_details(mixed  $websiteid) : string
[/code]

_Render Backup Details._
...
### render_backup_options()

__
[code]
    render_backup_options(mixed  $websiteid) : string
[/code]

_Render Backup Options._
...
### class-mainwp-manage-sites-backup-view.php
[/code]
[code] 
#  __
