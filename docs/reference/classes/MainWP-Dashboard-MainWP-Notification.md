...
#  \MainWP\Dashboard MainWP_Notification

_Class MainWP_Notification_

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Notification.html#method_get_class_name)  
[send_notify_user](classes/MainWP-Dashboard-MainWP-Notification.html#method_send_notify_user)  
[send_http_check_notification](classes/MainWP-Dashboard-MainWP-Notification.html#method_send_http_check_notification)  
[send_license_deactivated_alert](classes/MainWP-Dashboard-MainWP-Notification.html#method_send_license_deactivated_alert)  
[send_daily_digest_notification](classes/MainWP-Dashboard-MainWP-Notification.html#method_send_daily_digest_notification)  
[send_websites_uptime_monitoring](classes/MainWP-Dashboard-MainWP-Notification.html#method_send_websites_uptime_monitoring)  
[send_websites_health_status_notification](classes/MainWP-Dashboard-MainWP-Notification.html#method_send_websites_health_status_notification)  
[send_wp_mail](classes/MainWP-Dashboard-MainWP-Notification.html#method_send_wp_mail)  
...
File
     [ class/class-mainwp-notification.php ](files/class-class-mainwp-notification.md)
Package
...
__
[code]
    send_notify_user(int  $userId, string  $subject, string  $content) : mixed
[/code]

_Method send_notify_user()_
...
__
[code]
    send_http_check_notification(mixed  $email_settings, array  $sites_status, bool  $plain_text) : bool
[/code]

_Method send_http_check_notification()._

Send HTTP response email notification.

#### Parameters

mixed | $email_settings  | Email settings.  
---|---|---  
array | $sites_status  | Websites http status.  
bool | $plain_text  | Text format.  
...
__
[code]
    send_license_deactivated_alert(mixed  $email_settings, array  $deactivated_license, bool  $plain_text) : bool
[/code]

_Method send_license_deactivated_alert()._
...
mixed | $email_settings  | Email settings.  
---|---|---  
array | $deactivated_license  | Websites http status.  
bool | $plain_text  | Text format.  
...
__
[code]
    send_daily_digest_notification(array  $email_settings, bool  $available_updates, mixed  $wp_updates, mixed  $plugin_updates, mixed  $theme_updates, mixed  $sites_disconnected, array  $params = array()) : bool
[/code]

_Method send_daily_digest_notification()._
...
---|---|---  
bool | $available_updates  | Update avaiable.  
mixed | $wp_updates  | WP updates.  
mixed | $plugin_updates  | Plugin updates.  
mixed | $theme_updates  | Theme updates.  
mixed | $sites_disconnected  | Sites disconnected.  
...
__
[code]
    send_websites_uptime_monitoring(string  $emails, string  $subject, string  $mail_content, bool  $plain_text) : mixed
[/code]

_Method send_websites_uptime_monitoring()._

Send websites status email notification.

#### Parameters

string | $emails  | notification emails.  
---|---|---  
string | $subject  | email subject.  
string | $mail_content  | email content.  
bool | $plain_text  | Text format.  
...
__
[code]
    send_websites_health_status_notification(string  $email, string  $subject, string  $mail_content, bool  $plain_text) : mixed
[/code]

_Method send_websites_health_status_notification()._
...
__
[code]
    send_wp_mail(string  $email, string  $subject, string  $mail_content, string  $content_type = '') : mixed
[/code]

_Method send_wp_mail()._
...
string | $mail_content  | Text format.  
string | $content_type  | email content.  
