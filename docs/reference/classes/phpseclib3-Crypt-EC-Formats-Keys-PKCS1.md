...
_" PKCS1" (RFC5915) Formatted EC Key Handler_

## Summary

Methods Properties Constants [saveParameters](classes/phpseclib3-Crypt-EC-Formats-Keys-PKCS1.html#method_saveParameters)  
[savePrivateKey](classes/phpseclib3-Crypt-EC-Formats-Keys-PKCS1.html#method_savePrivateKey)  
...
File
     [ libs/phpseclib/vendor/phpseclib/phpseclib/phpseclib/Crypt/EC/Formats/Keys/PKCS1.php ](files/libs-phpseclib-vendor-phpseclib-phpseclib-phpseclib-crypt-ec-formats-keys-pkcs1.md)
Package
...
__
[code]
    saveParameters(\phpseclib3\Crypt\EC\BaseCurves\Base  $curve, array  $options = []) : string
[/code]
...
Inherited from
    [\phpseclib3\Crypt\EC\Formats\Keys\PKCS1](classes/phpseclib3-Crypt-EC-Formats-Keys-PKCS1.md)
