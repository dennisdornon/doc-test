...
#  \MainWP\Dashboard MainWP_Updates_Handler

_Class MainWP_Updates_Handler_

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Updates-Handler.html#method_get_class_name)  
[upgrade_site](classes/MainWP-Dashboard-MainWP-Updates-Handler.html#method_upgrade_site)  
[upgrade_website](classes/MainWP-Dashboard-MainWP-Updates-Handler.html#method_upgrade_website)  
[ignore_plugin_theme](classes/MainWP-Dashboard-MainWP-Updates-Handler.html#method_ignore_plugin_theme)  
[unignore_plugin_theme](classes/MainWP-Dashboard-MainWP-Updates-Handler.html#method_unignore_plugin_theme)  
[unignore_core_updates](classes/MainWP-Dashboard-MainWP-Updates-Handler.html#method_unignore_core_updates)  
[unignore_global_cores](classes/MainWP-Dashboard-MainWP-Updates-Handler.html#method_unignore_global_cores)  
[ignore_plugins_themes](classes/MainWP-Dashboard-MainWP-Updates-Handler.html#method_ignore_plugins_themes)  
[unignore_global_plugins_themes](classes/MainWP-Dashboard-MainWP-Updates-Handler.html#method_unignore_global_plugins_themes)  
[unignore_abandoned_plugin_theme](classes/MainWP-Dashboard-MainWP-Updates-Handler.html#method_unignore_abandoned_plugin_theme)  
[unignore_abandoned_plugins_themes](classes/MainWP-Dashboard-MainWP-Updates-Handler.html#method_unignore_abandoned_plugins_themes)  
[dismiss_plugin_theme](classes/MainWP-Dashboard-MainWP-Updates-Handler.html#method_dismiss_plugin_theme)  
[dismiss_plugins_themes](classes/MainWP-Dashboard-MainWP-Updates-Handler.html#method_dismiss_plugins_themes)  
[upgrade_plugin_theme_translation](classes/MainWP-Dashboard-MainWP-Updates-Handler.html#method_upgrade_plugin_theme_translation)  
[update_plugin_theme_translation](classes/MainWP-Dashboard-MainWP-Updates-Handler.html#method_update_plugin_theme_translation)  
[get_plugin_theme_slugs](classes/MainWP-Dashboard-MainWP-Updates-Handler.html#method_get_plugin_theme_slugs)  
...
File
     [ pages/page-mainwp-updates-handler.php ](files/pages-page-mainwp-updates-handler.md)
Package
...
__
[code]
    upgrade_site(int  $id) : string
[/code]

_Method upgrade_site()_
...
__
[code]
    ignore_plugin_theme(mixed  $type, mixed  $slug, mixed  $name, mixed  $id, string  $ver = '') : string
[/code]
...
---|---|---  
mixed | $slug  | Plugin or Theme Slug.  
mixed | $name  | Plugin or Theme Name.  
mixed | $id  | Child Site ID.  
string | $ver  | version ignore.  
...
__
[code]
    unignore_plugin_theme(mixed  $type, mixed  $slug, mixed  $id, string  $ver) : string
[/code]

_Remove a plugin or theme from the ignore list._
...
---|---|---  
mixed | $slug  | Plugin or Theme slug.  
mixed | $id  | Plugin or Theme name.  
string | $ver  | Plugin or Theme version.  
...
### unignore_core_updates()

__
[code]
    unignore_core_updates(mixed  $id, string  $ver) : string
[/code]

_Remove WP from the ignore list._
...
### unignore_global_cores()

__
[code]
    unignore_global_cores(string  $slug, string  $ver) : string
[/code]

_Unignore Plugins or Themes._

#### Parameters

string | $slug  | _ALL_ |empty.  
---|---|---  
string | $ver  | version info.  
...
__
[code]
    ignore_plugins_themes(string  $type, string  $slug, string  $name, string  $ver = '') : string
[/code]

_Method ignore_plugins_themes()_
...
---|---|---  
string | $slug  | Plugin or tempheme slug.  
string | $name  | Plugin or theme name.  
string | $ver  | Plugin or theme version.  
...
### unignore_global_plugins_themes()

__
[code]
    unignore_global_plugins_themes(mixed  $type, mixed  $slug, string  $ver) : string
[/code]
...
mixed | $type  | plugin|themes.  
---|---|---  
mixed | $slug  | Plugin or Themes slug.  
string | $ver  | Plugin or Themes version.  
...
_Unignor abandoned plugins or themes._
...
_Unignore abandoned plugins or themes._
...
__
[code]
    upgrade_plugin_theme_translation(int  $id, string  $type, array  $list_items) : array
[/code]

_Method upgrade_plugin_theme_translation()_
...
__
[code]
    update_plugin_theme_translation(int  $website, string  $type, array  $list_items) : array|false
[/code]

_Method update_plugin_theme_translation()_

Upgrade plugin or theme translations.

#### Parameters

int | $website  | Child site object.  
---|---|---  
string | $type  | Plugin or theme.  
array | $list_items  | List of theme or plugin names seperated by comma.  
...
__
[code]
    get_plugin_theme_slugs(int  $id, string  $type) : array
[/code]

_Get plugin or theme slugs._
...
### page-mainwp-updates-handler.php
[/code]
[code] 
#  __
