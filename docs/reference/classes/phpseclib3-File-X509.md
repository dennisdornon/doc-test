...
_Pure-PHP X.509 Parser_

## Summary

Methods Properties Constants [__construct](classes/phpseclib3-File-X509.html#method___construct)  
[loadX509](classes/phpseclib3-File-X509.html#method_loadX509)  
[saveX509](classes/phpseclib3-File-X509.html#method_saveX509)  
[loadCA](classes/phpseclib3-File-X509.html#method_loadCA)  
[validateURL](classes/phpseclib3-File-X509.html#method_validateURL)  
[validateDate](classes/phpseclib3-File-X509.html#method_validateDate)  
[validateSignature](classes/phpseclib3-File-X509.html#method_validateSignature)  
[setRecurLimit](classes/phpseclib3-File-X509.html#method_setRecurLimit)  
[disableURLFetch](classes/phpseclib3-File-X509.html#method_disableURLFetch)  
[enableURLFetch](classes/phpseclib3-File-X509.html#method_enableURLFetch)  
[decodeIP](classes/phpseclib3-File-X509.html#method_decodeIP)  
[decodeNameConstraintIP](classes/phpseclib3-File-X509.html#method_decodeNameConstraintIP)  
[encodeIP](classes/phpseclib3-File-X509.html#method_encodeIP)  
[setDNProp](classes/phpseclib3-File-X509.html#method_setDNProp)  
[removeDNProp](classes/phpseclib3-File-X509.html#method_removeDNProp)  
[getDNProp](classes/phpseclib3-File-X509.html#method_getDNProp)  
[setDN](classes/phpseclib3-File-X509.html#method_setDN)  
[getDN](classes/phpseclib3-File-X509.html#method_getDN)  
[getIssuerDN](classes/phpseclib3-File-X509.html#method_getIssuerDN)  
[getSubjectDN](classes/phpseclib3-File-X509.html#method_getSubjectDN)  
[getIssuerDNProp](classes/phpseclib3-File-X509.html#method_getIssuerDNProp)  
[getSubjectDNProp](classes/phpseclib3-File-X509.html#method_getSubjectDNProp)  
[getChain](classes/phpseclib3-File-X509.html#method_getChain)  
[getCurrentCert](classes/phpseclib3-File-X509.html#method_getCurrentCert)  
...
[mapInAttributes](classes/phpseclib3-File-X509.html#method_mapInAttributes)  
...
_Return OpenSSL compatible array_
...
_Attribute value disposition._
...
__
[code]
    setStartDate(\DateTimeInterface|string  $date) : mixed
[/code]

_Set certificate start date_
...
__
[code]
    setEndDate(\DateTimeInterface|string  $date) : mixed
[/code]

_Set certificate end date_
...
__
[code]
    setSerialNumber(string  $serial, int  $base = -256) : mixed
[/code]
...
_Turns the certificate into a certificate authority_
...
_Remove a certificate, CSR or CRL Extension_
...
_Sets the subject key identifier_
...
_Set the domain name 's which the cert is to be valid for_

#### Parameters

mixed | $domains variadic |   
---|---|---  
...
__
[code]
    setIPAddress(array  ...$ipAddresses) : mixed
[/code]

_Set the IP Addresses 's which the cert is to be valid for_

#### Parameters

array | $ipAddresses variadic |   
---|---|---  
...
_Remove a Revoked Certificate Extension_
...
__
[code]
    registerExtension(string  $id, array  $mapping) : mixed
[/code]
...
__
[code]
    mapInExtensions(array  $root, string  $path) : mixed
[/code]

_Map extension values from octet string to extension-specific internal format._
...
__
[code]
    mapOutExtensions(array  $root, string  $path) : mixed
[/code]

_Map extension values from extension-specific internal format to octet string._
...
__
[code]
    mapInAttributes(array  $root, string  $path) : mixed
[/code]

_Map attribute values from ANY type to attribute-specific internal format._
...
__
[code]
    mapOutAttributes(array  $root, string  $path) : mixed
[/code]

_Map attribute values from attribute-specific internal format to ANY type._
...
__
[code]
    mapInDNs(array  $root, string  $path) : mixed
[/code]

_Map DN values from ANY type to DN-specific internal format._
...
__
[code]
    mapOutDNs(array  $root, string  $path) : mixed
[/code]

_Map DN values from DN-specific internal format to ANY type._
...
_Associate an extension ID to an extension mapping_
...
__
[code]
    fetchURL(string  $url) : bool|string
[/code]
...
__
[code]
    testForIntermediate(bool  $caonly, int  $count) : bool
[/code]

_Validates an intermediate cert as identified via authority info access extension_
...
__
[code]
    validateSignatureCountable(bool  $caonly, int  $count) : mixed
[/code]
...
__
[code]
    validateSignatureHelper(string  $publicKeyAlgorithm, string  $publicKey, string  $signatureAlgorithm, string  $signature, string  $signatureSubject) : bool
[/code]

_Validates a signature_
...
_" Normalizes" a Distinguished Name property_
...
_Helper function to build a time field according to RFC 3280 section \- 4.1.2.5 Validity \- 5.1.2.4 This Update \- 5.1.2.5 Next Update \- 5.1.2.6 Revoked Certificates by choosing utcTime iff year of date given is before 2050 and generalTime else._
...
__
[code]
    identifySignatureAlgorithm(\phpseclib3\Crypt\Common\PrivateKey  $key) : array
[/code]

_Identify signature algorithm from key settings_
...
__
[code]
    isSubArrayValid(array  $root, string  $path) : bool
[/code]

_Check for validity of subarray_
...
_Format a public key as appropriate_
...
_Helper function to build domain array_
...
_Helper function to build IP Address array_
