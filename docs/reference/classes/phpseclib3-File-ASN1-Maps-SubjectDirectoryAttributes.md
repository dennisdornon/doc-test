...
Methods Properties Constants _No public methods found_ _No public properties found_ [MAP](classes/phpseclib3-File-ASN1-Maps-SubjectDirectoryAttributes.html#constant_MAP)  
...
File
     [ libs/phpseclib/vendor/phpseclib/phpseclib/phpseclib/File/ASN1/Maps/SubjectDirectoryAttributes.php ](files/libs-phpseclib-vendor-phpseclib-phpseclib-phpseclib-file-asn1-maps-subjectdirectoryattributes.md)
Package
...
### MAP
[code] 
    MAP = ['type' => \phpseclib3\File\ASN1::TYPE_SEQUENCE, 'min' => 1, 'max' => -1, 'children' => \phpseclib3\File\ASN1\Maps\Attribute::MAP]
[/code]
