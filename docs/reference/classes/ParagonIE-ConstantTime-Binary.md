...
Methods Properties Constants [safeStrlen](classes/ParagonIE-ConstantTime-Binary.html#method_safeStrlen)  
[safeSubstr](classes/ParagonIE-ConstantTime-Binary.html#method_safeSubstr)  
...
File
     [ libs/phpseclib/vendor/paragonie/constant_time_encoding/src/Binary.php ](files/libs-phpseclib-vendor-paragonie-constant-time-encoding-src-binary.md)
Package
...
Inherited from
    [\ParagonIE\ConstantTime\Binary](classes/ParagonIE-ConstantTime-Binary.md)
...
__
[code]
    safeSubstr(string  $str, int  $start = 0, ?int  $length = null) : string
[/code]
