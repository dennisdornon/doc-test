...
_Class MainWP MainWP_Plugins_Handler_

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Plugins-Handler.html#method_get_class_name)  
[plugins_search_handler](classes/MainWP-Dashboard-MainWP-Plugins-Handler.html#method_plugins_search_handler)  
[activate_plugins](classes/MainWP-Dashboard-MainWP-Plugins-Handler.html#method_activate_plugins)  
[deactivate_plugins](classes/MainWP-Dashboard-MainWP-Plugins-Handler.html#method_deactivate_plugins)  
[delete_plugins](classes/MainWP-Dashboard-MainWP-Plugins-Handler.html#method_delete_plugins)  
[ignore_updates](classes/MainWP-Dashboard-MainWP-Plugins-Handler.html#method_ignore_updates)  
[action](classes/MainWP-Dashboard-MainWP-Plugins-Handler.html#method_action)  
[trust_post](classes/MainWP-Dashboard-MainWP-Plugins-Handler.html#method_trust_post)  
[trust_plugin](classes/MainWP-Dashboard-MainWP-Plugins-Handler.html#method_trust_plugin)  
[check_auto_update_plugin](classes/MainWP-Dashboard-MainWP-Plugins-Handler.html#method_check_auto_update_plugin)  
[save_trusted_plugin_note](classes/MainWP-Dashboard-MainWP-Plugins-Handler.html#method_save_trusted_plugin_note)  
...
File
     [ pages/page-mainwp-plugins-handler.php ](files/pages-page-mainwp-plugins-handler.md)
Package
...
### plugins_search_handler()

__
[code]
    plugins_search_handler(mixed  $data, object  $website, mixed  $output) : mixed
[/code]

_Plugins Search Handler._

#### Parameters

mixed | $data  | Search Data.  
---|---|---  
object | $website  | Child Sites.  
mixed | $output  | Output.  
...
__
[code]
    action(mixed  $pAction) : mixed
[/code]

_Plugin Action handler._

#### Parameters

mixed | $pAction  | activate|deactivate|delete.  
---|---|---  
...
__
[code]
    trust_plugin(mixed  $slug) : mixed
[/code]

_Update Trusted Plugin list._

#### Parameters

mixed | $slug  | Plugin Slug.  
---|---|---  
...
### check_auto_update_plugin()

__
[code]
    check_auto_update_plugin(mixed  $slug) : bool
[/code]

_Check if automatic daily updates is on and the plugin is on the trusted list._
...
### save_trusted_plugin_note()

__
[code]
    save_trusted_plugin_note() : mixed
[/code]

_Save the trusted plugin note._
...
### page-mainwp-plugins-handler.php
[/code]
[code] 
#  __
