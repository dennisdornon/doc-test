...
#  \MainWP\Dashboard MainWP_Monitoring_View

_Class MainWP_Monitoring_View_

## Summary

Methods Properties Constants [render_settings](classes/MainWP-Dashboard-MainWP-Monitoring-View.html#method_render_settings)  
...
File
     [ class/class-mainwp-monitoring-view.php ](files/class-class-mainwp-monitoring-view.md)
Package
...
__
[code]
    render_settings() : mixed
[/code]

_Render monitoring sites settings._
...
Inherited from
    [\MainWP\Dashboard\MainWP_Monitoring_View](classes/MainWP-Dashboard-MainWP-Monitoring-View.md)
...
### class-mainwp-monitoring-view.php
[/code]
[code] 
#  __
