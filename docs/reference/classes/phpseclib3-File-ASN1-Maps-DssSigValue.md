...
Methods Properties Constants _No public methods found_ _No public properties found_ [MAP](classes/phpseclib3-File-ASN1-Maps-DssSigValue.html#constant_MAP)  
...
File
     [ libs/phpseclib/vendor/phpseclib/phpseclib/phpseclib/File/ASN1/Maps/DssSigValue.php ](files/libs-phpseclib-vendor-phpseclib-phpseclib-phpseclib-file-asn1-maps-dsssigvalue.md)
Package
...
### MAP
[code] 
    MAP = ['type' => \phpseclib3\File\ASN1::TYPE_SEQUENCE, 'children' => ['r' => ['type' => \phpseclib3\File\ASN1::TYPE_INTEGER], 's' => ['type' => \phpseclib3\File\ASN1::TYPE_INTEGER]]]
[/code]
