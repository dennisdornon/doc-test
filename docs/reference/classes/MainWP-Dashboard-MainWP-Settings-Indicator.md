...
#  \MainWP\Dashboard MainWP_Settings_Indicator

_Class MainWP_Settings_Indicator_

## Summary

Methods Properties Constants [get_instance](classes/MainWP-Dashboard-MainWP-Settings-Indicator.html#method_get_instance)  
[render_indicator](classes/MainWP-Dashboard-MainWP-Settings-Indicator.html#method_render_indicator)  
[get_indicator](classes/MainWP-Dashboard-MainWP-Settings-Indicator.html#method_get_indicator)  
[render_not_default_indicator](classes/MainWP-Dashboard-MainWP-Settings-Indicator.html#method_render_not_default_indicator)  
[render_not_default_email_settings_indicator](classes/MainWP-Dashboard-MainWP-Settings-Indicator.html#method_render_not_default_email_settings_indicator)  
[get_defaults_value](classes/MainWP-Dashboard-MainWP-Settings-Indicator.html#method_get_defaults_value)  
[get_defaults_email_settings_value](classes/MainWP-Dashboard-MainWP-Settings-Indicator.html#method_get_defaults_email_settings_value)  
[saved_indicator_status](classes/MainWP-Dashboard-MainWP-Settings-Indicator.html#property_saved_indicator_status)  
_No public constants found_ _No protected methods found_ [instance](classes/MainWP-Dashboard-MainWP-Settings-Indicator.html#property_instance)  
_No protected constants found_ _No private methods found_ _No private properties found_ _No private constants found_

File
     [ pages/page-mainwp-settings-indicator.php ](files/pages-page-mainwp-settings-indicator.md)
Package
...
### $saved_indicator_status
[code] 
    $saved_indicator_status : array
[/code]
...
Inherited from
    [\MainWP\Dashboard\MainWP_Settings_Indicator](classes/MainWP-Dashboard-MainWP-Settings-Indicator.md)
...
string | $indi_type  | Indicator type.  
---|---|---  
string | $wrapper_cls  | field wrapper class.  
...
string | $field  | setting field to check.  
---|---|---  
mixed | $current_value  | setting current value.  
bool | $render_indi  | to render indication.  
mixed | $default_val  | default value directly.  
...
### render_not_default_email_settings_indicator()
...
string | $type  | setting type to get default value.  
---|---|---  
string | $field  | setting field to check.  
mixed | $current_value  | setting current value.  
bool | $general  | general setting.  
bool | $render_indi  | to render indication.  
...
__
[code]
    get_defaults_value(string  $field = 'all') : mixed
[/code]

_Method get_defaults_value()._

#### Parameters

string | $field  | setting field to get default value.  
---|---|---  
...
### get_defaults_email_settings_value()
...
### page-mainwp-settings-indicator.php
[/code]
[code] 
#  __
