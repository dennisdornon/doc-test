...
#  \MainWP\Dashboard MainWP_DB_Site_Actions

_Class MainWP_DB_Site_Actions_
...
[hook_db_install_tables](classes/MainWP-Dashboard-MainWP-DB-Site-Actions.html#method_hook_db_install_tables)  
[hook_delete_site](classes/MainWP-Dashboard-MainWP-DB-Site-Actions.html#method_hook_delete_site)  
[sync_site_actions](classes/MainWP-Dashboard-MainWP-DB-Site-Actions.html#method_sync_site_actions)  
[add_site_action](classes/MainWP-Dashboard-MainWP-DB-Site-Actions.html#method_add_site_action)  
[update_action_by_id](classes/MainWP-Dashboard-MainWP-DB-Site-Actions.html#method_update_action_by_id)  
[get_wp_action_by_id](classes/MainWP-Dashboard-MainWP-DB-Site-Actions.html#method_get_wp_action_by_id)  
[get_non_mainwp_action_by_id](classes/MainWP-Dashboard-MainWP-DB-Site-Actions.html#method_get_non_mainwp_action_by_id)  
[delete_action_by](classes/MainWP-Dashboard-MainWP-DB-Site-Actions.html#method_delete_action_by)  
[delete_all_actions](classes/MainWP-Dashboard-MainWP-DB-Site-Actions.html#method_delete_all_actions)  
[get_wp_actions](classes/MainWP-Dashboard-MainWP-DB-Site-Actions.html#method_get_wp_actions)  
[get_none_mainwp_actions_log](classes/MainWP-Dashboard-MainWP-DB-Site-Actions.html#method_get_none_mainwp_actions_log)  
...
File
     [ class/class-mainwp-db-site-actions.php ](files/class-class-mainwp-db-site-actions.md)
Package
...
Inherited from
    [\MainWP\Dashboard\MainWP_DB_Site_Actions](classes/MainWP-Dashboard-MainWP-DB-Site-Actions.md)
...
__
[code]
    sync_site_actions(int  $site_id, array  $sync_actions) : bool
[/code]

_Method sync_site_actions()._
...
__
[code]
    add_site_action(array  $data) : bool
[/code]

_Method add_new_action._
...
__
[code]
    update_action_by_id(int  $action_id, array  $data) : bool
[/code]

_Method update_action_by_id._
...
__
[code]
    get_wp_action_by_id(int  $action_id) : bool
[/code]

_Method update_action._
...
### get_non_mainwp_action_by_id()

__
[code]
    get_non_mainwp_action_by_id(int  $log_id) : bool
[/code]

_Method get_non_mainwp_action_by_id._

#### Parameters

int | $log_id  | action id.  
---|---|---  
...
__
[code]
    delete_action_by(string  $by = 'action_id', mixed  $value = \MainWP\Dashboard\null) : bool
[/code]

_Method delete_action_by._
...
__
[code]
    delete_all_actions() : bool
[/code]

_Method delete_all_actions._
...
__
[code]
    get_wp_actions(bool  $params = array(), mixed  $obj = \MainWP\Dashboard\OBJECT, bool  $legacy = \MainWP\Dashboard\false) : mixed
[/code]

_Method get_wp_actions._
...
### get_none_mainwp_actions_log()

__
[code]
    get_none_mainwp_actions_log(bool  $legacy_params = array(), mixed  $obj = \MainWP\Dashboard\OBJECT) : mixed
[/code]

_Method get_none_mainwp_actions_log._

Get wp actions.

#### Parameters

bool | $legacy_params  | params.  
---|---|---  
mixed | $obj  | Format data.  
