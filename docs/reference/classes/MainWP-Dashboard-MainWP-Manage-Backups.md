...
#  \MainWP\Dashboard MainWP_Manage_Backups

_Class MainWP_Manage_Backups_

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_get_class_name)  
[instance](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_instance)  
[init](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_init)  
[init_menu](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_init_menu)  
[init_subpages_menu](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_init_subpages_menu)  
[init_left_menu](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_init_left_menu)  
[render_header](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_render_header)  
[render_footer](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_render_footer)  
[render_manager](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_render_manager)  
[display](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_display)  
[single_row](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_single_row)  
[column_actions](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_column_actions)  
[column_task_name](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_column_task_name)  
[column_type](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_column_type)  
[column_schedule](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_column_schedule)  
[column_destination](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_column_destination)  
[column_websites](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_column_websites)  
[column_details](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_column_details)  
[column_trigger](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_column_trigger)  
[render_edit](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_render_edit)  
[render_new](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_render_new)  
[render_new_edit](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_render_new_edit)  
[render_schedule_backup](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_render_schedule_backup)  
[render_task_details](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_render_task_details)  
[render_settings](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_render_settings)  
[render_individual_settings](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_render_individual_settings)  
[subPages](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#property_subPages)  
_No public constants found_ _No protected methods found_ _No protected properties found_ _No protected constants found_ _No private methods found_ [hideSubmenuBackups](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#property_hideSubmenuBackups)  
[instance](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#property_instance)  
_No private constants found_

File
     [ pages/page-mainwp-manage-backups.php ](files/pages-page-mainwp-manage-backups.md)
Package
...
### $subPages
[code] 
    $subPages : \MainWP\Dashboard\undefined
[/code]

_Subpages variable._

#### Type

undefined — Subpages variable. 
...
### $hideSubmenuBackups
[code] 
    $hideSubmenuBackups : bool
[/code]

_Whether or not to show the Backups Submenu._
...
Inherited from
    [\MainWP\Dashboard\MainWP_Manage_Backups](classes/MainWP-Dashboard-MainWP-Manage-Backups.md)
...
_Instantiate legacy backups subpages._
...
array | $subPages  | Legacy Backup Subpages.  
---|---|---  
bool | $enableLegacyBackup  | ture|false, whether or not to enable menu.  
...
_Render MainWP Legacy Backups Page Header._
...
_Render MainWP Legacy Backups Footer._
...
__
[code]
    render_manager() : mixed
[/code]

_Render Legacy Backups page._
...
Uses
     ...
     [\MainWP\Dashboard\MainWP_DB_Backup::get_backup_tasks_for_user()](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_get_backup_tasks_for_user)
     ...
     [\MainWP\Dashboard\MainWP_Manage_Backups_Handler::can_edit_backuptask()](classes/MainWP-Dashboard-MainWP-Manage-Backups-Handler.html#method_can_edit_backuptask)
     [\MainWP\Dashboard\MainWP_Manage_Backups_Handler::validate_backup_tasks()](classes/MainWP-Dashboard-MainWP-Manage-Backups-Handler.html#method_validate_backup_tasks)
...
__
[code]
    display(mixed  $backup_items) : mixed
[/code]

_Render MainWP Legacy Backups Table._

#### Parameters

mixed | $backup_items  | List Item.  
---|---|---  
...
__
[code]
    single_row(mixed  $item, mixed  $columns) : mixed
[/code]

_Single row Content._

#### Parameters

mixed | $item  | Item to go in column.  
---|---|---  
mixed | $columns  | Columns Array.  
...
__
[code]
    column_actions(mixed  $item) : string
[/code]
...
__
[code]
    column_task_name(mixed  $item) : string
[/code]
...
__
[code]
    column_schedule(mixed  $item) : string
[/code]
...
__
[code]
    column_destination(mixed  $item) : string
[/code]

_Column Destination._
...
__
[code]
    column_websites(mixed  $item) : mixed
[/code]
...
__
[code]
    column_details(mixed  $item) : string
[/code]
...
__
[code]
    column_trigger(mixed  $item) : string
[/code]
...
__
[code]
    render_new_edit(mixed  $task) : mixed
[/code]

_Render New edit Form._
...
### render_schedule_backup()

__
[code]
    render_schedule_backup() : void
[/code]

_Render Scheduled Backup._
...
__
[code]
    render_task_details(mixed  $task, mixed  $globalArchiveFormatText, mixed  $archiveFormat, mixed  $useGlobal, mixed  $useSite) : mixed
[/code]

_Render Task Details._

#### Parameters

mixed | $task  | Task to perform.  
---|---|---  
mixed | $globalArchiveFormatText  | Global Archived Format Text.  
mixed | $archiveFormat  | Archive Format.  
mixed | $useGlobal  | Use Global.  
mixed | $useSite  | Use Site.  
...
__
[code]
    render_individual_settings(mixed  $website) : mixed
[/code]

_Method render_individual_settings()_

Render backup settings.

#### Parameters

mixed | $website  | Website data.  
---|---|---  
...
### page-mainwp-manage-backups.php
[/code]
[code] 
#  __
...
Documentation is powered by [phpDocumentor ](https://www.phpdoc.org/) and authored on February 1st, 2026 at 00:44. 
  ...
  *[undefined]: \MainWP\Dashboard\undefined
