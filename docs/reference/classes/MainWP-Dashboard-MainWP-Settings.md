...
#  \MainWP\Dashboard MainWP_Settings

_Class MainWP_Settings_

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Settings.html#method_get_class_name)  
[get_instance](classes/MainWP-Dashboard-MainWP-Settings.html#method_get_instance)  
[init](classes/MainWP-Dashboard-MainWP-Settings.html#method_init)  
[admin_init](classes/MainWP-Dashboard-MainWP-Settings.html#method_admin_init)  
[init_menu](classes/MainWP-Dashboard-MainWP-Settings.html#method_init_menu)  
[init_subpages_menu](classes/MainWP-Dashboard-MainWP-Settings.html#method_init_subpages_menu)  
[init_left_menu](classes/MainWP-Dashboard-MainWP-Settings.html#method_init_left_menu)  
[render_header](classes/MainWP-Dashboard-MainWP-Settings.html#method_render_header)  
[render_footer](classes/MainWP-Dashboard-MainWP-Settings.html#method_render_footer)  
[handle_settings_post](classes/MainWP-Dashboard-MainWP-Settings.html#method_handle_settings_post)  
[render](classes/MainWP-Dashboard-MainWP-Settings.html#method_render)  
[render_auto_updates_settings](classes/MainWP-Dashboard-MainWP-Settings.html#method_render_auto_updates_settings)  
[render_timezone_settings](classes/MainWP-Dashboard-MainWP-Settings.html#method_render_timezone_settings)  
[render_datetime_settings](classes/MainWP-Dashboard-MainWP-Settings.html#method_render_datetime_settings)  
[get_websites_automatic_update_time](classes/MainWP-Dashboard-MainWP-Settings.html#method_get_websites_automatic_update_time)  
[show_openssl_lib_config](classes/MainWP-Dashboard-MainWP-Settings.html#method_show_openssl_lib_config)  
[render_advanced](classes/MainWP-Dashboard-MainWP-Settings.html#method_render_advanced)  
[render_sync_data_selection](classes/MainWP-Dashboard-MainWP-Settings.html#method_render_sync_data_selection)  
[get_data_sync_default](classes/MainWP-Dashboard-MainWP-Settings.html#method_get_data_sync_default)  
[get_data_list_to_sync](classes/MainWP-Dashboard-MainWP-Settings.html#method_get_data_list_to_sync)  
[render_mainwp_tools](classes/MainWP-Dashboard-MainWP-Settings.html#method_render_mainwp_tools)  
[is_basic_auth_dashboard_enabled](classes/MainWP-Dashboard-MainWP-Settings.html#method_is_basic_auth_dashboard_enabled)  
[render_select_custom_themes](classes/MainWP-Dashboard-MainWP-Settings.html#method_render_select_custom_themes)  
[get_custom_themes_files](classes/MainWP-Dashboard-MainWP-Settings.html#method_get_custom_themes_files)  
[get_selected_theme](classes/MainWP-Dashboard-MainWP-Settings.html#method_get_selected_theme)  
[get_custom_theme_folder](classes/MainWP-Dashboard-MainWP-Settings.html#method_get_custom_theme_folder)  
[get_current_user_theme](classes/MainWP-Dashboard-MainWP-Settings.html#method_get_current_user_theme)  
[export_sites](classes/MainWP-Dashboard-MainWP-Settings.html#method_export_sites)  
[render_email_settings](classes/MainWP-Dashboard-MainWP-Settings.html#method_render_email_settings)  
[mainwp_help_content](classes/MainWP-Dashboard-MainWP-Settings.html#method_mainwp_help_content)  
[subPages](classes/MainWP-Dashboard-MainWP-Settings.html#property_subPages)  
_No public constants found_ _No protected methods found_ [instance](classes/MainWP-Dashboard-MainWP-Settings.html#property_instance)  
_No protected constants found_ _No private methods found_ _No private properties found_ _No private constants found_

File
     [ pages/page-mainwp-settings.php ](files/pages-page-mainwp-settings.md)
Package
...
Inherited from
    [\MainWP\Dashboard\MainWP_Settings](classes/MainWP-Dashboard-MainWP-Settings.md)
...
_Instantiate Hooks for the Settings Page._
...
_Instantiate the Settings Menu._
...
_Instantiate Settings SubPages Menu._
...
__
[code]
    handle_settings_post() : bool
[/code]

_Method handle_settings_post()._
...
_Render the MainWP Settings Page._
...
Uses
     ...
     [\MainWP\Dashboard\MainWP_Manage_Backups::render_settings()](classes/MainWP-Dashboard-MainWP-Manage-Backups.html#method_render_settings)
...
### render_auto_updates_settings()

__
[code]
    render_auto_updates_settings() : mixed
[/code]

_Method render_auto_updates_settings()._
...
__
[code]
    render_timezone_settings() : mixed
[/code]

_Render Timezone settings._
...
__
[code]
    render_datetime_settings() : mixed
[/code]

_Render Date/Time settings._
...
_Method get_websites_automatic_update_time()_
...
_Returns false or the location of the OpenSSL Lib File._
...
__
[code]
    render_advanced() : mixed
[/code]

_Render Advanced Options Subpage._
...
### render_sync_data_selection()

__
[code]
    render_sync_data_selection() : void
[/code]

_Method render_sync_data_selection()._
...
### get_data_sync_default()

__
[code]
    get_data_sync_default() : array
[/code]

_Method get_data_sync_default()._
...
### get_data_list_to_sync()

__
[code]
    get_data_list_to_sync() : array
[/code]

_Method get_data_list_to_sync()._
...
__
[code]
    render_mainwp_tools() : mixed
[/code]

_Render MainWP Tools SubPage._
...
Inherited from
    [\MainWP\Dashboard\MainWP_Settings](classes/MainWP-Dashboard-MainWP-Settings.md)
Uses
     [\MainWP\Dashboard\MainWP_UI::render_screen_options()](classes/MainWP-Dashboard-MainWP-UI.html#method_render_screen_options)
...
### is_basic_auth_dashboard_enabled()

__
[code]
    is_basic_auth_dashboard_enabled() : bool
[/code]

_Method is_basic_auth_dashboard_enabled._
...
__
[code]
    render_select_custom_themes() : mixed
[/code]

_Render MainWP themes selection._
...
__
[code]
    get_custom_themes_files() : mixed
[/code]

_Get custom themes files._
...
__
[code]
    get_selected_theme() : mixed
[/code]

_Get selected MainWP theme name._
...
__
[code]
    get_custom_theme_folder() : mixed
[/code]

_Get custom MainWP theme folder._
...
__
[code]
    get_current_user_theme() : mixed
[/code]

_Get current user 's selected theme._
...
_Export Child Sites and save as .csv file._
...
__
[code]
    render_email_settings() : mixed
[/code]

_Render MainWP Email Settings SubPage._
...
Uses
     ...
     [\MainWP\Dashboard\MainWP_Notification_Settings::render_edit_settings()](classes/MainWP-Dashboard-MainWP-Notification-Settings.html#method_render_edit_settings)
     [\MainWP\Dashboard\MainWP_Notification_Settings::emails_general_settings_handle()](classes/MainWP-Dashboard-MainWP-Notification-Settings.html#method_emails_general_settings_handle)
     [\MainWP\Dashboard\MainWP_Notification_Settings::render_all_settings()](classes/MainWP-Dashboard-MainWP-Notification-Settings.html#method_render_all_settings)
