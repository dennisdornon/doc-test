...
#  \MainWP\Dashboard MainWP_Backup_Handler

_Class MainWP_Backup_Handler_

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Backup-Handler.html#method_get_class_name)  
[backup_site](classes/MainWP-Dashboard-MainWP-Backup-Handler.html#method_backup_site)  
[backup_download_file](classes/MainWP-Dashboard-MainWP-Backup-Handler.html#method_backup_download_file)  
[backup_delete_file](classes/MainWP-Dashboard-MainWP-Backup-Handler.html#method_backup_delete_file)  
[backup_check_pid](classes/MainWP-Dashboard-MainWP-Backup-Handler.html#method_backup_check_pid)  
[backup](classes/MainWP-Dashboard-MainWP-Backup-Handler.html#method_backup)  
[normalize_filename](classes/MainWP-Dashboard-MainWP-Backup-Handler.html#method_normalize_filename)  
[is_archive](classes/MainWP-Dashboard-MainWP-Backup-Handler.html#method_is_archive)  
[is_sql_file](classes/MainWP-Dashboard-MainWP-Backup-Handler.html#method_is_sql_file)  
[is_sql_archive](classes/MainWP-Dashboard-MainWP-Backup-Handler.html#method_is_sql_archive)  
[get_current_archive_extension](classes/MainWP-Dashboard-MainWP-Backup-Handler.html#method_get_current_archive_extension)  
[get_real_extension](classes/MainWP-Dashboard-MainWP-Backup-Handler.html#method_get_real_extension)  
[handle_settings_post](classes/MainWP-Dashboard-MainWP-Backup-Handler.html#method_handle_settings_post)  
[backup_get_file_size](classes/MainWP-Dashboard-MainWP-Backup-Handler.html#method_backup_get_file_size)  
...
File
     [ class/class-mainwp-backup-handler.php ](files/class-class-mainwp-backup-handler.md)
Package
...
__
[code]
    backup_download_file(mixed  $pSiteId, mixed  $pType, mixed  $pUrl, mixed  $pFile) : bool
[/code]

_Method backup_download_file()_
...
__
[code]
    backup_delete_file(mixed  $pSiteId, mixed  $pFile) : bool
[/code]

_Method backup_delete_file()._
...
bool | $pArchiveFormat  | Archive format.  
bool | $pMaximumFileDescriptorsOverride  | Override maximum file descriptors.  
bool | $pMaximumFileDescriptorsAuto  | Auto maximum file descriptors.  
bool | $pMaximumFileDescriptors  | Maximum file descriptors.  
bool | $pLoadFilesBeforeZip  | Load files before zip.  
bool | $pid  | Backup pid.  
bool | $append  | Append to backup.  
...
_Method normalize_filename()_

Normalize filename.

#### Parameters

mixed | $s  | Filename to normalize.  
---|---|---  
...
_Method is_archive()_

Check if Archive.

#### Parameters

mixed | $pFileName  | File to check.  
---|---|---  
string | $pPrefix  | File prefix.  
string | $pSuffix  | File suffix.  
...
bool | $website  | true|false.  
---|---|---  
bool|string | $task  | true|false|global|site.  
...
_Method get_real_extension()_

Get full file extension.

#### Parameters

mixed | $path  | Path to file.  
---|---|---  
...
__
[code]
    backup_get_file_size(mixed  $pFile) : false|int
[/code]

_Method backup_get_file_size()_
...
### class-mainwp-backup-handler.php
[/code]
[code] 
#  __
