...
#  \MainWP\Dashboard MainWP_Recent_Pages

_Class MainWP_Recent_Pages_

Displays the Child Sites most recent published draft, pending, trash & future Pages.

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Recent-Pages.html#method_get_class_name)  
[render](classes/MainWP-Dashboard-MainWP-Recent-Pages.html#method_render)  
[render_sites](classes/MainWP-Dashboard-MainWP-Recent-Pages.html#method_render_sites)  
[render_top_grid](classes/MainWP-Dashboard-MainWP-Recent-Pages.html#method_render_top_grid)  
[render_published_posts](classes/MainWP-Dashboard-MainWP-Recent-Pages.html#method_render_published_posts)  
[render_draft_posts](classes/MainWP-Dashboard-MainWP-Recent-Pages.html#method_render_draft_posts)  
[render_pending_posts](classes/MainWP-Dashboard-MainWP-Recent-Pages.html#method_render_pending_posts)  
[render_future_posts](classes/MainWP-Dashboard-MainWP-Recent-Pages.html#method_render_future_posts)  
[render_trash_posts](classes/MainWP-Dashboard-MainWP-Recent-Pages.html#method_render_trash_posts)  
...
File
     [ widgets/widget-mainwp-recent-pages.php ](files/widgets-widget-mainwp-recent-pages.md)
Package
...
Inherited from
    [\MainWP\Dashboard\MainWP_Recent_Pages](classes/MainWP-Dashboard-MainWP-Recent-Pages.md)
...
_Render MainWP Recent Paged Widget Header_
...
__
[code]
    render_published_posts(array  $allPages, int  $recent_number, bool  $individual) : mixed
[/code]

_Render Published Pages._

#### Parameters

array | $allPages  | All pages data.  
---|---|---  
...
__
[code]
    render_draft_posts(array  $allPages, int  $recent_number, bool  $individual) : mixed
[/code]

_Render all draft pages._

#### Parameters

array | $allPages  | All pages data.  
---|---|---  
int | $recent_number  | Number of pages.  
bool | $individual  | Determins if it's individual site dashboard.  
...
__
[code]
    render_pending_posts(array  $allPages, int  $recent_number, bool  $individual) : mixed
[/code]

_Render all pending pages._
...
__
[code]
    render_future_posts(array  $allPages, int  $recent_number, bool  $individual) : mixed
[/code]

_Render all future pages._
...
__
[code]
    render_trash_posts(array  $allPages, int  $recent_number, bool  $individual) : mixed
[/code]

_Render all trashed pages._
...
### widget-mainwp-recent-pages.php
[/code]
[code] 
#  __
