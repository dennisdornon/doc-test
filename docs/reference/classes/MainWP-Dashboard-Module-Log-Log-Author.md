...
#  \MainWP\Dashboard\Module\Log Log_Author

_Class Log_Author._

## Summary

Methods Properties Constants [__construct](classes/MainWP-Dashboard-Module-Log-Log-Author.html#method___construct)  
[__get](classes/MainWP-Dashboard-Module-Log-Log-Author.html#method___get)  
[__toString](classes/MainWP-Dashboard-Module-Log-Log-Author.html#method___toString)  
[get_display_name](classes/MainWP-Dashboard-Module-Log-Log-Author.html#method_get_display_name)  
[get_agent](classes/MainWP-Dashboard-Module-Log-Log-Author.html#method_get_agent)  
[get_role](classes/MainWP-Dashboard-Module-Log-Log-Author.html#method_get_role)  
[is_deleted](classes/MainWP-Dashboard-Module-Log-Log-Author.html#method_is_deleted)  
[is_wp_cli](classes/MainWP-Dashboard-Module-Log-Log-Author.html#method_is_wp_cli)  
[is_doing_wp_cron](classes/MainWP-Dashboard-Module-Log-Log-Author.html#method_is_doing_wp_cron)  
[get_current_agent](classes/MainWP-Dashboard-Module-Log-Log-Author.html#method_get_current_agent)  
[get_agent_label](classes/MainWP-Dashboard-Module-Log-Log-Author.html#method_get_agent_label)  
[id](classes/MainWP-Dashboard-Module-Log-Log-Author.html#property_id)  
[meta](classes/MainWP-Dashboard-Module-Log-Log-Author.html#property_meta)  
_No public constants found_ _No protected methods found_ [user](classes/MainWP-Dashboard-Module-Log-Log-Author.html#property_user)  
_No protected constants found_ _No private methods found_ _No private properties found_ _No private constants found_

File
     [ modules/logs/classes/class-log-author.php ](files/modules-logs-classes-class-log-author.md)
Package
...
_Holds WP user object connected to "$this" instance._
...
__
[code]
    __construct(int  $user_id, array  $user_meta = array()) : mixed
[/code]
...
---|---|---  
array | $user_meta  | The user meta array.  
...
Inherited from
    [\MainWP\Dashboard\Module\Log\Log_Author](classes/MainWP-Dashboard-Module-Log-Log-Author.md)
...
_Get various user meta data_

#### Parameters

string | $name  | User meta key.  
---|---|---  
...
_Returns string representation of this object_
...
_Get the display name of the user_
...
_Tries to find a label for the record 's user_role._
...
_True if user no longer exists, otherwise false_
...
_True if user is WP-CLI, otherwise false_
...
__
[code]
    is_doing_wp_cron() : bool
[/code]

_Check if the current request is part of a WP cron task._
...
_Look at the environment to detect if an agent is being used_
...
_Get the agent label_

#### Parameters

string | $agent  | Key representing agent.  
---|---|---  
