...
Methods Properties Constants _No public methods found_ _No public properties found_ [MAP](classes/phpseclib3-File-ASN1-Maps-DSAParams.html#constant_MAP)  
...
File
     [ libs/phpseclib/vendor/phpseclib/phpseclib/phpseclib/File/ASN1/Maps/DSAParams.php ](files/libs-phpseclib-vendor-phpseclib-phpseclib-phpseclib-file-asn1-maps-dsaparams.md)
Package
...
### MAP
[code] 
    MAP = ['type' => \phpseclib3\File\ASN1::TYPE_SEQUENCE, 'children' => ['p' => ['type' => \phpseclib3\File\ASN1::TYPE_INTEGER], 'q' => ['type' => \phpseclib3\File\ASN1::TYPE_INTEGER], 'g' => ['type' => \phpseclib3\File\ASN1::TYPE_INTEGER]]]
[/code]
