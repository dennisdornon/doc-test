...
[Keys](namespaces/phpseclib3-crypt-ec-formats-keys.md) __

#  \phpseclib3\Crypt\EC\Formats\Keys PuTTY

_PuTTY Formatted EC Key Handler_

## Summary

Methods Properties Constants [load](classes/phpseclib3-Crypt-Common-Formats-Keys-PuTTY.html#method_load)  
[savePrivateKey](classes/phpseclib3-Crypt-EC-Formats-Keys-PuTTY.html#method_savePrivateKey)  
[savePublicKey](classes/phpseclib3-Crypt-EC-Formats-Keys-PuTTY.html#method_savePublicKey)  
[setComment](classes/phpseclib3-Crypt-Common-Formats-Keys-PuTTY.html#method_setComment)  
[setVersion](classes/phpseclib3-Crypt-Common-Formats-Keys-PuTTY.html#method_setVersion)  
[setImplicitCurve](classes/phpseclib3-Crypt-EC-Formats-Keys-Common.html#method_setImplicitCurve)  
[extractPoint](classes/phpseclib3-Crypt-EC-Formats-Keys-Common.html#method_extractPoint)  
[useSpecifiedCurve](classes/phpseclib3-Crypt-EC-Formats-Keys-Common.html#method_useSpecifiedCurve)  
[useNamedCurve](classes/phpseclib3-Crypt-EC-Formats-Keys-Common.html#method_useNamedCurve)  
_No public properties found_ [PUBLIC_HANDLER](classes/phpseclib3-Crypt-EC-Formats-Keys-PuTTY.html#constant_PUBLIC_HANDLER)  
...
File
     [ libs/phpseclib/vendor/phpseclib/phpseclib/phpseclib/Crypt/EC/Formats/Keys/PuTTY.php ](files/libs-phpseclib-vendor-phpseclib-phpseclib-phpseclib-crypt-ec-formats-keys-putty.md)
Package
...
### PUBLIC_HANDLER
[code] 
    PUBLIC_HANDLER = 'phpseclib3\Crypt\EC\Formats\Keys\OpenSSH' : string
[/code]
...
__
[code]
    savePrivateKey(\phpseclib3\Math\BigInteger  $privateKey, \phpseclib3\Crypt\EC\BaseCurves\Base  $curve, \phpseclib3\Math\Common\FiniteField\Integer[]  $publicKey, string  $secret = null, string  $password = false, array  $options = []) : string
[/code]
...
\phpseclib3\Math\Common\FiniteField\Integer[] | $publicKey  |   
...
Inherited from
    [\phpseclib3\Crypt\EC\Formats\Keys\PuTTY](classes/phpseclib3-Crypt-EC-Formats-Keys-PuTTY.md)
...
__
[code]
    savePublicKey(\phpseclib3\Crypt\EC\BaseCurves\Base  $curve, \phpseclib3\Math\Common\FiniteField[]  $publicKey) : string
[/code]

_Convert an EC public key to the appropriate format_

#### Parameters

\phpseclib3\Crypt\EC\BaseCurves\Base | $curve  |   
---|---|---  
\phpseclib3\Math\Common\FiniteField[] | $publicKey  |   
...
__
[code]
    setImplicitCurve(\phpseclib3\Crypt\EC\BaseCurves\Base  $curve) : mixed
[/code]

_Explicitly set the curve_
...
__
[code]
    extractPoint(string  $str, \phpseclib3\Crypt\EC\BaseCurves\Base  $curve) : object[]
[/code]

_Extract points from a string_
...
__
[code]
    wrapPrivateKey(string  $public, string  $private, string  $type, string  $password, array  $options = []) : string
[/code]
...
_Returns an instance of \phpseclib3\Crypt\EC\BaseCurves\Base based on the curve parameters_
...
Documentation is powered by [phpDocumentor ](https://www.phpdoc.org/) and authored on March 11th, 2025 at 16:58. 
  ...
  *[PuTTY]: \phpseclib3\Crypt\Common\Formats\Keys\PuTTY
  ...
  *[Keys]: \phpseclib3\Crypt\EC\Formats\Keys
