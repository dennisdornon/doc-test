...
#  \MainWP\Dashboard MainWP_Connect

_Class MainWP_Connect_

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Connect.html#method_get_class_name)  
[try_visit](classes/MainWP-Dashboard-MainWP-Connect.html#method_try_visit)  
[validate_ip](classes/MainWP-Dashboard-MainWP-Connect.html#method_validate_ip)  
[check_ignored_http_code](classes/MainWP-Dashboard-MainWP-Connect.html#method_check_ignored_http_code)  
[check_website_status](classes/MainWP-Dashboard-MainWP-Connect.html#method_check_website_status)  
[get_post_data_authed](classes/MainWP-Dashboard-MainWP-Connect.html#method_get_post_data_authed)  
[get_get_data_authed](classes/MainWP-Dashboard-MainWP-Connect.html#method_get_get_data_authed)  
[connect_sign](classes/MainWP-Dashboard-MainWP-Connect.html#method_connect_sign)  
[get_post_data_not_authed](classes/MainWP-Dashboard-MainWP-Connect.html#method_get_post_data_not_authed)  
[fetch_urls_authed](classes/MainWP-Dashboard-MainWP-Connect.html#method_fetch_urls_authed)  
[get_resource_id](classes/MainWP-Dashboard-MainWP-Connect.html#method_get_resource_id)  
[get_lock_identifier](classes/MainWP-Dashboard-MainWP-Connect.html#method_get_lock_identifier)  
[lock](classes/MainWP-Dashboard-MainWP-Connect.html#method_lock)  
[release](classes/MainWP-Dashboard-MainWP-Connect.html#method_release)  
[fetch_url_authed](classes/MainWP-Dashboard-MainWP-Connect.html#method_fetch_url_authed)  
[fetch_url_not_authed](classes/MainWP-Dashboard-MainWP-Connect.html#method_fetch_url_not_authed)  
[fetch_url](classes/MainWP-Dashboard-MainWP-Connect.html#method_fetch_url)  
[fetch_url_site](classes/MainWP-Dashboard-MainWP-Connect.html#method_fetch_url_site)  
[download_to_file](classes/MainWP-Dashboard-MainWP-Connect.html#method_download_to_file)  
[init_cookiesdir](classes/MainWP-Dashboard-MainWP-Connect.html#method_init_cookiesdir)  
[get_file_content](classes/MainWP-Dashboard-MainWP-Connect.html#method_get_file_content)  
[get_favico_url](classes/MainWP-Dashboard-MainWP-Connect.html#method_get_favico_url)  
_No public properties found_ _No public constants found_ [get_expect_header](classes/MainWP-Dashboard-MainWP-Connect.html#method_get_expect_header)  
_No protected properties found_ _No protected constants found_ [get_renew_post_data_authed](classes/MainWP-Dashboard-MainWP-Connect.html#method_get_renew_post_data_authed)  
[check_constraints](classes/MainWP-Dashboard-MainWP-Connect.html#method_check_constraints)  
[check_constraints_last_request](classes/MainWP-Dashboard-MainWP-Connect.html#method_check_constraints_last_request)  
[check_constraints_open_requests](classes/MainWP-Dashboard-MainWP-Connect.html#method_check_constraints_open_requests)  
_No private properties found_ _No private constants found_

File
     [ class/class-mainwp-connect.php ](files/class-class-mainwp-connect.md)
Package
...
__
[code]
    try_visit(string  $url, bool  $ssl_verifyhost = null, string  $http_user = null, string  $http_pass = null, int  $sslVersion = 0, bool  $forceUseIPv4 = null, bool  $no_body = false) : array
[/code]
...
---|---|---  
bool | $ssl_verifyhost  | Option to check SSL Certificate. Default = null.  
string | $http_user  | HTTPAuth Username. Default = null.  
string | $http_pass  | HTTPAuth Password. Default = null.  
int | $sslVersion  | Child Site SSL Version.  
bool | $forceUseIPv4  | Option to force IP4. Default = null.  
bool | $no_body  | Option to set CURLOPT_NOBODY option. Default = false.  
...
mixed | $value  | http error code.  
---|---|---  
object|false | $website  | website.  
...
__
[code]
    check_website_status(object  $website) : mixed
[/code]

_Method check website status._

Check if the Website returns and http errors.

#### Parameters

object | $website  | Child Site information.  
---|---|---  
...
bool | $asArray  | true|false Default is false.  
...
__
[code]
    connect_sign(string  $data, string  $signature, string  $privkey, mixed  $algorithm, int  $site_id) : bool
[/code]

_Method connect_sign()_
...
__
[code]
    get_resource_id(mixed  $res) : mixed
[/code]

_Method get_resource_id()_

Get resource id.

#### Parameters

mixed | $res  | The given resource.  
---|---|---  
...
_Method get_lock_identifier()._

Get lock identifier.

#### Parameters

mixed | $pLockName  | Provided Lock Name.  
---|---|---  
...
null | $params  | Function parameters.  
bool | $checkConstraints  | Whether or not to check constraints.  
bool | $pForceFetch  | Whether or not to force the fetch.  
bool | $pRetryFailed  | Whether or not to retry the fetch process.  
...
__
[code]
    fetch_url_not_authed(string  $url, string  $admin, string  $what, null  $params = null, bool  $pForceFetch = false, null  $verifyCertificate = null, null  $http_user = null, null  $http_pass = null, int  $sslVersion = 0, array  $others = array(), array  $output = array()) : mixed
[/code]
...
__
[code]
    fetch_url(object  $website, string  $url, mixed  $postdata, bool  $checkConstraints = false, null  $verifyCertificate = null, bool  $pRetryFailed = true, null  $http_user = null, null  $http_pass = null, int  $sslVersion = 0, array  $others = array(), array  $output = array()) : mixed
[/code]
...
bool | $checkConstraints  | true|false Whether or not to check constraints.  
null | $verifyCertificate  | Verify SSL Certificate.  
bool | $pRetryFailed  | ture|false Whether or not the Retry has failed.  
null | $http_user  | htaccess username.  
null | $http_pass  | htaccess password.  
...
__
[code]
    fetch_url_site(object  $website, string  $url, mixed  $postdata, bool  $checkConstraints = false, null  $verifyCertificate = null, null  $http_user = null, null  $http_pass = null, int  $sslVersion = 0, array  $others = array(), array  $output = array()) : mixed
[/code]
...
_Method get_file_content()_

Get contents of file.

#### Parameters

mixed | $url  | File Location.  
---|---|---  
...
_Credits WordPress org._

Get the correct "Expect" header for the given request data.

#### Parameters

string|array | $data  | Data to send either as the POST body, or as parameters in the URL for a GET/HEAD.  
---|---|---  
...
_Method get_renew_post_data_authed()_
...
__
[code]
    check_constraints(mixed  $identifier, mixed  $website) : mixed
[/code]

_Method check_constraints()_

Check connection delay constraints.

#### Parameters

mixed | $identifier  | Lock identifier.  
---|---|---  
mixed | $website  | Object child site.  
...
---|---|---  
int | $minimumDelay  | minimum delay.  
...
mixed | $identifier  | connect identifier.  
---|---|---  
int | $maximumRequests  | maximum requests.  
string|null | $ip  | ip address.  
