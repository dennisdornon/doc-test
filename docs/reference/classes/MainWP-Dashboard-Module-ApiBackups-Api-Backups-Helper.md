...
#  \MainWP\Dashboard\Module\ApiBackups Api_Backups_Helper

_Class Api_Backups_Utility_

## Summary

Methods Properties Constants [get_instance](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Helper.html#method_get_instance)  
[__construct](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Helper.html#method___construct)  
[clean_url](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Helper.html#method_clean_url)  
[get_website_by_id](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Helper.html#method_get_website_by_id)  
[update_website_option](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Helper.html#method_update_website_option)  
[get_website_options](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Helper.html#method_get_website_options)  
[fetch_object](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Helper.html#method_fetch_object)  
[free_result](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Helper.html#method_free_result)  
[security_nonce](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Helper.html#method_security_nonce)  
[instance](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Helper.html#property_instance)  
...
File
     [ modules/api-backups/classes/class-api-backups-helper.php ](files/modules-api-backups-classes-class-api-backups-helper.md)
Package
...
Inherited from
    [\MainWP\Dashboard\Module\ApiBackups\Api_Backups_Helper](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-Helper.md)
...
__
[code]
    update_website_option(object|int  $website, string  $opt_name, string  $opt_value) : mixed
[/code]

_Method update_website_option()._

Update the website option.

#### Parameters

object|int | $website  | website object or ID.  
---|---|---  
string | $opt_name  | website.  
string | $opt_value  | website.  
...
__
[code]
    get_website_options(object|int  $website, string|array  $options) : mixed
[/code]

_Method get_website_options()._
...
object|int | $website  | website object or ID.  
---|---|---  
string|array | $options  | Options name.  
...
mixed | $websites  | websites results.  
---|---|---  
...
mixed | $results  | websites results.  
---|---|---  
...
__
[code]
    security_nonce(string  $action) : mixed
[/code]

_Method security_nonce()._
