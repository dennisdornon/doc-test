...
_Class responsible for loading the REST API and all REST API namespaces._

## Summary

Methods Properties Constants [instance](classes/MainWP-Rest-Server.html#method_instance)  
[init](classes/MainWP-Rest-Server.html#method_init)  
[register_rest_routes](classes/MainWP-Rest-Server.html#method_register_rest_routes)  
[get_rest_controller](classes/MainWP-Rest-Server.html#method_get_rest_controller)  
[get_path](classes/MainWP-Rest-Server.html#method_get_path)  
_No public properties found_ _No public constants found_ [get_rest_namespaces](classes/MainWP-Rest-Server.html#method_get_rest_namespaces)  
[get_v2_controllers](classes/MainWP-Rest-Server.html#method_get_v2_controllers)  
[controllers](classes/MainWP-Rest-Server.html#property_controllers)  
_No protected constants found_ _No private methods found_ [instance](classes/MainWP-Rest-Server.html#property_instance)  
_No private constants found_

File
     [ includes/rest-api/class-mainwp-rest-server.php ](files/includes-rest-api-class-mainwp-rest-server.md)
Package
...
_REST API namespaces and endpoints._
...
_Hook into WordPress ready to init the REST API as needed._
...
__
[code]
    get_rest_controller(string  $nspace, string  $name) : mixed
[/code]

_Get registered routes controller._
...
_Return the path to the package._
...
__
[code]
    get_rest_namespaces() : array
[/code]

_Get API namespaces - new namespaces should be registered here._
...
__
[code]
    get_v2_controllers() : array
[/code]

_List of controllers in the wc/v2 namespace._
