...
[Functions](namespaces/phpseclib3-common-functions.md) __
...
Methods Properties Constants [shift](classes/phpseclib3-Common-Functions-Strings.html#method_shift)  
[pop](classes/phpseclib3-Common-Functions-Strings.html#method_pop)  
[unpackSSH2](classes/phpseclib3-Common-Functions-Strings.html#method_unpackSSH2)  
[packSSH2](classes/phpseclib3-Common-Functions-Strings.html#method_packSSH2)  
[bits2bin](classes/phpseclib3-Common-Functions-Strings.html#method_bits2bin)  
[bin2bits](classes/phpseclib3-Common-Functions-Strings.html#method_bin2bits)  
[switchEndianness](classes/phpseclib3-Common-Functions-Strings.html#method_switchEndianness)  
[increment_str](classes/phpseclib3-Common-Functions-Strings.html#method_increment_str)  
[is_stringable](classes/phpseclib3-Common-Functions-Strings.html#method_is_stringable)  
[base64_decode](classes/phpseclib3-Common-Functions-Strings.html#method_base64_decode)  
[base64url_decode](classes/phpseclib3-Common-Functions-Strings.html#method_base64url_decode)  
[base64_encode](classes/phpseclib3-Common-Functions-Strings.html#method_base64_encode)  
[base64url_encode](classes/phpseclib3-Common-Functions-Strings.html#method_base64url_encode)  
[hex2bin](classes/phpseclib3-Common-Functions-Strings.html#method_hex2bin)  
[bin2hex](classes/phpseclib3-Common-Functions-Strings.html#method_bin2hex)  
_No public properties found_ _No public constants found_ _No protected methods found_ _No protected properties found_ _No protected constants found_ [formatPack](classes/phpseclib3-Common-Functions-Strings.html#method_formatPack)  
_No private properties found_ _No private constants found_

abstract

File
     [ libs/phpseclib/vendor/phpseclib/phpseclib/phpseclib/Common/Functions/Strings.php ](files/libs-phpseclib-vendor-phpseclib-phpseclib-phpseclib-common-functions-strings.md)
Package
...
__
[code]
    shift(string  $string, int  $index = 1) : string
[/code]
...
Inherited from
    [\phpseclib3\Common\Functions\Strings](classes/phpseclib3-Common-Functions-Strings.md)
...
__
[code]
    pop(string  $string, int  $index = 1) : string
[/code]
...
__
[code]
    packSSH2(string  $format, string|int|float|array|bool  ...$elements) : string
[/code]

_Create SSH2-style string_

#### Parameters

string | $format  |   
---|---|---  
string|int|float|array|bool | $elements variadic |   
...
_Convert binary data into bits_
...
_Increment the current string_
...
_Find whether the type of a variable is string (or could be converted to one)_
...
_Constant Time Base64-decoding_
...
_Constant Time Base64-decoding (URL safe)_
...
_Constant Time Base64-encoding_
...
_Constant Time Base64-encoding (URL safe)_
