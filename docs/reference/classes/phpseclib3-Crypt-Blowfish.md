...
[bcrypt_pbkdf](classes/phpseclib3-Crypt-Blowfish.html#method_bcrypt_pbkdf)  
...
[setupInlineCrypt](classes/phpseclib3-Crypt-Blowfish.html#method_setupInlineCrypt)  
...
[key_length](classes/phpseclib3-Crypt-Blowfish.html#property_key_length)  
...
_No protected constants found_ [bcrypt_hash](classes/phpseclib3-Crypt-Blowfish.html#method_bcrypt_hash)  
[expand0state](classes/phpseclib3-Crypt-Blowfish.html#method_expand0state)  
[expandstate](classes/phpseclib3-Crypt-Blowfish.html#method_expandstate)  
[encryptBlockHelperFast](classes/phpseclib3-Crypt-Blowfish.html#method_encryptBlockHelperFast)  
[encryptBlockHelperSlow](classes/phpseclib3-Crypt-Blowfish.html#method_encryptBlockHelperSlow)  
...
[sbox0](classes/phpseclib3-Crypt-Blowfish.html#property_sbox0)  
[sbox1](classes/phpseclib3-Crypt-Blowfish.html#property_sbox1)  
[sbox2](classes/phpseclib3-Crypt-Blowfish.html#property_sbox2)  
[sbox3](classes/phpseclib3-Crypt-Blowfish.html#property_sbox3)  
[parray](classes/phpseclib3-Crypt-Blowfish.html#property_parray)  
[bctx](classes/phpseclib3-Crypt-Blowfish.html#property_bctx)  
[kl](classes/phpseclib3-Crypt-Blowfish.html#property_kl)  
...
File
     [ libs/phpseclib/vendor/phpseclib/phpseclib/phpseclib/Crypt/Blowfish.php ](files/libs-phpseclib-vendor-phpseclib-phpseclib-phpseclib-crypt-blowfish.md)
Package
...
_The Key Length (in bytes) {@internal The max value is 256 / 8 = 32, the min value is 128 / 8 = 16. Exists in conjunction with $Nk because the encryption / decryption / key schedule creation requires this number and not $key_length. We could derive this from $key_length or vice versa, but that 'd mean we'd have to do multiple shift operations, so in lieu of that, we'll just precompute it once.}_
...
_The fixed subkeys boxes ($sbox0 - $sbox3) with 256 entries each_
...
_P-Array consists of 18 32-bit subkeys_
...
__
[code]
    bcrypt_pbkdf(string  $pass, string  $salt, int  $keylen, int  $rounds) : string
[/code]

_Performs OpenSSH-style bcrypt_
...
Inherited from
    [\phpseclib3\Crypt\Blowfish](classes/phpseclib3-Crypt-Blowfish.md)
...
__
[code]
    expand0state(int[]  $key, int[]  $sbox0, int[]  $sbox1, int[]  $sbox2, int[]  $sbox3, int[]  $p) : mixed
[/code]

_Key expansion without salt_
...
Inherited from
    [\phpseclib3\Crypt\Blowfish](classes/phpseclib3-Crypt-Blowfish.md)
See also
    [](\\phpseclib3\\Crypt\\self::_bcrypt_hash\(\))
...
__
[code]
    expandstate(int[]  $data, int[]  $key, int[]  $sbox0, int[]  $sbox1, int[]  $sbox2, int[]  $sbox3, int[]  $p) : mixed
[/code]

_Key expansion with salt_
...
__
[code]
    encryptBlockHelperFast(int  $x0, int  $x1, int[]  $sbox0, int[]  $sbox1, int[]  $sbox2, int[]  $sbox3, int[]  $p) : int[]
[/code]

_Fast helper function for block encryption_
...
__
[code]
    encryptBlockHelperSlow(int  $x0, int  $x1, int[]  $sbox0, int[]  $sbox1, int[]  $sbox2, int[]  $sbox3, int[]  $p) : int[]
[/code]

_Slow helper function for block encryption_
