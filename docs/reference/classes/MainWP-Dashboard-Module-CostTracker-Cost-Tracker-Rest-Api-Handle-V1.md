...
#  \MainWP\Dashboard\Module\CostTracker Cost_Tracker_Rest_Api_Handle_V1

_Class Cost_Tracker_Rest_Api_Handle_V1_

## Summary

Methods Properties Constants [instance](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Rest-Api-Handle-V1.html#method_instance)  
[valid_api_request_data_by](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Rest-Api-Handle-V1.html#method_valid_api_request_data_by)  
[prepare_api_costs_data](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Rest-Api-Handle-V1.html#method_prepare_api_costs_data)  
[get_cost_field_value](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Rest-Api-Handle-V1.html#method_get_cost_field_value)  
_No public properties found_ _No public constants found_ _No protected methods found_ _No protected properties found_ _No protected constants found_ _No private methods found_ [instance](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Rest-Api-Handle-V1.html#property_instance)  
_No private constants found_

File
     [ modules/cost-tracker/rest-api/version1/class-cost-tracker-rest-api-handle-v1.php ](files/modules-cost-tracker-rest-api-version1-class-cost-tracker-rest-api-handle-v1.md)
Package
...
Inherited from
    [\MainWP\Dashboard\Module\CostTracker\Cost_Tracker_Rest_Api_Handle_V1](classes/MainWP-Dashboard-Module-CostTracker-Cost-Tracker-Rest-Api-Handle-V1.md)
...
### valid_api_request_data_by()

__
[code]
    valid_api_request_data_by(string  $by, string  $value) : mixed
[/code]

_Method valid_api_request_data_by()_
...
### prepare_api_costs_data()

__
[code]
    prepare_api_costs_data(array  $costs) : mixed
[/code]

_Method prepare_api_costs_data()_
...
### get_cost_field_value()

__
[code]
    get_cost_field_value(object  $cost, string  $field) : string
[/code]

_Method get_cost_field_value()._

#### Parameters

object | $cost  | Object containing the cost data.  
---|---|---  
string | $field  | Data cost field.  
...
### class-cost-tracker-rest-api-handle-v1.php
[/code]
[code] 
#  __
