...
Methods Properties Constants _No public methods found_ _No public properties found_ [MAP](classes/phpseclib3-File-ASN1-Maps-Time.html#constant_MAP)  
...
File
     [ libs/phpseclib/vendor/phpseclib/phpseclib/phpseclib/File/ASN1/Maps/Time.php ](files/libs-phpseclib-vendor-phpseclib-phpseclib-phpseclib-file-asn1-maps-time.md)
Package
...
### MAP
[code] 
    MAP = ['type' => \phpseclib3\File\ASN1::TYPE_CHOICE, 'children' => ['utcTime' => ['type' => \phpseclib3\File\ASN1::TYPE_UTC_TIME], 'generalTime' => ['type' => \phpseclib3\File\ASN1::TYPE_GENERALIZED_TIME]]]
[/code]
