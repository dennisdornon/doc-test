...
#  \MainWP\Dashboard\Module\Log Log_Graph_Status_Widget

_Class Log_Graph_Status_Widget_

Displays the Logs info.

## Summary

Methods Properties Constants [instance](classes/MainWP-Dashboard-Module-Log-Log-Graph-Status-Widget.html#method_instance)  
[get_class_name](classes/MainWP-Dashboard-Module-Log-Log-Graph-Status-Widget.html#method_get_class_name)  
[render](classes/MainWP-Dashboard-Module-Log-Log-Graph-Status-Widget.html#method_render)  
[render_widget](classes/MainWP-Dashboard-Module-Log-Log-Graph-Status-Widget.html#method_render_widget)  
[render_widget_content](classes/MainWP-Dashboard-Module-Log-Log-Graph-Status-Widget.html#method_render_widget_content)  
_No public properties found_ _No public constants found_ _No protected methods found_ [instance](classes/MainWP-Dashboard-Module-Log-Log-Graph-Status-Widget.html#property_instance)  
_No protected constants found_ _No private methods found_ _No private properties found_ _No private constants found_

File
     [ modules/logs/widgets/widget-log-graph-status-widget.php ](files/modules-logs-widgets-widget-log-graph-status-widget.md)
Package
...
Inherited from
    [\MainWP\Dashboard\Module\Log\Log_Graph_Status_Widget](classes/MainWP-Dashboard-Module-Log-Log-Graph-Status-Widget.md)
...
### widget-log-graph-status-widget.php
[/code]
[code] 
#  __
