...
#  \MainWP\Dashboard MainWP_Recent_Posts

_Class MainWP_Recent_Posts_

Displays the Child Sites most recent published draft, pending, trash & future posts.

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Recent-Posts.html#method_get_class_name)  
[render](classes/MainWP-Dashboard-MainWP-Recent-Posts.html#method_render)  
[render_sites](classes/MainWP-Dashboard-MainWP-Recent-Posts.html#method_render_sites)  
[render_top_grid](classes/MainWP-Dashboard-MainWP-Recent-Posts.html#method_render_top_grid)  
[render_published_posts](classes/MainWP-Dashboard-MainWP-Recent-Posts.html#method_render_published_posts)  
[render_draft_posts](classes/MainWP-Dashboard-MainWP-Recent-Posts.html#method_render_draft_posts)  
[render_pending_posts](classes/MainWP-Dashboard-MainWP-Recent-Posts.html#method_render_pending_posts)  
[render_future_posts](classes/MainWP-Dashboard-MainWP-Recent-Posts.html#method_render_future_posts)  
[render_trash_posts](classes/MainWP-Dashboard-MainWP-Recent-Posts.html#method_render_trash_posts)  
[publish](classes/MainWP-Dashboard-MainWP-Recent-Posts.html#method_publish)  
[approve](classes/MainWP-Dashboard-MainWP-Recent-Posts.html#method_approve)  
[unpublish](classes/MainWP-Dashboard-MainWP-Recent-Posts.html#method_unpublish)  
[trash](classes/MainWP-Dashboard-MainWP-Recent-Posts.html#method_trash)  
[delete](classes/MainWP-Dashboard-MainWP-Recent-Posts.html#method_delete)  
[restore](classes/MainWP-Dashboard-MainWP-Recent-Posts.html#method_restore)  
[action](classes/MainWP-Dashboard-MainWP-Recent-Posts.html#method_action)  
...
File
     [ widgets/widget-mainwp-recent-posts.php ](files/widgets-widget-mainwp-recent-posts.md)
Package
...
__
[code]
    render_top_grid() : mixed
[/code]

_Render MainWP Recent Posts Widget Header_
...
### render_published_posts()

__
[code]
    render_published_posts(array  $allPosts, int  $recent_number, bool  $individual) : mixed
[/code]

_Render Published Posts._

#### Parameters

array | $allPosts  | All posts data.  
---|---|---  
int | $recent_number  | Number of posts.  
bool | $individual  | Determins if it's individual site dashboard.  
...
__
[code]
    render_draft_posts(array  $allPosts, int  $recent_number, bool  $individual) : mixed
[/code]

_Render all draft posts._
...
### render_pending_posts()

__
[code]
    render_pending_posts(array  $allPosts, int  $recent_number, bool  $individual) : mixed
[/code]

_Render all pending posts._
...
__
[code]
    render_future_posts(array  $allPosts, int  $recent_number, bool  $individual) : mixed
[/code]

_Render all future posts._
...
__
[code]
    render_trash_posts(array  $allPosts, int  $recent_number, bool  $individual) : mixed
[/code]

_Render all trashed posts._
...
__
[code]
    action(string  $pAction, string  $type = 'post') : mixed
[/code]
...
### widget-mainwp-recent-posts.php
[/code]
[code] 
#  __
