...
[SSH](namespaces/phpseclib3-system-ssh.md) __

#  \phpseclib3\System\SSH Agent

_Pure-PHP ssh-agent client identity factory_

requestIdentities() method pumps out \phpseclib3\System\SSH\Agent\Identity objects

## Summary

Methods Properties Constants [__construct](classes/phpseclib3-System-SSH-Agent.html#method___construct)  
[requestIdentities](classes/phpseclib3-System-SSH-Agent.html#method_requestIdentities)  
[startSSHForwarding](classes/phpseclib3-System-SSH-Agent.html#method_startSSHForwarding)  
[registerChannelOpen](classes/phpseclib3-System-SSH-Agent.html#method_registerChannelOpen)  
[forwardData](classes/phpseclib3-System-SSH-Agent.html#method_forwardData)  
[readBytes](classes/phpseclib3-System-SSH-Common-Traits-ReadBytes.html#method_readBytes)  
_No public properties found_ [SSH_AGENTC_REQUEST_IDENTITIES](classes/phpseclib3-System-SSH-Agent.html#constant_SSH_AGENTC_REQUEST_IDENTITIES)  
[SSH_AGENT_IDENTITIES_ANSWER](classes/phpseclib3-System-SSH-Agent.html#constant_SSH_AGENT_IDENTITIES_ANSWER)  
[SSH_AGENTC_SIGN_REQUEST](classes/phpseclib3-System-SSH-Agent.html#constant_SSH_AGENTC_SIGN_REQUEST)  
[SSH_AGENT_SIGN_RESPONSE](classes/phpseclib3-System-SSH-Agent.html#constant_SSH_AGENT_SIGN_RESPONSE)  
[FORWARD_NONE](classes/phpseclib3-System-SSH-Agent.html#constant_FORWARD_NONE)  
[FORWARD_REQUEST](classes/phpseclib3-System-SSH-Agent.html#constant_FORWARD_REQUEST)  
[FORWARD_ACTIVE](classes/phpseclib3-System-SSH-Agent.html#constant_FORWARD_ACTIVE)  
[SSH_AGENT_FAILURE](classes/phpseclib3-System-SSH-Agent.html#constant_SSH_AGENT_FAILURE)  
_No protected methods found_ _No protected properties found_ _No protected constants found_ [request_forwarding](classes/phpseclib3-System-SSH-Agent.html#method_request_forwarding)  
[fsock](classes/phpseclib3-System-SSH-Agent.html#property_fsock)  
[forward_status](classes/phpseclib3-System-SSH-Agent.html#property_forward_status)  
[socket_buffer](classes/phpseclib3-System-SSH-Agent.html#property_socket_buffer)  
[expected_bytes](classes/phpseclib3-System-SSH-Agent.html#property_expected_bytes)  
_No private constants found_

File
     [ libs/phpseclib/vendor/phpseclib/phpseclib/phpseclib/System/SSH/Agent.php ](files/libs-phpseclib-vendor-phpseclib-phpseclib-phpseclib-system-ssh-agent.md)
Package
...
_Buffer for accumulating forwarded authentication agent data arriving on SSH data channel destined for agent unix socket_
...
_Tracking the number of bytes we are expecting to arrive for the agent socket on the SSH data channel_
...
__
[code]
    __construct(mixed  $address = \phpseclib3\System\SSH\null) : \phpseclib3\System\SSH\Agent
[/code]
...
Inherited from
    [\phpseclib3\System\SSH\Agent](classes/phpseclib3-System-SSH-Agent.md)
...
_Signal that agent forwarding should be requested when a channel is opened_
...
__
[code]
    registerChannelOpen(\phpseclib3\Net\SSH2  $ssh) : mixed
[/code]

_On successful channel open_
...
_Forward data to SSH Agent and return data reply_
...
__
[code]
    request_forwarding(\phpseclib3\Net\SSH2  $ssh) : bool
[/code]
