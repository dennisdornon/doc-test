...
#  \MainWP\Dashboard MainWP_Updates_Helper

_Class MainWP_Updates_Helper_

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Updates-Helper.html#method_get_class_name)  
[instance](classes/MainWP-Dashboard-MainWP-Updates-Helper.html#method_instance)  
[get_roll_items_updates_of_site](classes/MainWP-Dashboard-MainWP-Updates-Helper.html#method_get_roll_items_updates_of_site)  
[get_roll_msg](classes/MainWP-Dashboard-MainWP-Updates-Helper.html#method_get_roll_msg)  
[get_roll_icon](classes/MainWP-Dashboard-MainWP-Updates-Helper.html#method_get_roll_icon)  
[get_roll_update_plugintheme_items](classes/MainWP-Dashboard-MainWP-Updates-Helper.html#method_get_roll_update_plugintheme_items)  
_No public properties found_ _No public constants found_ _No protected methods found_ _No protected properties found_ _No protected constants found_ _No private methods found_ [instance](classes/MainWP-Dashboard-MainWP-Updates-Helper.html#property_instance)  
_No private constants found_

File
     [ class/class-mainwp-updates-helper.php ](files/class-class-mainwp-updates-helper.md)
Package
...
Inherited from
    [\MainWP\Dashboard\MainWP_Updates_Helper](classes/MainWP-Dashboard-MainWP-Updates-Helper.md)
...
__
[code]
    instance() : \MainWP\Dashboard\MainWP_Updates_Helper
[/code]
...
### get_roll_items_updates_of_site()

__
[code]
    get_roll_items_updates_of_site(object  $website) : array
[/code]

_Method get_roll_items_updates_of_site()_
...
array | $item  | update item.  
---|---|---  
bool | $with_icon  | get msg with icon.  
string | $msg_type  | default|notice.  
...
string | $ttip  | tooltip text.  
---|---|---  
bool | $icon_only  | get icon only.  
...
### get_roll_update_plugintheme_items()

__
[code]
    get_roll_update_plugintheme_items(string  $item_type, array  $roll_data) : array
[/code]

_Method get_roll_update_plugintheme_items()._

#### Parameters

string | $item_type  | plugin|theme.  
---|---|---  
array | $roll_data  | roll update data.  
...
### class-mainwp-updates-helper.php
[/code]
[code] 
#  __
