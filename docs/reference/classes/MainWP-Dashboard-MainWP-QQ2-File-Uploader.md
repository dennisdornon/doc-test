...
_Class MainWP_QQ2_File_Uploader_

## Summary

Methods Properties Constants [__construct](classes/MainWP-Dashboard-MainWP-QQ2-File-Uploader.html#method___construct)  
[handle_upload](classes/MainWP-Dashboard-MainWP-QQ2-File-Uploader.html#method_handle_upload)  
[handleUpload](classes/MainWP-Dashboard-MainWP-QQ2-File-Uploader.html#method_handleUpload)  
_No public properties found_ _No public constants found_ _No protected methods found_ _No protected properties found_ _No protected constants found_ [to_bytes](classes/MainWP-Dashboard-MainWP-QQ2-File-Uploader.html#method_to_bytes)  
[allowedExtensions](classes/MainWP-Dashboard-MainWP-QQ2-File-Uploader.html#property_allowedExtensions)  
[sizeLimit](classes/MainWP-Dashboard-MainWP-QQ2-File-Uploader.html#property_sizeLimit)  
[file](classes/MainWP-Dashboard-MainWP-QQ2-File-Uploader.html#property_file)  
_No private constants found_

File
     [ class/class-mainwp-qq2-file-uploader.php ](files/class-class-mainwp-qq2-file-uploader.md)
Package
...
_Private variable to hold allowed file extensions._

#### Type

array<string|int, mixed> — Allowed extension. 
...
_Private variable to hold allowed file size._
...
_Private variable to hold the file to upload._
...
__
[code]
    __construct(array  $allowedExtensions = array(), int  $sizeLimit = 8388608) : mixed
[/code]

_MainWP_QQ2_File_Uploader constructor._

Run each time the class is called.

#### Parameters

array | $allowedExtensions  | Array of allowed Extensions.  
---|---|---  
int | $sizeLimit  | Maximum allowed file size.  
...
---|---|---  
bool | $replaceOldFile  | True|False Weather or not to replace the orignal file or not.  
...
__
[code]
    to_bytes(int  $str) : int
[/code]

_Convert file size into bytes._

#### Parameters

int | $str  | Original File.  
---|---|---  
...
### class-mainwp-qq2-file-uploader.php
[/code]
[code] 
#  __
