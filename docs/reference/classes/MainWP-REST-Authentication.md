...
#  \ MainWP_REST_Authentication

_REST API authentication class._

## Summary

Methods Properties Constants [get_instance](classes/MainWP-REST-Authentication.html#method_get_instance)  
[init](classes/MainWP-REST-Authentication.html#method_init)  
[__construct](classes/MainWP-REST-Authentication.html#method___construct)  
[authenticate](classes/MainWP-REST-Authentication.html#method_authenticate)  
[authentication_fallback](classes/MainWP-REST-Authentication.html#method_authentication_fallback)  
[check_authentication_error](classes/MainWP-REST-Authentication.html#method_check_authentication_error)  
[parse_header](classes/MainWP-REST-Authentication.html#method_parse_header)  
[parse_auth_header](classes/MainWP-REST-Authentication.html#method_parse_auth_header)  
[get_authorization_header](classes/MainWP-REST-Authentication.html#method_get_authorization_header)  
[get_oauth_parameters](classes/MainWP-REST-Authentication.html#method_get_oauth_parameters)  
[send_unauthorized_headers](classes/MainWP-REST-Authentication.html#method_send_unauthorized_headers)  
[check_user_permissions](classes/MainWP-REST-Authentication.html#method_check_user_permissions)  
[get_rest_valid_user](classes/MainWP-REST-Authentication.html#method_get_rest_valid_user)  
[is_valid_permissions](classes/MainWP-REST-Authentication.html#method_is_valid_permissions)  
[instance](classes/MainWP-REST-Authentication.html#property_instance)  
_No public constants found_ [is_request_to_rest_api](classes/MainWP-REST-Authentication.html#method_is_request_to_rest_api)  
[set_error](classes/MainWP-REST-Authentication.html#method_set_error)  
[get_error](classes/MainWP-REST-Authentication.html#method_get_error)  
[error](classes/MainWP-REST-Authentication.html#property_error)  
[user](classes/MainWP-REST-Authentication.html#property_user)  
[auth_method](classes/MainWP-REST-Authentication.html#property_auth_method)  
_No protected constants found_ [perform_basic_authentication](classes/MainWP-REST-Authentication.html#method_perform_basic_authentication)  
[perform_oauth_authentication](classes/MainWP-REST-Authentication.html#method_perform_oauth_authentication)  
[perform_basic_token_authentication](classes/MainWP-REST-Authentication.html#method_perform_basic_token_authentication)  
[get_oauth_token_parameters](classes/MainWP-REST-Authentication.html#method_get_oauth_token_parameters)  
[check_oauth_signature](classes/MainWP-REST-Authentication.html#method_check_oauth_signature)  
[join_with_equals_sign](classes/MainWP-REST-Authentication.html#method_join_with_equals_sign)  
[normalize_parameters](classes/MainWP-REST-Authentication.html#method_normalize_parameters)  
[check_oauth_timestamp_and_nonce](classes/MainWP-REST-Authentication.html#method_check_oauth_timestamp_and_nonce)  
[get_user_data_by_consumer_key](classes/MainWP-REST-Authentication.html#method_get_user_data_by_consumer_key)  
[check_permissions](classes/MainWP-REST-Authentication.html#method_check_permissions)  
[update_last_access](classes/MainWP-REST-Authentication.html#method_update_last_access)  
_No private properties found_ _No private constants found_

File
     [ includes/rest-api/class-mainwp-rest-authentication.php ](files/includes-rest-api-class-mainwp-rest-authentication.md)
Package
...
_Initialize authentication actions._
...
_Authenticate the user if authentication wasn 't performed during the determine_current_user action._

Necessary in cases where wp_get_current_user() is called before the plugin is loaded.

#### Parameters

\WP_Error|null|bool | $error  | Error data.  
---|---|---  
...
_Check for authentication error._
...
__
[code]
    parse_header(string  $header) : array
[/code]

_Parse the Authorization header into parameters._

#### Parameters

string | $header  | Authorization header value (not including "Authorization: " prefix).  
---|---|---  
...
__
[code]
    parse_auth_header(string  $header) : array
[/code]
...
_Get the authorization header._
...
__
[code]
    get_oauth_parameters() : array|\WP_Error
[/code]

_Get oAuth parameters from $_GET, $_POST or request header._
...
_If the consumer_key and consumer_secret $_GET parameters are NOT provided and the Basic auth headers are either not present or the consumer secret does not match the consumer key provided, then return the correct Basic headers and an error message._
...
_Check for user permissions and register last access._

#### Parameters

mixed | $result  | Response to replace the requested version with.  
---|---|---  
...
__
[code]
    get_rest_valid_user() : mixed|object
[/code]

_Method get_rest_valid_user()._
...
__
[code]
    is_valid_permissions(\WP_REST_Request  $request) : mixed
[/code]

_Valid REST permissions._
...
_Check if is request to our REST API._
...
_Set authentication error._

#### Parameters

\WP_Error | $error  | Authentication error data.  
---|---|---  
...
_Perform OAuth 1.0a "one-legged" (http://oauthbible.com/#oauth-10a-one-legged) authentication for non-SSL requests._
...
Inherited from
    [\MainWP_REST_Authentication](classes/MainWP-REST-Authentication.md)
See also
    [for the full spec.](http://tools.ietf.org/html/rfc5849)
...
### perform_basic_token_authentication()

__
[code]
    perform_basic_token_authentication() : int|bool
[/code]
...
__
[code]
    get_oauth_token_parameters() : array|\WP_Error
[/code]
...
__
[code]
    check_oauth_signature(\stdClass  $user, array  $params) : true|\WP_Error
[/code]

_Verify that the consumer-provided request signature matches our generated signature, this ensures the consumer has a valid key/secret._

#### Parameters

\stdClass | $user  | User data.  
---|---|---  
...
__
[code]
    join_with_equals_sign(array  $params, array  $query_params = array(), string  $key = '') : string
[/code]

_Creates an array of urlencoded strings out of each array key/value pairs._

#### Parameters

array | $params  | Array of parameters to convert.  
---|---|---  
array | $query_params  | Array to extend.  
string | $key  | Optional Array key to append.  
...
_Normalize each parameter by assuming each parameter may have already been encoded, so attempt to decode, and then re-encode according to RFC 3986._
...
array | $parameters  | Un-normalized parameters.  
---|---|---  
...
_Verify that the timestamp and nonce provided with the request are valid. This prevents replay attacks where an attacker could attempt to re-send an intercepted request at a later time._
...
\stdClass | $user  | User data.  
---|---|---  
int | $timestamp  | The unix timestamp for when the request was made.  
string | $nonce  | A unique (for the given user) 32 alphanumeric string, consumer-generated.  
...
__
[code]
    get_user_data_by_consumer_key(string  $consumer_key) : mixed
[/code]
...
_Check that the API keys provided have the proper key-specific permissions to either read or write API resources._
...
__
[code]
    update_last_access() : mixed
[/code]

_Updated API Key last access datetime._
...
### class-mainwp-rest-authentication.php
[/code]
[code] 
#  __
