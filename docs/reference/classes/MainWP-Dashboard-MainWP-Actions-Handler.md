...
#  \MainWP\Dashboard MainWP_Actions_Handler

_Class MainWP_Actions_Handler_

## Summary

Methods Properties Constants [instance](classes/MainWP-Dashboard-MainWP-Actions-Handler.html#method_instance)  
[do_action_mainwp_post_action](classes/MainWP-Dashboard-MainWP-Actions-Handler.html#method_do_action_mainwp_post_action)  
[do_action_mainwp_install_actions](classes/MainWP-Dashboard-MainWP-Actions-Handler.html#method_do_action_mainwp_install_actions)  
[hook_mainwp_fetch_url_authed](classes/MainWP-Dashboard-MainWP-Actions-Handler.html#method_hook_mainwp_fetch_url_authed)  
_No public properties found_ _No public constants found_ _No protected methods found_ _No protected properties found_ _No protected constants found_ _No private methods found_ [instance](classes/MainWP-Dashboard-MainWP-Actions-Handler.html#property_instance)  
_No private constants found_

File
     [ class/class-mainwp-actions-handler.php ](files/class-class-mainwp-actions-handler.md)
Package
...
Inherited from
    [\MainWP\Dashboard\MainWP_Actions_Handler](classes/MainWP-Dashboard-MainWP-Actions-Handler.md)
...
__
[code]
    do_action_mainwp_post_action(object  $website, string  $pAction, array  $information, int|false  $postId, string  $type = '') : mixed
[/code]

_Action mainwp_post_action._
...
bool | $upload  | true|false: install by upload (option).  
...
__
[code]
    hook_mainwp_fetch_url_authed(object  $website, array  $information, string  $action, array  $params, array  $others) : mixed
[/code]

_Handle @action mainwp_fetch_url_authed._
...
### class-mainwp-actions-handler.php
[/code]
[code] 
#  __
