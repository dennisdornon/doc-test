...
#  \MainWP\Dashboard MainWP_Uptime_Monitoring_Handle

_Class MainWP_Uptime_Monitoring_Handle_

## Summary

Methods Properties Constants [instance](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Handle.html#method_instance)  
[__construct](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Handle.html#method___construct)  
[admin_init](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Handle.html#method_admin_init)  
[get_default_monitoring_settings](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Handle.html#method_get_default_monitoring_settings)  
[get_global_monitoring_settings](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Handle.html#method_get_global_monitoring_settings)  
[update_uptime_global_settings](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Handle.html#method_update_uptime_global_settings)  
[ajax_remove_monitor](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Handle.html#method_ajax_remove_monitor)  
[ajax_check_uptime](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Handle.html#method_ajax_check_uptime)  
[get_site_response_time_chart_data](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Handle.html#method_get_site_response_time_chart_data)  
[hook_get_reports_data](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Handle.html#method_hook_get_reports_data)  
[handle_update_website_legacy_uptime_status](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Handle.html#method_handle_update_website_legacy_uptime_status)  
[check_website_uptime_monitoring_status](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Handle.html#method_check_website_uptime_monitoring_status)  
[calc_and_save_site_uptime_stat_hourly_data](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Handle.html#method_calc_and_save_site_uptime_stat_hourly_data)  
[get_hourly_key_by_timestamp](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Handle.html#method_get_hourly_key_by_timestamp)  
[clear_outdated_hourly_uptime_stats](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Handle.html#method_clear_outdated_hourly_uptime_stats)  
[update_process_monitor_notification](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Handle.html#method_update_process_monitor_notification)  
_No public properties found_ _No public constants found_ _No protected methods found_ [instance](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Handle.html#property_instance)  
_No protected constants found_ _No private methods found_ _No private properties found_ _No private constants found_

File
     [ class/class-mainwp-uptime-monitoring-handle.php ](files/class-class-mainwp-uptime-monitoring-handle.md)
Package
...
__
[code]
    get_default_monitoring_settings(bool  $individual) : array
[/code]

_Method get_default_monitoring_settings_

#### Parameters

bool | $individual  | individual.  
---|---|---  
...
__
[code]
    get_global_monitoring_settings() : array
[/code]

_Method get_global_monitoring_settings._
...
__
[code]
    update_uptime_global_settings(array  $settings) : void
[/code]

_Method update_uptime_global_settings_
...
__
[code]
    ajax_remove_monitor() : void
[/code]

_Method ajax_remove_monitor_
...
__
[code]
    ajax_check_uptime() : mixed
[/code]

_Method ajax_check_uptime()_
...
### get_site_response_time_chart_data()

__
[code]
    get_site_response_time_chart_data(int  $site_id, array  $params = array()) : array
[/code]

_Get site response time chart data_
...
---|---|---  
mixed | $start_date  | Y-m-d.  
mixed | $end_date  | Y-m-d.  
array | $params  | params.  
...
### handle_update_website_legacy_uptime_status()

__
[code]
    handle_update_website_legacy_uptime_status(object  $website, array  $params) : mixed
[/code]

_Handle update website legacy HTTP status._
...
### check_website_uptime_monitoring_status()

__
[code]
    check_website_uptime_monitoring_status(object  $monitor, array  $params = array()) : mixed
[/code]

_Method to compatible with check_website_status()_

Check if the Website returns and http errors.

#### Parameters

object | $monitor  | Child Site monitor.  
---|---|---  
array | $params  | Params.  
...
__
[code]
    calc_and_save_site_uptime_stat_hourly_data(mixed  $monitor_id, mixed  $ping_data) : void
[/code]

_Method calc_and_save_site_uptime_stat_hourly_data_

#### Parameters

mixed | $monitor_id  | monitor id.  
---|---|---  
mixed | $ping_data  | ping data.  
...
__
[code]
    get_hourly_key_by_timestamp(int  $timestamp) : int
[/code]

_Method get_hourly_key_by_timestamp_
...
__
[code]
    clear_outdated_hourly_uptime_stats() : void
[/code]

_Method clear_outdated_hourly_uptime_stats_
...
### update_process_monitor_notification()

__
[code]
    update_process_monitor_notification(int  $monitor_id, int  $check_time) : void
[/code]

_Update monitor notification process._

#### Parameters

int | $monitor_id  | monitor id.  
---|---|---  
int | $check_time  | monitor time.  
...
### class-mainwp-uptime-monitoring-handle.php
[/code]
[code] 
#  __
