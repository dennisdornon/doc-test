...
Methods Properties Constants _No public methods found_ _No public properties found_ [MAP](classes/phpseclib3-File-ASN1-Maps-PrivateDomainName.html#constant_MAP)  
...
File
     [ libs/phpseclib/vendor/phpseclib/phpseclib/phpseclib/File/ASN1/Maps/PrivateDomainName.php ](files/libs-phpseclib-vendor-phpseclib-phpseclib-phpseclib-file-asn1-maps-privatedomainname.md)
Package
...
### MAP
[code] 
    MAP = ['type' => \phpseclib3\File\ASN1::TYPE_CHOICE, 'children' => ['numeric' => ['type' => \phpseclib3\File\ASN1::TYPE_NUMERIC_STRING], 'printable' => ['type' => \phpseclib3\File\ASN1::TYPE_PRINTABLE_STRING]]]
[/code]
