...
#  \MainWP\Dashboard MainWP_Plugins_Install_List_Table

_Class MainWP_Plugins_Install_List_Table_

## Summary

Methods Properties Constants [ajax_user_can](classes/MainWP-Dashboard-MainWP-Plugins-Install-List-Table.html#method_ajax_user_can)  
[prepare_items](classes/MainWP-Dashboard-MainWP-Plugins-Install-List-Table.html#method_prepare_items)  
[no_items](classes/MainWP-Dashboard-MainWP-Plugins-Install-List-Table.html#method_no_items)  
[display](classes/MainWP-Dashboard-MainWP-Plugins-Install-List-Table.html#method_display)  
[get_columns](classes/MainWP-Dashboard-MainWP-Plugins-Install-List-Table.html#method_get_columns)  
[display_rows](classes/MainWP-Dashboard-MainWP-Plugins-Install-List-Table.html#method_display_rows)  
[order](classes/MainWP-Dashboard-MainWP-Plugins-Install-List-Table.html#property_order)  
[orderby](classes/MainWP-Dashboard-MainWP-Plugins-Install-List-Table.html#property_orderby)  
[groups](classes/MainWP-Dashboard-MainWP-Plugins-Install-List-Table.html#property_groups)  
_No public constants found_ [display_tablenav](classes/MainWP-Dashboard-MainWP-Plugins-Install-List-Table.html#method_display_tablenav)  
[pagination](classes/MainWP-Dashboard-MainWP-Plugins-Install-List-Table.html#method_pagination)  
_No protected properties found_ _No protected constants found_ [order_callback](classes/MainWP-Dashboard-MainWP-Plugins-Install-List-Table.html#method_order_callback)  
[error](classes/MainWP-Dashboard-MainWP-Plugins-Install-List-Table.html#property_error)  
_No private constants found_

File
     [ class/class-mainwp-plugins-install-list-table.php ](files/class-class-mainwp-plugins-install-list-table.md)
Package
...
global  |  array $tabs string $tab int $paged string $type string $term string $wp_version  
---|---  
...
_Method display_tablenav()_

Displays the table Navigation.

#### Parameters

mixed | $which  | Position information.  
---|---|---  
...
__
[code]
    pagination(mixed  $which) : mixed
[/code]

_Method pagination()_
...
__
[code]
    order_callback(object  $plugin_a, object  $plugin_b) : int
[/code]

_Method order_callback()_

#### Parameters

object | $plugin_a  | Plugin A.  
---|---|---  
object | $plugin_b  | Plugin B.  
...
### class-mainwp-plugins-install-list-table.php
[/code]
[code] 
#  __
