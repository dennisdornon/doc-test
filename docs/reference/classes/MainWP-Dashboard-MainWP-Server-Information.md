...
#  \MainWP\Dashboard MainWP_Server_Information

_Class MainWP_Server_Information_

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_get_class_name)  
[init_menu](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_init_menu)  
[init_subpages_menu](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_init_subpages_menu)  
[init_left_menu](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_init_left_menu)  
[render_header](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render_header)  
[render_footer](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render_footer)  
[render_actions_bar](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render_actions_bar)  
[render](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render)  
[render_wordpress_check_tbody](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render_wordpress_check_tbody)  
[render_php_check_tbody](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render_php_check_tbody)  
[render_mysql_check_tbody](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render_mysql_check_tbody)  
[render_server_check_tbody](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render_server_check_tbody)  
[render_dashboard_check_tbody](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render_dashboard_check_tbody)  
[render_extensions_license_check_tbody](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render_extensions_license_check_tbody)  
[render_plugins_check_tbody](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render_plugins_check_tbody)  
[render_quick_setup_system_check](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render_quick_setup_system_check)  
[get_mainwp_version_check](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_get_mainwp_version_check)  
[render_cron](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render_cron)  
[get_schedule_auto_update_label](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_get_schedule_auto_update_label)  
[get_schedule_next_time_to_show](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_get_schedule_next_time_to_show)  
[check_directory_mainwp_directory](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_check_directory_mainwp_directory)  
[render_directory_row](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render_directory_row)  
[render_row](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render_row)  
[render_row_with_description](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render_row_with_description)  
[get_file_system_method_check](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_get_file_system_method_check)  
[render_error_log_page](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render_error_log_page)  
[render_error_log](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render_error_log)  
[render_wp_config](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render_wp_config)  
[render_action_logs](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render_action_logs)  
[render_plugin_privacy_page](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render_plugin_privacy_page)  
[render_htaccess](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_render_htaccess)  
[php_disabled_functions](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_php_disabled_functions)  
[display_mainwp_options](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_display_mainwp_options)  
[subPages](classes/MainWP-Dashboard-MainWP-Server-Information.html#property_subPages)  
[WARNING](classes/MainWP-Dashboard-MainWP-Server-Information.html#constant_WARNING)  
[ERROR](classes/MainWP-Dashboard-MainWP-Server-Information.html#constant_ERROR)  
_No protected methods found_ _No protected properties found_ _No protected constants found_ [get_warning_html](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_get_warning_html)  
[get_pass_html](classes/MainWP-Dashboard-MainWP-Server-Information.html#method_get_pass_html)  
_No private properties found_ _No private constants found_

File
     [ pages/page-mainwp-server-information.php ](files/pages-page-mainwp-server-information.md)
Package
...
_Initiates Server Information left menu._
...
_Renders Server Information footer._
...
_Renders Server Information action bar element._
...
_Renders Server Information page._
...
_Renders WordPress checks table body._
...
_Renders PHP checks table body._
...
_Renders MySQL checks table body._
...
_Renders Server checks table body._
...
_Renders MainWP Dashboard checks table body._
...
_Renders extensions API License status table body._
...
_Renders plugins check table body._
...
_Renders MainWP system requirements check._
...
_Compares the detected MainWP Dashboard version agains the verion in WP.org._

#### Returns

mixed —

Pass|static::get_warning_html().
...
_Renders the Cron Schedule page._
...
__
[code]
    get_schedule_auto_update_label(int  $freq) : string
[/code]

_Get frequency auto update to show._

#### Parameters

int | $freq  | frequency of auto update.  
---|---|---  
...
__
[code]
    get_schedule_next_time_to_show(string  $job_freq, int  $lasttime_run, int  $local_timestamp) : int
[/code]

_Get next time of schedule job to show._

#### Parameters

string | $job_freq  | frequency of schedule job.  
---|---|---  
int | $lasttime_run  | Lasttime to run.  
int | $local_timestamp  | current local time.  
...
__
[code]
    check_directory_mainwp_directory() : bool
[/code]

_Checks if the ../wp-content/uploads/mainwp/ directory is writable._
...
__
[code]
    render_directory_row(string  $name, string  $check, string  $result, bool  $passed) : bool
[/code]

_Renders the directory check row._
...
bool | $passed  | true|false check result.  
...
int | $errorType  | global variable static::WARNING = 1.  
...
_Checks if file system method is direct._

#### Returns

mixed —

html|static::get_warning_html().
...
__
[code]
    render_error_log_page() : mixed
[/code]

_Renders Error Log page._
...
__
[code]
    render_action_logs() : mixed
[/code]

_Renders action logs page._
...
_Renders the Plugin Privacy page._
...
_Checks for disable PHP Functions._
...
_Renders MainWP Settings 'Options'._
...
### page-mainwp-server-information.php
[/code]
[code] 
#  __
