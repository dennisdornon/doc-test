...
#  \MainWP\Dashboard\Module\Log Log_DB_Driver_WPDB

_Class Log_DB_Driver_WPDB_

## Summary

Methods Properties Constants [__construct](classes/MainWP-Dashboard-Module-Log-Log-DB-Driver-WPDB.html#method___construct)  
[insert_record](classes/MainWP-Dashboard-Module-Log-Log-DB-Driver-WPDB.html#method_insert_record)  
[insert_meta](classes/MainWP-Dashboard-Module-Log-Log-DB-Driver-WPDB.html#method_insert_meta)  
[get_records](classes/MainWP-Dashboard-Module-Log-Log-DB-Driver-WPDB.html#method_get_records)  
[get_column_values](classes/MainWP-Dashboard-Module-Log-Log-DB-Driver-WPDB.html#method_get_column_values)  
[get_table_names](classes/MainWP-Dashboard-Module-Log-Log-DB-Driver-WPDB.html#method_get_table_names)  
[purge_storage](classes/MainWP-Dashboard-Module-Log-Log-DB-Driver-WPDB.html#method_purge_storage)  
[table](classes/MainWP-Dashboard-Module-Log-Log-DB-Driver-WPDB.html#property_table)  
[table_meta](classes/MainWP-Dashboard-Module-Log-Log-DB-Driver-WPDB.html#property_table_meta)  
[table_wp](classes/MainWP-Dashboard-Module-Log-Log-DB-Driver-WPDB.html#property_table_wp)  
_No public constants found_ _No protected methods found_ [query](classes/MainWP-Dashboard-Module-Log-Log-DB-Driver-WPDB.html#property_query)  
_No protected constants found_ _No private methods found_ _No private properties found_ _No private constants found_

File
     [ modules/logs/classes/class-log-db-driver-wpdb.php ](files/modules-logs-classes-class-log-db-driver-wpdb.md)
Package
...
Implements
     [ \MainWP\Dashboard\Module\Log\Log_DB_Driver ](classes/MainWP-Dashboard-Module-Log-Log-DB-Driver.md)
...
__
[code]
    insert_meta(int  $record_id, string  $key, string  $val) : array
[/code]

_Insert record meta_
...
_Returns array of existing values for requested column._
...
__
[code]
    purge_storage(\MainWP\Dashboard\Module\Log\Log_Manager  $manager) : mixed
[/code]
