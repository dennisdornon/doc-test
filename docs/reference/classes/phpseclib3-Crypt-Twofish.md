...
Inherited from
    [\phpseclib3\Crypt\Twofish](classes/phpseclib3-Crypt-Twofish.md)
See also
    [](\\phpseclib3\\Crypt\\Common\\SymmetricKey::_setupInlineCrypt\(\))
...
__
[code]
    mdsrem(string  $A, string  $B) : array
[/code]

__mdsrem function using by the twofish cipher algorithm_
