...
_Class MainWP_Exception_

## Summary

Methods Properties Constants [__construct](classes/MainWP-Dashboard-MainWP-Exception.html#method___construct)  
[get_message_extra](classes/MainWP-Dashboard-MainWP-Exception.html#method_get_message_extra)  
[get_message_error_code](classes/MainWP-Dashboard-MainWP-Exception.html#method_get_message_error_code)  
[set_data](classes/MainWP-Dashboard-MainWP-Exception.html#method_set_data)  
[get_data](classes/MainWP-Dashboard-MainWP-Exception.html#method_get_data)  
_No public properties found_ _No public constants found_ _No protected methods found_ [messageExtra](classes/MainWP-Dashboard-MainWP-Exception.html#property_messageExtra)  
[errorCode](classes/MainWP-Dashboard-MainWP-Exception.html#property_errorCode)  
[data](classes/MainWP-Dashboard-MainWP-Exception.html#property_data)  
_No protected constants found_ _No private methods found_ _No private properties found_ _No private constants found_

File
     [ class/class-mainwp-exception.php ](files/class-class-mainwp-exception.md)
Package
...
_Protected variable to hold the extra messages._
...
_Protected variable to hold the Error Code._
...
_Protected variable to hold the extra data._
...
mixed | $message  | Exception message.  
---|---|---  
null | $extra  | Any extra Errors.  
string | $errCode  | Errors code.  
...
bool | $escape_msg  | Exception message.  
---|---|---  
...
__
[code]
    get_message_error_code() : string
[/code]

_Method get_message_error_code()_
