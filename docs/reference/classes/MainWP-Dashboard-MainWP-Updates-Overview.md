...
#  \MainWP\Dashboard MainWP_Updates_Overview

_Class MainWP_Updates_Overview_

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Updates-Overview.html#method_get_class_name)  
[init](classes/MainWP-Dashboard-MainWP-Updates-Overview.html#method_init)  
[plugins_api](classes/MainWP-Dashboard-MainWP-Updates-Overview.html#method_plugins_api)  
[get_name](classes/MainWP-Dashboard-MainWP-Updates-Overview.html#method_get_name)  
[render](classes/MainWP-Dashboard-MainWP-Updates-Overview.html#method_render)  
[render_sites](classes/MainWP-Dashboard-MainWP-Updates-Overview.html#method_render_sites)  
[render_updates_overview_widget_header](classes/MainWP-Dashboard-MainWP-Updates-Overview.html#method_render_updates_overview_widget_header)  
[render_updates_overview_widget_footer](classes/MainWP-Dashboard-MainWP-Updates-Overview.html#method_render_updates_overview_widget_footer)  
[render_total_update](classes/MainWP-Dashboard-MainWP-Updates-Overview.html#method_render_total_update)  
[render_wordpress_update](classes/MainWP-Dashboard-MainWP-Updates-Overview.html#method_render_wordpress_update)  
[render_plugins_update](classes/MainWP-Dashboard-MainWP-Updates-Overview.html#method_render_plugins_update)  
[render_themes_update](classes/MainWP-Dashboard-MainWP-Updates-Overview.html#method_render_themes_update)  
[render_language_update](classes/MainWP-Dashboard-MainWP-Updates-Overview.html#method_render_language_update)  
[render_abandoned_plugins](classes/MainWP-Dashboard-MainWP-Updates-Overview.html#method_render_abandoned_plugins)  
[render_abandoned_themes](classes/MainWP-Dashboard-MainWP-Updates-Overview.html#method_render_abandoned_themes)  
[render_global_update](classes/MainWP-Dashboard-MainWP-Updates-Overview.html#method_render_global_update)  
[render_bottom](classes/MainWP-Dashboard-MainWP-Updates-Overview.html#method_render_bottom)  
[dismiss_sync_errors](classes/MainWP-Dashboard-MainWP-Updates-Overview.html#method_dismiss_sync_errors)  
[check_backups](classes/MainWP-Dashboard-MainWP-Updates-Overview.html#method_check_backups)  
...
File
     [ widgets/widget-mainwp-updates-overview.php ](files/widgets-widget-mainwp-updates-overview.md)
Package
...
_Method plugins_api()_

Grab Child Sites update status & build widget.

#### Parameters

mixed | $default_value  | Default.  
---|---|---  
mixed | $action  | Action.  
mixed | $args  | Slug.  
...
### render_updates_overview_widget_header()

__
[code]
    render_updates_overview_widget_header(string  $lastSyncMsg) : mixed
[/code]

_Renders Updates Overview widget header._
...
### render_updates_overview_widget_footer()

__
[code]
    render_updates_overview_widget_footer() : mixed
[/code]

_Renders Updates Overview widget footer._
...
__
[code]
    render_total_update(int  $total_upgrades, bool  $can_total_update, int  $limit_updates_all, int  $count_websites, int  $count_plugins, int  $count_themes) : mixed
[/code]

_Render total update._

#### Parameters

int | $total_upgrades  | number of update.  
---|---|---  
bool | $can_total_update  | permission to update all.  
int | $limit_updates_all  | limit number of update per request, 0 is no limit.  
int | $count_websites  | count websites.  
int | $count_plugins  | count plugins.  
int | $count_themes  | count themes.  
...
__
[code]
    render_wordpress_update(bool  $user_can_update_wordpress, int  $total_wp_upgrades, bool  $globalView, int  $current_wpid, int  $count_websites) : mixed
[/code]

_Renders WordPress update details._

#### Parameters

bool | $user_can_update_wordpress  | Permission to update WordPress.  
---|---|---  
int | $total_wp_upgrades  | Total number of WordPress update.  
bool | $globalView  | Global view or not.  
int | $current_wpid  | Current site ID.  
int | $count_websites  | Number of sites.  
...
__
[code]
    render_plugins_update(bool  $user_can_update_plugins, int  $total_plugin_upgrades, bool  $globalView, int  $current_wpid, int  $count_plugins) : mixed
[/code]

_Renders Plugins update detail._

#### Parameters

bool | $user_can_update_plugins  | permission to update.  
---|---|---  
int | $total_plugin_upgrades  | total number of update.  
bool | $globalView  | global view or not.  
int | $current_wpid  | current site id.  
int | $count_plugins  | count plugin.  
...
__
[code]
    render_themes_update(bool  $user_can_update_themes, int  $total_theme_upgrades, bool  $globalView, int  $current_wpid, int  $count_themes) : mixed
[/code]

_Render Themes update detail._

#### Parameters

bool | $user_can_update_themes  | permission to update.  
---|---|---  
int | $total_theme_upgrades  | total number of update.  
bool | $globalView  | global view or not.  
int | $current_wpid  | current site id.  
int | $count_themes  | count themes.  
...
__
[code]
    render_language_update(bool  $user_can_update_translation, int  $total_translation_upgrades, bool  $globalView, int  $current_wpid) : mixed
[/code]

_Render language update details._

#### Parameters

bool | $user_can_update_translation  | Permission to update.  
---|---|---  
int | $total_translation_upgrades  | Total number of update.  
bool | $globalView  | Global view or not.  
int | $current_wpid  | Current site id.  
...
__
[code]
    render_abandoned_plugins(int  $total_plugins_outdate, bool  $globalView, int  $current_wpid, int  $count_plugins) : mixed
[/code]

_Renders abandoned plugins detail._

#### Parameters

int | $total_plugins_outdate  | total number of update.  
---|---|---  
bool | $globalView  | global view or not.  
int | $current_wpid  | current site id.  
int | $count_plugins  | count plugins.  
...
__
[code]
    render_abandoned_themes(int  $total_themes_outdate, bool  $globalView, int  $current_wpid, int  $count_themes) : mixed
[/code]

_Renders abandoned themes detail._

#### Parameters

int | $total_themes_outdate  | Total number of update.  
---|---|---  
bool | $globalView  | global View or not.  
int | $current_wpid  | Current site ID.  
int | $count_themes  | count themes.  
...
__
[code]
    render_global_update(bool  $user_can_update_wordpress, int  $total_wp_upgrades, array  $all_wp_updates, bool  $user_can_update_plugins, int  $total_plugin_upgrades, array  $all_plugins_updates, bool  $user_can_update_themes, int  $total_theme_upgrades, mixed  $all_themes_updates, mixed  $mainwp_show_language_updates, bool  $user_can_update_translation, int  $total_translation_upgrades, mixed  $all_translations_updates) : mixed
[/code]

_Method render_global_update()_
...
bool | $user_can_update_wordpress  | Permission to update WordPress.  
---|---|---  
int | $total_wp_upgrades  | Total WordPress update.  
array | $all_wp_updates  | All WordPress update list.  
bool | $user_can_update_plugins  | permission to update plugings.  
int | $total_plugin_upgrades  | total WordPress update.  
array | $all_plugins_updates  | all WordPress update list.  
bool | $user_can_update_themes  | permission to update themes.  
int | $total_theme_upgrades  | total themes update.  
mixed | $all_themes_updates  | all themes update list.  
mixed | $mainwp_show_language_updates  | MainWP Language Updates.  
bool | $user_can_update_translation  | permission to update languages.  
int | $total_translation_upgrades  | total WordPress update.  
...
__
[code]
    render_bottom(object  $websites, bool  $globalView) : mixed
[/code]

_Render bottom of widget._

#### Parameters

object | $websites  | Object containing child sites info.  
---|---|---  
bool | $globalView  | Whether it's global or individual site view.  
...
### widget-mainwp-updates-overview.php
[/code]
[code] 
#  __
