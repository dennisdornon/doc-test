...
#  \MainWP\Dashboard MainWP_DB_Backup

_Class MainWP_DB_Backup_

## Summary

Methods Properties Constants [instance](classes/MainWP-Dashboard-MainWP-DB.html#method_instance)  
[get_website_backup_settings](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_get_website_backup_settings)  
[update_backup_task_progress](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_update_backup_task_progress)  
[add_backup_task_progress](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_add_backup_task_progress)  
[get_backup_task_progress](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_get_backup_task_progress)  
[backup_full_task_running](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_backup_full_task_running)  
[remove_backup_task](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_remove_backup_task)  
[get_backup_task_by_id](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_get_backup_task_by_id)  
[get_backup_tasks_for_user](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_get_backup_tasks_for_user)  
[get_backup_tasks](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_get_backup_tasks)  
[add_backup_task](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_add_backup_task)  
[update_backup_task](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_update_backup_task)  
[update_backup_task_with_values](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_update_backup_task_with_values)  
[update_backup_run](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_update_backup_run)  
[update_backup_run_manually](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_update_backup_run_manually)  
[update_backup_completed](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_update_backup_completed)  
[update_backup_errors](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_update_backup_errors)  
[update_completed_sites](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_update_completed_sites)  
[get_backup_tasks_to_complete](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_get_backup_tasks_to_complete)  
[get_backup_tasks_todo_daily](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_get_backup_tasks_todo_daily)  
[get_backup_tasks_todo_weekly](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_get_backup_tasks_todo_weekly)  
[get_backup_tasks_todo_monthly](classes/MainWP-Dashboard-MainWP-DB-Backup.html#method_get_backup_tasks_todo_monthly)  
...
_No protected constants found_ _No private methods found_ [instance](classes/MainWP-Dashboard-MainWP-DB-Backup.html#property_instance)  
_No private constants found_

File
     [ class/class-mainwp-db-backup.php ](files/class-class-mainwp-db-backup.md)
Package
...
_Instance variable class._

#### Type

self|null — Instance of MainWP_DB_Backup or null. 
...
_Method get_website_backup_settings()_
...
Inherited from
    [\MainWP\Dashboard\MainWP_DB_Backup](classes/MainWP-Dashboard-MainWP-DB-Backup.md)
Uses
...
_Method update_backup_task_progress()_
...
__
[code]
    add_backup_task_progress(mixed  $task_id, mixed  $wp_id, mixed  $information) : array|null
[/code]

_Method add_backup_task_progress()_
...
__
[code]
    get_backup_task_progress(mixed  $task_id, mixed  $wp_id) : array|null
[/code]

_Method get_backup_task_progress()_
...
__
[code]
    backup_full_task_running(mixed  $wp_id) : bool
[/code]

_Method backup_full_task_running()_
...
__
[code]
    get_backup_task_by_id(mixed  $id) : object|null
[/code]

_Method get_backup_task_by_id()_
...
_Method get_backup_tasks_for_user()_
...
__
[code]
    get_backup_tasks(null  $userid = \MainWP\Dashboard\null, string  $orderBy = \MainWP\Dashboard\null) : object|null
[/code]

_Method get_backup_tasks()_
...
__
[code]
    update_backup_task_with_values(mixed  $id, mixed  $values) : int|false
[/code]

_Method update_backup_task_with_values()_
...
__
[code]
    update_backup_run(mixed  $id) : int|false
[/code]

_Method update_backup_run()_
...
__
[code]
    update_backup_run_manually(mixed  $id) : int|false
[/code]

_Method update_backup_run_manually()_
...
__
[code]
    update_backup_completed(mixed  $id) : int|false
[/code]

_Method update_backup_completed()_
...
__
[code]
    update_backup_errors(mixed  $id, mixed  $errors) : int|false
[/code]

_Method update_backup_errors()_
...
__
[code]
    update_completed_sites(mixed  $id, mixed  $completedSites) : int|false
[/code]

_Method update_completed_sites()_
...
mixed | $id  | Task ID.  
---|---|---  
mixed | $completedSites  | Completed sites.  
...
_Method get_backup_tasks_to_complete()_
...
_Method get backup tasks daily._
...
_Method get backup tasks weekly._
...
_Method get backup tasks monthly._
