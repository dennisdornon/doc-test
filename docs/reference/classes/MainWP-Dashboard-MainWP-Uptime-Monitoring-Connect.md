...
#  \MainWP\Dashboard MainWP_Uptime_Monitoring_Connect

_Class MainWP_Uptime_Monitoring_Connect_

## Summary

Methods Properties Constants [instance](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#method_instance)  
[check_monitors](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#method_check_monitors)  
[check_multi_monitors](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#method_check_multi_monitors)  
[check_uptime_monitors](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#method_check_uptime_monitors)  
[fetch_uptime_monitor](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#method_fetch_uptime_monitor)  
[fetch_uptime_urls](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#method_fetch_uptime_urls)  
[fetch_single_uptime_url](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#method_fetch_single_uptime_url)  
[handle_response_fetch_uptime](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#method_handle_response_fetch_uptime)  
[is_http_code_type](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#method_is_http_code_type)  
[parse_response_status](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#method_parse_response_status)  
[get_mapping_status_code_names](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#method_get_mapping_status_code_names)  
[get_apply_monitor_url](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#method_get_apply_monitor_url)  
[is_importance_status](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#method_is_importance_status)  
[get_apply_setting](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#method_get_apply_setting)  
[get_up_codes](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#method_get_up_codes)  
[get_user_agent](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#method_get_user_agent)  
_No public properties found_ [DOWN](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#constant_DOWN)  
[UP](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#constant_UP)  
[PENDING](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#constant_PENDING)  
[FIRST](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#constant_FIRST)  
[RETRY](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#constant_RETRY)  
[NOTALLOWED](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#constant_NOTALLOWED)  
[TIMEOUTED_ERROR](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#constant_TIMEOUTED_ERROR)  
[CERT_ERROR](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#constant_CERT_ERROR)  
[RESOLVEHOST_ERROR](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#constant_RESOLVEHOST_ERROR)  
[UNDEFINED_ERROR](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#constant_UNDEFINED_ERROR)  
_No protected methods found_ [instance](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.html#property_instance)  
_No protected constants found_ _No private methods found_ _No private properties found_ _No private constants found_

File
     [ class/class-mainwp-uptime-monitoring-connect.php ](files/class-class-mainwp-uptime-monitoring-connect.md)
Package
...
_The single instance of the class_
...
Inherited from
    [\MainWP\Dashboard\MainWP_Uptime_Monitoring_Connect](classes/MainWP-Dashboard-MainWP-Uptime-Monitoring-Connect.md)
...
__
[code]
    check_monitors(array  $monitors, array  $glo_settings) : mixed
[/code]

_Check multi uptime monitors._

#### Parameters

array | $monitors  | object array monitors.  
---|---|---  
array | $glo_settings  | global settings.  
...
### check_multi_monitors()

__
[code]
    check_multi_monitors(array  $monitors, array  $glo_settings) : mixed
[/code]
...
__
[code]
    check_uptime_monitors(array  $monitors, array  $glo_settings) : mixed
[/code]

_Check uptime monitors._

#### Parameters

array | $monitors  | object array monitors.  
---|---|---  
array | $glo_settings  | glo settings.  
...
mixed | $monitor  | monitor.  
---|---|---  
mixed | $global_settings  | global settings.  
bool | $second_try  | second try.  
array | $params  | params.  
...
__
[code]
    fetch_uptime_urls(array  $websites, array  $handler, object  $output, array  $params = array()) : mixed
[/code]

_Fetch uptime urls._

#### Parameters

array | $websites  | websites.  
---|---|---  
array | $handler  | callable.  
...
### handle_response_fetch_uptime()

__
[code]
    handle_response_fetch_uptime(mixed  $data, mixed  $monitor, mixed  $output, array  $params = array()) : mixed
[/code]

_Method handle response fetch uptime._
...
__
[code]
    is_http_code_type(mixed  $type, mixed  $code) : bool
[/code]

_Method is_http_code_type_
...
__
[code]
    get_mapping_status_code_names() : array
[/code]

_Method get_mapping_status_code_names_
...
### get_apply_monitor_url()

__
[code]
    get_apply_monitor_url(mixed  $monitor) : string
[/code]

_Get apply monitor url._
...
__
[code]
    is_importance_status(int  $previous, int  $current) : mixed
[/code]

_Method is_importance_status_
...
__
[code]
    get_apply_setting(mixed  $name, mixed  $indiv_settings, mixed  $glo_settings, mixed  $apply_global_value, mixed  $default_value) : mixed
[/code]

_Get apply setting._

#### Parameters

mixed | $name  | name.  
---|---|---  
mixed | $indiv_settings  | indiv settings.  
mixed | $glo_settings  | glo settings.  
mixed | $apply_global_value  | apply global value.  
...
__
[code]
    get_up_codes(mixed  $monitor, mixed  $global_settings) : mixed
[/code]

_Method get_up_codes_
...
### class-mainwp-uptime-monitoring-connect.php
[/code]
[code] 
#  __
