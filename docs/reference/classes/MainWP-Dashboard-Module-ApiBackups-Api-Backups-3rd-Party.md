...
[render_mainwp_backups_page](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-3rd-Party.html#method_render_mainwp_backups_page)  
...
[gridpane_get_sites_list](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-3rd-Party.html#method_gridpane_get_sites_list)  
...
[ajax_plesk_action_delete_backup](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-3rd-Party.html#method_ajax_plesk_action_delete_backup)  
...
[ajax_kinsta_action_create_backup](classes/MainWP-Dashboard-Module-ApiBackups-Api-Backups-3rd-Party.html#method_ajax_kinsta_action_create_backup)  
...
### fetch_gridpane_settings_for_site()
...
_Fetch all available servers._
...
_Vultr: action refresh available backups._
...
_Vultr: action restore backup._
...
_Call GridPane API, Authenticate & perform given method._
...
__
[code]
    gridpane_get_sites_list(int  $sites_count) : object|bool
[/code]

_Get GridPane Site List._

Request for all sites for current user token.

#### Parameters

int | $sites_count  | sites count.  
---|---|---  
...
### gridpane_get_domain_list()

__
[code]
    gridpane_get_domain_list() : object|bool
[/code]
...
True|False Return True on success & False on failure
...
_Assign Server:Apps to Child Sites options table._
...
_GridPane: action refresh available backups._
...
_GridPane: action restore backup._
...
_GridPane: action delete backup._
...
_Call Linode API, Authenticate & perform given method._
...
_Linode: action Refresh available backups._
...
_Linode: action Restore backup._
...
__
[code]
    linode_action_linode_status(int  $website_id) : void
[/code]

_Linode: action Linode status._

Check linode status to know when to reboot server.

#### Parameters

int | $website_id  | Child Site ID.  
---|---|---  
...
__
[code]
    linode_action_linode_start(int  $instance_id) : void
[/code]

_Linode: action Linode start._

#### Parameters

int | $instance_id  | Linode Instance ID.  
---|---|---  
...
_Linode: action cancel backups._
...
_Call DigitalOcean API, Authenticate & perform given method._
...
_DigitalOcean: Action refresh available backups._
...
_DigitalOcean: Action restore backup._
...
_DigitalOcean: Action delete backup._
...
_Call Plesk API, Authenticate & perform given method._
...
__
[code]
    get_plesk_home_dir() : string|bool
[/code]

_Plesk: Grab Home Directory._
...
_Plesk: action refresh available backups._
...
_Plesk: action restore backup._
...
__
[code]
    plesk_action_restore_backup() : mixed
[/code]
...
__
[code]
    plesk_action_delete_backup() : mixed
[/code]
...
_Call cPanel API, Authenticate & perform given method._
...
__
[code]
    get_cpanel_authentication_credentials(int  $website_id = '') : array
[/code]

_CPanel: Authentication._
...
_CPanel: Action get cPanel Home Directory._
...
_Get cPanel manual account backups._
...
__
[code]
    get_cpanel_manual_database_backups(int  $website_id = '') : false|string
[/code]

_Get cPanel manual database backups._
...
### get_3rdparty_installation_path()

__
[code]
    get_3rdparty_installation_path(string  $what = '') : string
[/code]

_Method get_3rdparty_installation_path()._

#### Parameters

string | $what  | what to get path.  
---|---|---  
...
__
[code]
    get_cpanel_wp_toolkit_backups(int  $website_id) : array
[/code]

_CPanel: Action refresh available WP-Toolit backups._
...
_CPanel: action restore backup._
...
_CPanel: action restore database backup._
...
_CPanel: action restore manual backup._
...
_CPanel: action refresh available backups._
...
_CPanel: action create backup._
...
_CPanel: action delete WP-Toolkit backup._
...
_CPanel: action create full backup._
...
_CPanel: Action restore selected backup._
...
_CPanel: Action restore selected database backup._
...
_CPanel: Action restore selected manual backup._
...
### ajax_kinsta_action_refresh_available_backups()

__
[code]
    ajax_kinsta_action_refresh_available_backups() : void
[/code]

_Kinsta: action refresh available backups._
...
### ajax_kinsta_action_create_backup()

__
[code]
    ajax_kinsta_action_create_backup() : void
[/code]

_Kinsta: action create backup._
...
### ajax_kinsta_action_delete_backup()

__
[code]
    ajax_kinsta_action_delete_backup() : void
[/code]

_Kinsta: action delete backup._
...
### ajax_kinsta_action_restore_backup()

__
[code]
    ajax_kinsta_action_restore_backup() : void
[/code]

_Kinsta: action restore backup._
...
### get_kinsta_authentication_credentials()
...
__
[code]
    call_kinsta_api(string  $method, string  $url, string  $baseurl, string  $api_key, string  $action = '', string  $backup_data = array()) : array
[/code]

_Call Kinsta API, Authenticate & perform given method._
...
string | $url  | API endpoint for the call.  
string | $baseurl  | baseurl.  
string | $api_key  | Kinsta API Key.  
string | $action  | action.  
string | $backup_data  | action.  
...
### kinsta_action_get_user_id()

__
[code]
    kinsta_action_get_user_id() : array
[/code]

_Kinsta: Action get User ID._
...
__
[code]
    kinsta_action_refresh_available_backups() : void
[/code]
...
bool | $resturn_values  | resturn values.  
---|---|---  
int | $site_id  | website id.  
...
bool | $return_values  | return values.  
---|---|---  
...
bool | $return_values  | return or not.  
---|---|---  
...
### class-api-backups-3rd-party.php
[/code]
[code] 
#  __
