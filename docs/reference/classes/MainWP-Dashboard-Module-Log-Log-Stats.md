...
#  \MainWP\Dashboard\Module\Log Log_Stats

_Class - Log_Stats_

## Summary

Methods Properties Constants [__construct](classes/MainWP-Dashboard-Module-Log-Log-Stats.html#method___construct)  
[get_stats_data](classes/MainWP-Dashboard-Module-Log-Log-Stats.html#method_get_stats_data)  
[get_stats_count](classes/MainWP-Dashboard-Module-Log-Log-Stats.html#method_get_stats_count)  
[render_stats_duration_time](classes/MainWP-Dashboard-Module-Log-Log-Stats.html#method_render_stats_duration_time)  
[render_stats_info](classes/MainWP-Dashboard-Module-Log-Log-Stats.html#method_render_stats_info)  
[render_stats_compare](classes/MainWP-Dashboard-Module-Log-Log-Stats.html#method_render_stats_compare)  
[render_chart_series](classes/MainWP-Dashboard-Module-Log-Log-Stats.html#method_render_chart_series)  
...
File
     [ modules/logs/classes/class-log-stats.php ](files/modules-logs-classes-class-log-stats.md)
Package
...
Inherited from
    [\MainWP\Dashboard\Module\Log\Log_Stats](classes/MainWP-Dashboard-Module-Log-Log-Stats.md)
...
__
[code]
    get_stats_data(mixed  $items) : mixed
[/code]
...
__
[code]
    get_stats_count(array  $data, string  $action) : mixed
[/code]

_Render stats count._
...
__
[code]
    render_stats_duration_time(array  $data, string  $action) : mixed
[/code]

_Render stats duration time._
...
__
[code]
    render_stats_info(array  $data, string  $action, string  $title, array  $data_prev) : mixed
[/code]

_Render stats column content._

#### Parameters

array | $data  | Data stats array.  
---|---|---  
string | $action  | Action name.  
string | $title  | Action title.  
array | $data_prev  | Data Stats previous array.  
...
__
[code]
    render_stats_compare(int  $count, int  $prev_count) : mixed
[/code]

_Render stats compare._

#### Parameters

int | $count  | Count stats.  
---|---|---  
int | $prev_count  | Count previous stats.  
...
__
[code]
    render_chart_series(array  $data, string  $action, string  $title, array  $data_prev) : mixed
[/code]

_Method render_chart_series()._
...
string | $title  | Title.  
array | $data_prev  | Stats previous data.  
