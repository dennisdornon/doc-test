...
#  \MainWP\Dashboard MainWP_Site_Open

_Class MainWP_Site_Open_

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Site-Open.html#method_get_class_name)  
[render](classes/MainWP-Dashboard-MainWP-Site-Open.html#method_render)  
[render_restore](classes/MainWP-Dashboard-MainWP-Site-Open.html#method_render_restore)  
[open_site_restore](classes/MainWP-Dashboard-MainWP-Site-Open.html#method_open_site_restore)  
[verify_open_nonce](classes/MainWP-Dashboard-MainWP-Site-Open.html#method_verify_open_nonce)  
[open_site_location](classes/MainWP-Dashboard-MainWP-Site-Open.html#method_open_site_location)  
[get_open_site_url](classes/MainWP-Dashboard-MainWP-Site-Open.html#method_get_open_site_url)  
_No public properties found_ _No public constants found_ _No protected methods found_ _No protected properties found_ _No protected constants found_ [open_site](classes/MainWP-Dashboard-MainWP-Site-Open.html#method_open_site)  
_No private properties found_ _No private constants found_

File
     [ pages/page-mainwp-site-open.php ](files/pages-page-mainwp-site-open.md)
Package
...
_Child Site Dashboard Link redirect handler._
...
__
[code]
    render_restore() : mixed
[/code]

_This renders the method open_site _restore()_
...
__
[code]
    open_site_restore(mixed  $website, mixed  $file, mixed  $size) : mixed
[/code]

_This opens the site restore._

#### Parameters

mixed | $website  | Website ID.  
---|---|---  
mixed | $file  | Restore File.  
mixed | $size  | Post data size.  
...
__
[code]
    verify_open_nonce() : mixed
[/code]

_This verify opens the site nonce._
...
__
[code]
    open_site_location(mixed  $website, mixed  $open_location) : mixed
[/code]

_This opens the site location._

#### Parameters

mixed | $website  | Website ID.  
---|---|---  
mixed | $open_location  | Website URL.  
...
mixed | $website  | Website ID.  
---|---|---  
mixed | $location  | open location.  
bool | $echo_out  | Echo or not.  
...
__
[code]
    open_site(mixed  $website, mixed  $location, array  $params = array()) : mixed
[/code]

_This method opens the requested Child Site Admin._

#### Parameters

mixed | $website  | Website ID.  
---|---|---  
mixed | $location  | Website Location.  
