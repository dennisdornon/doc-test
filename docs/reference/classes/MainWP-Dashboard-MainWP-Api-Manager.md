...
#  \MainWP\Dashboard MainWP_Api_Manager

_Class MainWP_Api_Manager_

## Summary

Methods Properties Constants [instance](classes/MainWP-Dashboard-MainWP-Api-Manager.html#method_instance)  
[__clone](classes/MainWP-Dashboard-MainWP-Api-Manager.html#method___clone)  
[__wakeup](classes/MainWP-Dashboard-MainWP-Api-Manager.html#method___wakeup)  
[__construct](classes/MainWP-Dashboard-MainWP-Api-Manager.html#method___construct)  
[get_upgrade_url](classes/MainWP-Dashboard-MainWP-Api-Manager.html#method_get_upgrade_url)  
[get_domain](classes/MainWP-Dashboard-MainWP-Api-Manager.html#method_get_domain)  
[get_activation_info](classes/MainWP-Dashboard-MainWP-Api-Manager.html#method_get_activation_info)  
[set_activation_info](classes/MainWP-Dashboard-MainWP-Api-Manager.html#method_set_activation_info)  
[remove_activation_info](classes/MainWP-Dashboard-MainWP-Api-Manager.html#method_remove_activation_info)  
[license_key_activation](classes/MainWP-Dashboard-MainWP-Api-Manager.html#method_license_key_activation)  
[license_key_deactivation](classes/MainWP-Dashboard-MainWP-Api-Manager.html#method_license_key_deactivation)  
[verify_mainwp_api](classes/MainWP-Dashboard-MainWP-Api-Manager.html#method_verify_mainwp_api)  
[purchase_software](classes/MainWP-Dashboard-MainWP-Api-Manager.html#method_purchase_software)  
[get_purchased_extension](classes/MainWP-Dashboard-MainWP-Api-Manager.html#method_get_purchased_extension)  
[grab_license_key](classes/MainWP-Dashboard-MainWP-Api-Manager.html#method_grab_license_key)  
[check_response_for_api_errors](classes/MainWP-Dashboard-MainWP-Api-Manager.html#method_check_response_for_api_errors)  
[check_response_for_intall_errors](classes/MainWP-Dashboard-MainWP-Api-Manager.html#method_check_response_for_intall_errors)  
[request_extension_information](classes/MainWP-Dashboard-MainWP-Api-Manager.html#method_request_extension_information)  
[domain](classes/MainWP-Dashboard-MainWP-Api-Manager.html#property_domain)  
_No public constants found_ _No protected methods found_ [instance](classes/MainWP-Dashboard-MainWP-Api-Manager.html#property_instance)  
_No protected constants found_ [replace_license_key](classes/MainWP-Dashboard-MainWP-Api-Manager.html#method_replace_license_key)  
[upgrade_url](classes/MainWP-Dashboard-MainWP-Api-Manager.html#property_upgrade_url)  
[renew_license_url](classes/MainWP-Dashboard-MainWP-Api-Manager.html#property_renew_license_url)  
_No private constants found_

File
     [ class/class-mainwp-api-manager.php ](files/class-class-mainwp-api-manager.md)
Package
...
_MainWP installation domain name._
...
_Extensions license renewal URL._
...
_Un-serializing instances of this class is forbidden._
...
_MainWP_Api_Manager constructor._
...
_Get activation info._

#### Parameters

mixed | $ext_key  | extension key.  
---|---|---  
...
_Store activation info._

#### Parameters

mixed | $ext_key  | Extension key.  
---|---|---  
mixed | $info  | Activation information.  
...
_Check API Key & API Email again MainWP Servers._

#### Parameters

array | $api_slug  | Extension activation info.  
---|---|---  
...
_Deactivate license Key._

#### Parameters

array | $api_slug  | Extension activation info.  
---|---|---  
array | $api_key  | Extension activation api key.  
...
_Test the users MainWP.com Login details against MainWP Server._

#### Parameters

string | $api_key  | MainWP api key.  
---|---|---  
...
_Check if the user purchased the software._
...
---|---|---  
string | $productId  | extension (product) ID.  
bool | $no_register  | registration request.  
...
_Grab users associate MainWP License key for the selected Extension._

#### Parameters

array | $api_slug  | Extension activation info.  
---|---|---  
string | $master_api_key  | MainWP master api key.  
...
_Check if $response contains any api errors._
...
_Check if $response contains any install errors._
...
__
[code]
    replace_license_key(array  $args) : bool
[/code]

_Deactivate the current license key before activating the new license key._
