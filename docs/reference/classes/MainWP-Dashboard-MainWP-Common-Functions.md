...
#  \MainWP\Dashboard MainWP_Common_Functions

_Class MainWP_Common_Functions_

## Summary

Methods Properties Constants [get_class_name](classes/MainWP-Dashboard-MainWP-Common-Functions.html#method_get_class_name)  
[instance](classes/MainWP-Dashboard-MainWP-Common-Functions.html#method_instance)  
[__construct](classes/MainWP-Dashboard-MainWP-Common-Functions.html#method___construct)  
[get_available_update_siteids](classes/MainWP-Dashboard-MainWP-Common-Functions.html#method_get_available_update_siteids)  
[get_not_ignored_updates_themesplugins](classes/MainWP-Dashboard-MainWP-Common-Functions.html#method_get_not_ignored_updates_themesplugins)  
[is_ignored_updates](classes/MainWP-Dashboard-MainWP-Common-Functions.html#method_is_ignored_updates)  
_No public properties found_ _No public constants found_ _No protected methods found_ [userExtension](classes/MainWP-Dashboard-MainWP-Common-Functions.html#property_userExtension)  
_No protected constants found_ _No private methods found_ [instance](classes/MainWP-Dashboard-MainWP-Common-Functions.html#property_instance)  
_No private constants found_

File
     [ class/class-mainwp-common-functions.php ](files/class-class-mainwp-common-functions.md)
Package
...
__
[code]
    instance() : \MainWP\Dashboard\MainWP_Common_Functions
[/code]
...
_MainWP_Common_Functions constructor._
...
_Get child site ids that have available updates._
...
### get_not_ignored_updates_themesplugins()

__
[code]
    get_not_ignored_updates_themesplugins(array  $updates, array  $ignored) : array
[/code]

_Method get_not_ignored_updates_themesplugins()._

To compatible with new ignored update info.

#### Parameters

array | $updates  | Update info.  
---|---|---  
array | $ignored  | Ignored update info.  
  
#### Returns

array —

$updates Not ignored updates info.
...
__
[code]
    is_ignored_updates(array  $item, array  $ignored, string  $type = 'plugin') : bool
[/code]

_Method is_ignored_updates()._

To compatible with new ignored update info.

#### Parameters

array | $item  | Update info of theme or plugin.  
---|---|---  
array | $ignored  | Ignored update info.  
string | $type  | theme/plugin/core.  
...
### class-mainwp-common-functions.php
[/code]
[code] 
#  __
