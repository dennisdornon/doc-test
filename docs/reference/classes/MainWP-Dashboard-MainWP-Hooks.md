...
[cache_echo_body](classes/MainWP-Dashboard-MainWP-Hooks.html#method_cache_echo_body)  
...
[hook_atarim_manage_sites_default_item](classes/MainWP-Dashboard-MainWP-Hooks.html#method_hook_atarim_manage_sites_default_item)  
...
__
[code]
    hook_db_data_seek(mixed  $result, int  $offset = 0) : mixed
[/code]
...
__
[code]
    hook_db_query(mixed  $input_value, string  $sql) : bool
[/code]

_Method hook_db_query()_
...
__
[code]
    db_fetch_object(mixed  $input_value, mixed  $result) : bool
[/code]

_Method db_fetch_object()_
...
__
[code]
    db_fetch_array(mixed  $input_value, mixed  $result) : bool
[/code]

_Method db_fetch_array()_
...
_Get notification email settings._
...
__
[code]
    hook_send_wp_mail(string  $input, string  $email, string  $subject, bool  $formated_content, string  $content_type = '') : mixed
[/code]

_Hook send_wp_mail()._
...
---|---|---  
string | $email  | send to email.  
string | $subject  | email content.  
bool | $formated_content  | email content.  
...
_Hook get template HTML content._
...
__
[code]
    hook_secure_request(string  $action = '', string  $query_arg = 'security') : mixed
[/code]

_Method hook_secure_request()_
...
__
[code]
    hook_check_security_request(bool  $input_value, string  $action = '', string  $query_arg = '') : mixed
[/code]

_Method hook_check_security_request()_

Security check to request parameter

#### Parameters

bool | $input_value  | Input value.  
---|---|---  
string | $action  | Action to perform.  
string | $query_arg  | Query argument.  
...
_Method filter_qq2_file_uploader()_
...
__
[code]
    get_metaboxes_post() : string|bool
[/code]

_Method get_metaboxes_post()_
...
_Method hook_notification_email()_
...
__
[code]
    get_formated_email(mixed  $body, mixed  $email, string  $title = '') : string|bool
[/code]

_Method get_formated_email()_
...
__
[code]
    deactive_plugin() : mixed
[/code]

_Method deactive_plugin()_
...
__
[code]
    upgrade_plugin_theme() : mixed
[/code]

_Method upgrade_plugin_theme()_
...
__
[code]
    hook_posts_get_edit() : mixed
[/code]

_Method hook_posts_get_edit()_
...
__
[code]
    hook_posts_bulk_posting() : mixed
[/code]

_Method hook_posts_bulk_posting()_
...
__
[code]
    hook_atarim_default_sitestable_column(mixed  $columns) : mixed
[/code]

_Method hook_atarim_default_sitestable_column()_
...
__
[code]
    hook_atarim_manage_sites_default_item(mixed  $item) : mixed
[/code]

_Method hook_atarim_manage_sites_default_item()_
...
_Method hook_get_download_sig()_
...
__
[code]
    hook_secure_download(string  $false_value, string  $fullfile, string  $sig) : mixed
[/code]

_Method hook_download_valid_sig()._
...
__
[code]
    hook_ajax_add_action(string  $action, string  $callback, int  $priority = 10, int  $accepted = 2) : mixed
[/code]

_Method hook_ajax_add_action()._
...
int | $priority  | priority action.  
int | $accepted  | number args.  
...
__
[code]
    hook_get_plugin_icon(mixed  $icon, string  $slug) : mixed
[/code]

_Method hook_get_plugin_icon()._
...
__
[code]
    hook_get_theme_icon(mixed  $icon, string  $slug) : mixed
[/code]

_Method hook_get_theme_icon()._
...
__
[code]
    hook_get_dir_slug(mixed  $input, string  $slug) : mixed
[/code]

_Method hook_get_dir_slug()._
...
Sets Global $mainwp_widget_boxes[ $page ][ $context ][ $priority ][ $id ].
...
__
[code]
    hook_render_modal_upload_icon() : mixed
[/code]

_Method hook_render_modal_upload_icon()_
...
__
[code]
    hook_render_plugin_details_modal() : mixed
[/code]

_Method hook_render_plugin_details_modal()_
...
__
[code]
    hook_render_updates() : mixed
[/code]

_Method hook_render_updates()_
...
__
[code]
    hook_get_activation_info(bool  $boolean, string  $ext_slug) : mixed
[/code]

_Method hook_get_activation_info()_

Get extension activation info.

#### Parameters

bool | $boolean  | Input bool value.  
---|---|---  
...
__
[code]
    hook_get_api_url() : mixed
[/code]

_Method hook_get_api_url()_
...
bool | $out_die  | The function die or return.  
...
_Method hook_master_api_key_check()._
...
bool | $input_value  | Boolean value, it should always be FALSE.  
---|---|---  
...
_Method hook_delete_key_value()._
...
_Method hook_delete_key_file()._
...
### hook_get_lookup_items()

__
[code]
    hook_get_lookup_items(bool  $false_val, string  $item_name, int  $item_id, string  $obj_name) : array
[/code]

_Method hook_get_lookup_items()._

#### Parameters

bool | $false_val  | false value.  
---|---|---  
...
### hook_insert_lookup_item()

__
[code]
    hook_insert_lookup_item(bool  $false_val, string  $item_name, int  $item_id, string  $obj_name, int  $obj_id) : array
[/code]

_Method hook_insert_lookup_item()._
...
### hook_delete_lookup_items()

__
[code]
    hook_delete_lookup_items(bool  $false_val, string  $by = 'lookup_id', array  $params = array()) : mixed
[/code]

_Method hook_delete_lookup_items()._
...
bool | $def_value  | default input value.  
---|---|---  
bool | $indi_type  | Indicator type.  
bool | $wrapper_cls  | field wrapper class.  
bool | $visible  | Current indicator status.  
...
### hook_get_time_elapsed_string()

__
[code]
    hook_get_time_elapsed_string(mixed  $ptime = 0) : string
[/code]

_Method hook_get_time_elapsed_string()._

Returns date in time ago format

#### Parameters

mixed | $ptime  | Date stamp.  
---|---|---  
