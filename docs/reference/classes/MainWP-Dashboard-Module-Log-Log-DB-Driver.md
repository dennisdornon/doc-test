...
#  \MainWP\Dashboard\Module\Log Log_DB_Driver

_Interface - Log_DB_Driver_

## Summary

Methods Constants [insert_record()](classes/MainWP-Dashboard-Module-Log-Log-DB-Driver.html#method_insert_record)  
[get_records()](classes/MainWP-Dashboard-Module-Log-Log-DB-Driver.html#method_get_records)  
[get_column_values()](classes/MainWP-Dashboard-Module-Log-Log-DB-Driver.html#method_get_column_values)  
[get_table_names()](classes/MainWP-Dashboard-Module-Log-Log-DB-Driver.html#method_get_table_names)  
[purge_storage()](classes/MainWP-Dashboard-Module-Log-Log-DB-Driver.html#method_purge_storage)  
_No public constants found_

File
     [ modules/logs/classes/class-log-db-driver.php ](files/modules-logs-classes-class-log-db-driver.md)
Package
...
array | $data  | Data to be insert into the database.  
---|---|---  
...
array | $args  | Argument to filter the result by.  
---|---|---  
...
string | $column  | Column to pull data from.  
---|---|---  
...
_Public getter to return the names of the tables this driver manages._
...
\MainWP\Dashboard\Module\Log\Log_Manager | $manager  | Instance of the manager.  
---|---|---  
