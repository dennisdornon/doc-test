...
#  \phpseclib3\Crypt\EC BaseCurves

## Classes

[Base](classes/phpseclib3-Crypt-EC-BaseCurves-Base.md) |  _Base_  
---|---  
[Binary](classes/phpseclib3-Crypt-EC-BaseCurves-Binary.md) |  _Curves over y^2 + x*y = x^3 + a*x^2 + b_  
[KoblitzPrime](classes/phpseclib3-Crypt-EC-BaseCurves-KoblitzPrime.md) |  _Curves over y^2 = x^3 + b_  
[Montgomery](classes/phpseclib3-Crypt-EC-BaseCurves-Montgomery.md) |  _Curves over y^2 = x^3 + a*x + x_  
[Prime](classes/phpseclib3-Crypt-EC-BaseCurves-Prime.md) |  _Curves over y^2 = x^3 + a*x + b_  
[TwistedEdwards](classes/phpseclib3-Crypt-EC-BaseCurves-TwistedEdwards.md) |  _Curves over a*x^2 + y^2 = 1 + d*x^2*y^2_  
...
Documentation is powered by [phpDocumentor ](https://www.phpdoc.org/) and authored on March 11th, 2025 at 18:17. 
  ...
  *[Montgomery]: \phpseclib3\Crypt\EC\BaseCurves\Montgomery
