...
[ComposerAutoloaderInit297c1cacbd97936952563e1c84ae279f](classes/ComposerAutoloaderInit297c1cacbd97936952563e1c84ae279f.md) |  __  
---|---  
[MainWP_DateTime](classes/MainWP-DateTime.md) |  _Datetime class._  
...
[MainWP_REST_Controller](classes/MainWP-REST-Controller.md) |  _Abstract Rest Controller Class_  
[MainWP_Rest_Costs_Controller](classes/MainWP-Rest-Costs-Controller.md) |  _Class MainWP_Rest_Costs_Controller_  
[MainWP_Rest_Global_Batch_Controller](classes/MainWP-Rest-Global-Batch-Controller.md) |  _Class MainWP_Rest_Global_Batch_Controller_  
...
[MainWP_Rest_Sites_Controller](classes/MainWP-Rest-Sites-Controller.md) |  _Class MainWP_Rest_Sites_Controller_  
[MainWP_Rest_Tags_Controller](classes/MainWP-Rest-Tags-Controller.md) |  _Class MainWP_Rest_Tags_Controller_  
[MainWP_Rest_Updates_Controller](classes/MainWP-Rest-Updates-Controller.md) |  _Class MainWP_Rest_Updates_Controller_  
[MainWP_Setup](classes/MainWP-Setup.md) |  _MainWP Setup Class._  
[TestClass](classes/TestClass.md) |  _Test class for documentation_  
...
_Checks whether cron is in progress._
...
_Define MainWP Dashboard Plugin Directory._
...
_Define MainWP Dashboard Plugin absolute full path and filename of this file._
...
_Define MainWP Child Dashboard URL._
...
__
[code]
    mainwp_api_hash(string  $data) : string
[/code]
...
File
    [includes/core-functions.php](files/includes-core-functions.md)
...
_Autoloader for all classes, pages & widgets_

#### Parameters

string | $class_name  | Folder name class|pages|widgets.  
---|---|---  
...
__
[code]
    mainwp_current_user_can(string  $cap_type = '', string  $cap = '') : bool
[/code]

_Check permission level._

To compatible with extensions.

#### Parameters

string | $cap_type  | Group or type of capabilities.  
---|---|---  
string | $cap  | Capabilities for current user.  
...
File
    [includes/functions.php](files/includes-functions.md)
...
---|---|---  
bool | $echo_out  | Defines weather or not to echo error message.  
...
__
[code]
    mainwp_get_actions_handler_instance() : bool
[/code]

_Function to get mainwp actions handler instance._
...
bool | $get_db_datetime  | To get db datetime.  
---|---|---  
...
__
[code]
    mainwp_get_timestamp(int  $add_time) : int
[/code]

_Function mainwp_get_timestamp._

#### Parameters

int | $add_time  | add time.  
---|---|---  
...
---|---|---  
int | $filter  | The ID of the filter to apply.  
...
File
    [modules/logs/includes/functions.php](files/modules-logs-includes-functions.md)
...
__
[code]
    mainwp_module_log_get_iso_8601_extended_date(int|bool  $time = false, int  $offset) : string
[/code]
...
int|bool | $time  | Seconds since unix epoch.  
---|---|---  
...
__
[code]
    mainwp_modules_is_enabled(string  $module) : bool
[/code]

_Check if module is enable._
...
string|null|\DateTime | $date  | Date.  
---|---|---  
bool | $utc  | Send false to get local/offset time.  
...
__
[code]
    mainwp_rest_urlencode_rfc3986(string|array  $value) : string|array
[/code]

_Encodes a value according to RFC 3986._

Supports multidimensional arrays.

#### Parameters

string|array | $value  | The value to encode.  
---|---|---  
...
__
[code]
    mainwp_search_in_array(array  $data, string  $search_str, array  $params = array()) : array
[/code]

_Method mainwp_search_in_array()._
...
__
[code]
    mainwp_secure_request(string  $action) : void
[/code]

_Function mainwp_secure_request._
...
__
[code]
    mainwp_send_json_output(array  $output) : mixed
[/code]

_Handle send json output._
...
__
[code]
    mainwp_string_to_bool(string|bool  $str) : bool
[/code]

_Converts a string (e.g. 'yes' or 'no') to a bool._

#### Parameters

string|bool | $str  | String to convert. If a bool is passed it will be returned as-is.  
---|---|---  
